...
void call_direct(void) {
  ...
  my_calloc(1, 16);
  // CHECK: call ptr @my_calloc(i32 noundef 1, i32 noundef 16) [[DIRECT_CALLOC_ATTR:#[0-9]+]]
}
...
void call_function_pointer(void) {
  ...
  // CHECK: [[MALLOC_FN_PTR:%.+]] = load ptr, ptr @malloc_function_pointer, align 8
  // CHECK: call ptr [[MALLOC_FN_PTR]](ptr noundef null, i32 noundef 100) [[INDIRECT_MALLOC_ATTR:#[0-9]+]]
  calloc_function_pointer(NULL, 2, 4);
  // CHECK: [[CALLOC_FN_PTR:%.+]] = load ptr, ptr @calloc_function_pointer, align 8
  // CHECK: call ptr [[CALLOC_FN_PTR]](ptr noundef null, i32 noundef 2, i32 noundef 4) [[INDIRECT_CALLOC_ATTR:#[0-9]+]]
}
...
void call_function_pointer_typedef(void) {
  ...
  // CHECK: [[INDIRECT_TYPEDEF_MALLOC_FN_PTR:%.+]] = load ptr, ptr @malloc_function_pointer_with_typedef, align 8
  // CHECK: call ptr [[INDIRECT_TYPEDEF_MALLOC_FN_PTR]](ptr noundef null, ptr noundef null, i32 noundef 200) [[INDIRECT_TYPEDEF_MALLOC_ATTR:#[0-9]+]]
  calloc_function_pointer_with_typedef(NULL, NULL, 8, 4);
  // CHECK: [[INDIRECT_TYPEDEF_CALLOC_FN_PTR:%.+]] = load ptr, ptr @calloc_function_pointer_with_typedef, align 8
