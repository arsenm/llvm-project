...
// CHECK-DDEFAULT: Function Attrs: mustprogress noconvergent noinline nounwind optnone{{$$}}
// CHECK-DEBSTRICT: Function Attrs: mustprogress noconvergent noinline nounwind optnone strictfp{{$$}}
// CHECK-FAST: Function Attrs: mustprogress noconvergent noinline nounwind optnone{{$$}}
// CHECK-NOHONOR: Function Attrs: mustprogress noconvergent noinline nounwind optnone{{$$}}
...
#endif
    // CHECK-FAST: Function Attrs: mustprogress noconvergent noinline nounwind optnone{{$$}}
    // CHECK-DDEFAULT: Function Attrs: mustprogress noconvergent noinline nounwind optnone strictfp{{$$}}
    // CHECK-DEBSTRICT: Function Attrs: mustprogress noconvergent noinline nounwind optnone strictfp{{$$}}
    // CHECK-NOHONOR: Function Attrs: mustprogress noconvergent noinline nounwind optnone strictfp{{$$}}
    float exc_on FUN(2)
...
#pragma float_control(except, on)
                                        ...
                                        float y();
// CHECK-DDEFAULT: Function Attrs: mustprogress noconvergent noinline nounwind optnone{{$$}}
// CHECK-DEBSTRICT: Function Attrs: noconvergent noinline nounwind optnone strictfp{{$$}}
// CHECK-FAST: Function Attrs: mustprogress noconvergent noinline nounwind optnone{{$$}}
// CHECK-NOHONOR: Function Attrs: mustprogress noconvergent noinline nounwind optnone{{$$}}
class ON {
...
ON on;
#pragma float_control(except, off)
// CHECK-DDEFAULT: Function Attrs: noconvergent noinline nounwind optnone{{$$}}
// CHECK-DEBSTRICT: Function Attrs: noconvergent noinline nounwind optnone{{$$}}
// CHECK-FAST: Function Attrs: noconvergent noinline nounwind optnone{{$$}}
// CHECK-NOHONOR: Function Attrs: noconvergent noinline nounwind optnone{{$$}}
class OFF {
  float w = 2 + y() * 7;
...
// CHECK-DDEFAULT: Function Attrs: noconvergent noinline nounwind{{$$}}
// CHECK-DEBSTRICT: Function Attrs: noconvergent noinline nounwind strictfp{{$$}}
// CHECK-FAST: Function Attrs: noconvergent noinline nounwind{{$$}}
// CHECK-NOHONOR: Function Attrs: noconvergent noinline nounwind{{$$}}
