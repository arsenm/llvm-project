...
// CHECK-NEXT:    [[ISZERO:%.*]] = call i1 @llvm.experimental.constrained.fcmp.f64(double [[TMP0]], double 0.000000e+00, metadata !"oeq", metadata !"fpexcept.strict") #[[ATTR5:[0-9]+]]
...
// CHECK-NEXT:    call void @p(ptr noundef @.str.2, i32 noundef [[TMP4]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = zext i1 [[TMP3]] to i32
// CHECK-NEXT:    call void @p(ptr noundef @.str.3, i32 noundef [[TMP4]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = zext i1 [[TMP3]] to i32
// CHECK-NEXT:    call void @p(ptr noundef @.str.4, i32 noundef [[TMP4]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = zext i1 [[TMP3]] to i32
// CHECK-NEXT:    call void @p(ptr noundef @.str.5, i32 noundef [[TMP4]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = zext i1 [[TMP3]] to i32
// CHECK-NEXT:    call void @p(ptr noundef @.str.6, i32 noundef [[TMP4]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = zext i1 [[TMP3]] to i32
// CHECK-NEXT:    call void @p(ptr noundef @.str.7, i32 noundef [[TMP4]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP3:%.*]] = sub i16 31744, [[TMP2]]
// CHECK-NEXT:    [[TMP4:%.*]] = lshr i16 [[TMP3]], 15
// CHECK-NEXT:    [[TMP5:%.*]] = zext i16 [[TMP4]] to i32
// CHECK-NEXT:    call void @p(ptr noundef @.str.9, i32 noundef [[TMP5]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP3:%.*]] = sub i32 2139095040, [[TMP2]]
// CHECK-NEXT:    [[TMP4:%.*]] = lshr i32 [[TMP3]], 31
// CHECK-NEXT:    call void @p(ptr noundef @.str.10, i32 noundef [[TMP4]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP3:%.*]] = sub i64 9218868437227405312, [[TMP2]]
// CHECK-NEXT:    [[TMP4:%.*]] = lshr i64 [[TMP3]], 63
// CHECK-NEXT:    [[TMP5:%.*]] = trunc i64 [[TMP4]] to i32
// CHECK-NEXT:    call void @p(ptr noundef @.str.11, i32 noundef [[TMP5]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
//
