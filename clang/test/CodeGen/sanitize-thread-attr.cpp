...
// BL: attributes [[NOATTR]] = { noconvergent noinline nounwind{{.*}} }

// TSAN: attributes [[NOATTR]] = { mustprogress noconvergent noinline nounwind{{.*}} }
// TSAN: attributes [[WITH]] = { noconvergent noinline nounwind sanitize_thread{{.*}} }
