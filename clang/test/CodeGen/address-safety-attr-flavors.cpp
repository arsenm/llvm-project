...
// CHECK-NOASAN: {{Function Attrs: mustprogress noconvergent noinline nounwind$}}
// CHECK-ASAN: Function Attrs: mustprogress noconvergent noinline nounwind sanitize_address
// CHECK-KASAN: Function Attrs: mustprogress noconvergent noinline nounwind sanitize_address
// CHECK-HWASAN: Function Attrs: mustprogress noconvergent noinline nounwind sanitize_hwaddress
// CHECK-KHWASAN: Function Attrs: mustprogress noconvergent noinline nounwind sanitize_hwaddress

__attribute__((no_sanitize("address"))) int NoSanitizeQuoteAddress() {
  return 0;
}
// CHECK-NOASAN: {{Function Attrs: mustprogress noconvergent noinline nounwind$}}
// CHECK-ASAN: {{Function Attrs: mustprogress noconvergent noinline nounwind$}}
// CHECK-KASAN: {{Function Attrs: mustprogress noconvergent noinline nounwind$}}
// CHECK-HWASAN: {{Function Attrs: mustprogress noconvergent noinline nounwind sanitize_hwaddress$}}
// CHECK-KHWASAN: {{Function Attrs: mustprogress noconvergent noinline nounwind sanitize_hwaddress$}}
...
// CHECK-ASAN: {{Function Attrs: mustprogress noconvergent noinline nounwind sanitize_address$}}
// CHECK-KASAN: {{Function Attrs: mustprogress noconvergent noinline nounwind sanitize_address$}}
// CHECK-HWASAN: {{Function Attrs: mustprogress noconvergent noinline nounwind$}}
// CHECK-KHWASAN: {{Function Attrs: mustprogress noconvergent noinline nounwind$}}
...
// CHECK-NOASAN: {{Function Attrs: disable_sanitizer_instrumentation mustprogress noconvergent noinline nounwind$}}
// CHECK-ASAN: {{Function Attrs: disable_sanitizer_instrumentation mustprogress noconvergent noinline nounwind$}}
// CHECK-KASAN: {{Function Attrs: disable_sanitizer_instrumentation mustprogress noconvergent noinline nounwind$}}
// CHECK-HWASAN: {{Function Attrs: disable_sanitizer_instrumentation mustprogress noconvergent noinline nounwind$}}
// CHECK-KHWASAN: {{Function Attrs: disable_sanitizer_instrumentation mustprogress noconvergent noinline nounwind$}}
