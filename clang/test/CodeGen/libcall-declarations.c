...
// CHECK-NOERRNO: attributes [[NUWRN]] = { noconvergent nounwind willreturn memory(none){{.*}} }
// CHECK-NOERRNO: attributes [[NUWRO]] = { noconvergent nounwind willreturn memory(read){{.*}} }

// CHECK-ERRNO: attributes [[NUWRN]] = { noconvergent nounwind willreturn memory(none){{.*}} }
// CHECK-ERRNO: attributes [[NUWRO]] = { noconvergent nounwind willreturn memory(read){{.*}} }
