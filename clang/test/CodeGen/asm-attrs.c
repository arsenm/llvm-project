...
// CHECK: attributes [[READNONE]] = { noconvergent nounwind memory(none) }
// CHECK: attributes [[NOATTRS]] = { noconvergent nounwind }
// CHECK: attributes [[READONLY]] = { noconvergent nounwind memory(read) }
