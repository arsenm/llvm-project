...
// RUN: %clang_cc1 -fno-ident -triple aarch64-none-linux-gnu -target-feature +ls64 -target-feature +fullfp16 -S -emit-llvm -o - %s | FileCheck %s
// RUN: %clang_cc1 -fno-ident -triple aarch64-none-linux-gnu -target-feature -fmv -S -emit-llvm -o - %s | FileCheck %s -check-prefix=CHECK-NOFMV
...
//.
// CHECK: Function Attrs: noconvergent noinline nounwind optnone
...
// CHECK-SAME: () #[[ATTR9]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[CALL:%.*]] = call i32 @fmv.ifunc() #[[ATTR12:[0-9]+]]
// CHECK-NEXT:    [[CALL1:%.*]] = call i32 @fmv_one.ifunc() #[[ATTR12]]
// CHECK-NEXT:    [[ADD:%.*]] = add nsw i32 [[CALL]], [[CALL1]]
// CHECK-NEXT:    [[CALL2:%.*]] = call i32 @fmv_two.ifunc() #[[ATTR12]]
...
// CHECK-SAME: () #[[ATTR9]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[CALL:%.*]] = call i32 @fmv_inline.ifunc() #[[ATTR12]]
// CHECK-NEXT:    [[CALL1:%.*]] = call i32 @fmv_e.ifunc() #[[ATTR12]]
// CHECK-NEXT:    [[CALL2:%.*]] = call i32 @fmv_d.ifunc() #[[ATTR12]]
// CHECK-NEXT:    call void @fmv_c.ifunc() #[[ATTR12]]
// CHECK-NEXT:    [[CALL3:%.*]] = call i32 @fmv_default() #[[ATTR12]]
...
// CHECK-SAME: () #[[ATTR9]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @reca() #[[ATTR12]]
// CHECK-NEXT:    ret void
//
//
// CHECK: Function Attrs: noconvergent noinline nounwind optnone
...
// CHECK-NEXT:    call void @recur() #[[ATTR12]]
// CHECK-NEXT:    [[CALL:%.*]] = call i32 @goo() #[[ATTR12]]
...
// CHECK-NEXT:    call void @f(ptr noundef @fmv.ifunc) #[[ATTR12]]
...
// CHECK-NEXT:    [[CALL:%.*]] = call i32 [[TMP0]]() #[[ATTR12]]
// CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[FP2]], align 8
// CHECK-NEXT:    [[CALL1:%.*]] = call i32 [[TMP1]]() #[[ATTR12]]
// CHECK-NEXT:    [[ADD:%.*]] = add nsw i32 [[CALL]], [[CALL1]]
...
//
// CHECK: Function Attrs: noconvergent noinline nounwind optnone
// CHECK-LABEL: define {{[^@]+}}@fmv_inline._Mfp16MfcmaMsmeMfp16
...
//
// CHECK: Function Attrs: noconvergent noinline nounwind optnone
// CHECK-LABEL: define {{[^@]+}}@fmv_inline._Mmemtag3
...
//
// CHECK: Function Attrs: noconvergent noinline nounwind optnone
// CHECK-LABEL: define {{[^@]+}}@fmv_d
// CHECK-SAME: () #[[ATTR9]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    ret i32 1
//
//
// CHECK-NOFMV: Function Attrs: noconvergent noinline nounwind optnone
...
// CHECK-NOFMV-SAME: () #[[ATTR0]] {
// CHECK-NOFMV-NEXT:  entry:
// CHECK-NOFMV-NEXT:    [[CALL:%.*]] = call i32 @fmv() #[[ATTR2:[0-9]+]]
// CHECK-NOFMV-NEXT:    [[CALL1:%.*]] = call i32 @fmv_one() #[[ATTR2]]
// CHECK-NOFMV-NEXT:    [[ADD:%.*]] = add nsw i32 [[CALL]], [[CALL1]]
// CHECK-NOFMV-NEXT:    [[CALL2:%.*]] = call i32 @fmv_two() #[[ATTR2]]
...
// CHECK-NOFMV-SAME: () #[[ATTR0]] {
// CHECK-NOFMV-NEXT:  entry:
// CHECK-NOFMV-NEXT:    [[CALL:%.*]] = call i32 @fmv_inline() #[[ATTR2]]
// CHECK-NOFMV-NEXT:    [[CALL1:%.*]] = call i32 @fmv_e() #[[ATTR2]]
// CHECK-NOFMV-NEXT:    [[CALL2:%.*]] = call i32 @fmv_d() #[[ATTR2]]
// CHECK-NOFMV-NEXT:    call void @fmv_c() #[[ATTR2]]
// CHECK-NOFMV-NEXT:    [[CALL3:%.*]] = call i32 @fmv_default() #[[ATTR2]]
...
// CHECK-NOFMV-SAME: () #[[ATTR0]] {
// CHECK-NOFMV-NEXT:  entry:
// CHECK-NOFMV-NEXT:    call void @reca() #[[ATTR2]]
// CHECK-NOFMV-NEXT:    ret void
//
//
// CHECK-NOFMV: Function Attrs: noconvergent noinline nounwind optnone
...
// CHECK-NOFMV-NEXT:    call void @recur() #[[ATTR2]]
// CHECK-NOFMV-NEXT:    [[CALL:%.*]] = call i32 @goo() #[[ATTR2]]
...
// CHECK-NOFMV-NEXT:    call void @f(ptr noundef @fmv) #[[ATTR2]]
...
// CHECK-NOFMV-NEXT:    [[CALL:%.*]] = call i32 [[TMP0]]() #[[ATTR2]]
// CHECK-NOFMV-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[FP2]], align 8
// CHECK-NOFMV-NEXT:    [[CALL1:%.*]] = call i32 [[TMP1]]() #[[ATTR2]]
// CHECK-NOFMV-NEXT:    [[ADD:%.*]] = add nsw i32 [[CALL]], [[CALL1]]
// CHECK-NOFMV-NEXT:    ret i32 [[ADD]]
//
//.
// CHECK: attributes #0 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+flagm,+fp-armv8,+fp16fml,+fullfp16,+ls64,+neon,+rand" }
// CHECK: attributes #1 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+altnzcv,+bf16,+flagm,+fullfp16,+ls64,+sme,+sme-i16i64" }
// CHECK: attributes #2 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+fp-armv8,+fullfp16,+ls64,+lse,+neon,+sha2" }
// CHECK: attributes #3 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+dotprod,+fp-armv8,+fullfp16,+ls64,+neon" }
// CHECK: attributes #4 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+fp-armv8,+fp16fml,+fullfp16,+ls64,+neon" }
// CHECK: attributes #5 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+fp-armv8,+fullfp16,+ls64,+neon" }
// CHECK: attributes #6 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+crc,+fullfp16,+ls64" }
// CHECK: attributes #7 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+bti,+fullfp16,+ls64" }
// CHECK: attributes #8 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+bf16,+fullfp16,+ls64,+sme,+sme2" }
// CHECK: attributes #9 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+fullfp16,+ls64" }
// CHECK: attributes #10 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+ccpp,+fullfp16,+ls64" }
// CHECK: attributes #11 = { noconvergent "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+fullfp16,+ls64" }
// CHECK: attributes #12 = { noconvergent }
// CHECK: attributes #13 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+aes,+f64mm,+fp-armv8,+fullfp16,+ls64,+neon,+sve" }
// CHECK: attributes #14 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+bf16,+complxnum,+fp-armv8,+fullfp16,+ls64,+neon,+sme" }
// CHECK: attributes #15 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+f32mm,+fp-armv8,+fullfp16,+i8mm,+ls64,+neon,+sha2,+sha3,+sve" }
// CHECK: attributes #16 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+bf16,+dit,+fp-armv8,+fullfp16,+ls64,+neon,+sve" }
// CHECK: attributes #17 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+ccpp,+fullfp16,+ls64,+rcpc" }
// CHECK: attributes #18 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+ccdp,+ccpp,+fp-armv8,+fullfp16,+jsconv,+ls64,+neon" }
// CHECK: attributes #19 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+fptoint,+fullfp16,+ls64,+rcpc" }
// CHECK: attributes #20 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+bf16,+fp-armv8,+fullfp16,+ls64,+neon,+sve" }
// CHECK: attributes #21 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+fp-armv8,+fullfp16,+ls64,+neon,+sve,+sve2,+sve2-aes,+sve2-sha3" }
// CHECK: attributes #22 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+fp-armv8,+fullfp16,+ls64,+neon,+sve,+sve2,+sve2-aes,+sve2-bitperm" }
// CHECK: attributes #23 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+fp-armv8,+fullfp16,+ls64,+mte,+neon,+sve,+sve2,+sve2-sm4" }
// CHECK: attributes #24 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+fullfp16,+ls64,+mte" }
// CHECK: attributes #25 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+fullfp16,+ls64,+sb" }
//.
// CHECK-NOFMV: attributes #0 = { noconvergent noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="-fmv" }
// CHECK-NOFMV: attributes #1 = { noconvergent "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="-fmv" }
// CHECK-NOFMV: attributes #2 = { noconvergent }
//.
// CHECK: !0 = !{i32 1, !"wchar_size", i32 4}
//.
// CHECK-NOFMV: !0 = !{i32 1, !"wchar_size", i32 4}
//.
