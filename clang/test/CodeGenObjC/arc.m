...
// CHECK: call void @llvm.objc.release(i8* %[[V8]]) #{{[0-9]+}}, !clang.imprecise_release !10

// CHECK-NOT: call void @llvm.objc.release

// CHECK: %[[V10:.*]] = load i8*, i8** %[[B_ADDR]], align 8
// CHECK: call void @llvm.objc.release(i8* %[[V10]]) #{{[0-9]+}}, !clang.imprecise_release !10
// CHECK: %[[V11:.*]] = load i8*, i8** %[[A_ADDR]], align 8
// CHECK: call void @llvm.objc.release(i8* %[[V11]]) #{{[0-9]+}}, !clang.imprecise_release !10

void test72(id a, id b) {
  __strong id t[] = (__strong id[]){a, b};
}

// ARC-ALIEN: attributes [[NLB]] = { noconvergent nonlazybind }
