...
; RV32-NEXT:    snez s4, t0
; RV32-NEXT:    or t6, t6, t4
; RV32-NEXT:    bnez a1, .LBB1_10
; RV32-NEXT:  # %bb.9: # %_udiv-special-cases
; RV32-NEXT:    srli t0, t6, 1
; RV32-NEXT:    or t0, t6, t0
; RV32-NEXT:    srli t4, t0, 2
; RV32-NEXT:    or t0, t0, t4
; RV32-NEXT:    srli t4, t0, 4
; RV32-NEXT:    or t0, t0, t4
; RV32-NEXT:    srli t4, t0, 8
; RV32-NEXT:    or t0, t0, t4
; RV32-NEXT:    srli t4, t0, 16
; RV32-NEXT:    or t0, t0, t4
; RV32-NEXT:    not t0, t0
; RV32-NEXT:    srli t4, t0, 1
; RV32-NEXT:    and t4, t4, t2
; RV32-NEXT:    sub t0, t0, t4
; RV32-NEXT:    srli t4, t0, 2
; RV32-NEXT:    and t0, t0, a7
; RV32-NEXT:    and t4, t4, a7
; RV32-NEXT:    add t0, t0, t4
; RV32-NEXT:    srli t4, t0, 4
; RV32-NEXT:    add t0, t0, t4
; RV32-NEXT:    and t0, t0, t1
; RV32-NEXT:    slli t4, t0, 8
; RV32-NEXT:    add t0, t0, t4
; RV32-NEXT:    slli t4, t0, 16
; RV32-NEXT:    add t0, t0, t4
; RV32-NEXT:    srli t0, t0, 24
; RV32-NEXT:    addi s1, t0, 32
; RV32-NEXT:    j .LBB1_11
; RV32-NEXT:  .LBB1_10:
; RV32-NEXT:    srli t0, a1, 1
; RV32-NEXT:    or t0, a1, t0
; RV32-NEXT:    srli t4, t0, 2
; RV32-NEXT:    or t0, t0, t4
; RV32-NEXT:    srli t4, t0, 4
; RV32-NEXT:    or t0, t0, t4
...
; RV32-NEXT:    and t6, t2, t5
; RV32-NEXT:    sltu s0, t3, s1
; RV32-NEXT:    seqz a7, a7
; RV32-NEXT:    mv t2, s0
; RV32-NEXT:    beq a1, t6, .LBB1_17
; RV32-NEXT:  # %bb.16: # %_udiv-special-cases
; RV32-NEXT:    sltu t2, a1, t6
; RV32-NEXT:  .LBB1_17: # %_udiv-special-cases
; RV32-NEXT:    or t5, t1, a7
; RV32-NEXT:    andi t2, t2, 1
; RV32-NEXT:    sub a1, a1, t6
; RV32-NEXT:    sub t1, a1, s0
; RV32-NEXT:    sub a7, t3, s1
; RV32-NEXT:    beqz t2, .LBB1_19
...
; RV32-NEXT:    sub t4, t0, s0
; RV32-NEXT:    sub s2, s2, t6
; RV32-NEXT:    or t0, a1, t1
...
; RV32-NEXT:    addi s1, a0, -1
; RV32-NEXT:    and s0, s1, a7
; RV32-NEXT:    and t5, s1, a1
; RV32-NEXT:    and t1, s1, a6
; RV32-NEXT:    and s1, s1, t0
; RV32-NEXT:    bnez a0, .LBB2_32
; RV32-NEXT:  # %bb.22: # %_udiv-special-cases
; RV32-NEXT:    xori a0, t4, 127
; RV32-NEXT:    or a0, a0, t6
; RV32-NEXT:    or s2, t2, t3
; RV32-NEXT:    or a0, a0, s2
; RV32-NEXT:    beqz a0, .LBB2_32
...
; RV32-NEXT:    li a3, 127
; RV32-NEXT:    seqz t5, a0
; RV32-NEXT:    sub a0, a3, t4
; RV32-NEXT:    add t5, t6, t5
; RV32-NEXT:    srli a3, a0, 3
; RV32-NEXT:    sltu a4, t5, t6
...
; RV32-NEXT:    sll a4, s0, t4
; RV32-NEXT:    or s2, a4, a0
; RV32-NEXT:    sll t4, s1, t4
; RV32-NEXT:    li a0, 0
...
; RV32-NEXT:    or t6, t6, s0
; RV32-NEXT:    or a3, a3, a4
; RV32-NEXT:    srli a4, t4, 31
; RV32-NEXT:    slli s2, s2, 1
; RV32-NEXT:    or a4, s2, a4
; RV32-NEXT:    slli t4, t4, 1
; RV32-NEXT:    or t4, a0, t4
...
; RV32-NEXT:    sw a2, 24(sp) # 4-byte Folded Spill
...
; RV32-NEXT:    or a1, t2, s6
; RV32-NEXT:    sltu t2, s0, a4
; RV32-NEXT:    or a2, a3, a2
; RV32-NEXT:    mv t4, t2
...
; RV32-NEXT:    snez t3, t4
; RV32-NEXT:    neg a3, t4
; RV32-NEXT:    neg t3, t3
; RV32-NEXT:    sub t2, a0, t2
; RV32-NEXT:    or t6, a3, t3
; RV32-NEXT:    andi t5, t4, 1
; RV32-NEXT:    sub a0, s0, a4
; RV32-NEXT:    beqz t6, .LBB3_36
; RV32-NEXT:  # %bb.35: # %_udiv-special-cases
; RV32-NEXT:    snez a4, t6
...
; RV32-NEXT:    or s0, a1, a4
; RV32-NEXT:    addi a2, s0, -1
; RV32-NEXT:    and t6, s11, a2
; RV32-NEXT:    and t4, a2, t1
; RV32-NEXT:    and a1, a2, a6
; RV32-NEXT:    and a4, a2, t0
; RV32-NEXT:    and a2, a2, a7
; RV32-NEXT:    bnez s0, .LBB3_55
; RV32-NEXT:  # %bb.39: # %_udiv-special-cases
; RV32-NEXT:    xori s0, a0, 128
; RV32-NEXT:    or s1, t5, a3
; RV32-NEXT:    or s2, t2, t3
; RV32-NEXT:    or s0, s0, s1
; RV32-NEXT:    or s0, s0, s2
; RV32-NEXT:    beqz s0, .LBB3_55
...
; RV32-NEXT:    sll s1, s1, a0
; RV32-NEXT:    or s5, t6, s3
; RV32-NEXT:    or s2, s1, s2
; RV32-NEXT:    sll t6, s4, a0
; RV32-NEXT:    beqz s5, .LBB3_53
...
; RV32-NEXT:    andi t1, a1, 31
; RV32-NEXT:    slli a4, a4, 1
; RV32-NEXT:    xori t1, t1, 31
; RV32-NEXT:    srl s1, t0, a1
; RV32-NEXT:    sll a4, a4, t1
; RV32-NEXT:    or a3, a0, a3
; RV32-NEXT:    or s11, s1, a4
; RV32-NEXT:    li s1, 0
; RV32-NEXT:    srl a0, a7, a1
; RV32-NEXT:    slli t0, t0, 1
; RV32-NEXT:    sll a4, t0, t1
; RV32-NEXT:    slli a7, a7, 1
; RV32-NEXT:    srl t0, a6, a1
; RV32-NEXT:    sll a7, a7, t1
; RV32-NEXT:    or a0, a0, a4
; RV32-NEXT:    or s5, t0, a7
; RV32-NEXT:    andi ra, a3, 1
; RV32-NEXT:    or a3, a5, s6
; RV32-NEXT:    srl a2, a2, a1
; RV32-NEXT:    snez a3, a3
; RV32-NEXT:    slli a6, a6, 1
; RV32-NEXT:    lw a4, 36(sp) # 4-byte Folded Reload
; RV32-NEXT:    add a3, a4, a3
; RV32-NEXT:    sll a4, a6, t1
; RV32-NEXT:    not a3, a3
...
; RV32-NEXT:    li s9, 0
; RV32-NEXT:    li s10, 0
; RV32-NEXT:    lw a6, 12(sp) # 4-byte Folded Reload
...
; RV32-NEXT:    lw a5, 16(sp) # 4-byte Folded Reload
...
; RV64-NEXT:    slli s4, a7, 1
; RV64-NEXT:    slli t2, t2, 1
; RV64-NEXT:    or s1, s4, s1
; RV64-NEXT:    srli s4, a7, 63
; RV64-NEXT:    or t2, t5, t2
; RV64-NEXT:    or a7, t6, s1
...
; RV64-NEXT:    slli a2, a7, 1
; RV64-NEXT:    slli a3, t2, 1
; RV64-NEXT:    or t2, a2, a1
; RV64-NEXT:    srli a6, a7, 63
