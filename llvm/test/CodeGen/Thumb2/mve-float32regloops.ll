...
; CHECK-NEXT:  .LBB19_1: @ in Loop: Header=BB19_4 Depth=1
; CHECK-NEXT:    mov r2, r3
; CHECK-NEXT:    mov r3, r8
; CHECK-NEXT:    mov r5, r11
; CHECK-NEXT:    mov r8, r12
; CHECK-NEXT:  .LBB19_2: @ %if.end69
; CHECK-NEXT:    @ in Loop: Header=BB19_4 Depth=1
; CHECK-NEXT:    ldr r7, [sp, #12] @ 4-byte Reload
; CHECK-NEXT:  .LBB19_3: @ %if.end69
; CHECK-NEXT:    @ in Loop: Header=BB19_4 Depth=1
; CHECK-NEXT:    strd r2, r5, [r9]
...
; CHECK-NEXT:    mov r1, r2
; CHECK-NEXT:    beq.w .LBB19_14
; CHECK-NEXT:  .LBB19_4: @ %do.body
; CHECK-NEXT:    @ =>This Loop Header: Depth=1
; CHECK-NEXT:    @ Child Loop BB19_6 Depth 2
; CHECK-NEXT:    ldrd r3, r11, [r9]
; CHECK-NEXT:    mov r6, r2
; CHECK-NEXT:    ldrd r8, r12, [r9, #8]
; CHECK-NEXT:    ldr r2, [sp] @ 4-byte Reload
; CHECK-NEXT:    str r7, [sp, #12] @ 4-byte Spill
; CHECK-NEXT:    wls lr, r2, .LBB19_7
; CHECK-NEXT:  @ %bb.5: @ %while.body.lr.ph
; CHECK-NEXT:    @ in Loop: Header=BB19_4 Depth=1
; CHECK-NEXT:    ldr r6, [sp, #8] @ 4-byte Reload
; CHECK-NEXT:  .LBB19_6: @ %while.body
; CHECK-NEXT:    @ Parent Loop BB19_4 Depth=1
; CHECK-NEXT:    @ => This Inner Loop Header: Depth=2
; CHECK-NEXT:    mov r5, r3
; CHECK-NEXT:    ldr r3, [r1, #12]
...
; CHECK-NEXT:    vfma.f32 q2, q0, r12
; CHECK-NEXT:    mov r10, r3
; CHECK-NEXT:    vmov r12, r8, d5
; CHECK-NEXT:    vstrb.8 q2, [r6], #16
; CHECK-NEXT:    le lr, .LBB19_6
; CHECK-NEXT:  .LBB19_7: @ %while.end
; CHECK-NEXT:    @ in Loop: Header=BB19_4 Depth=1
...
; CHECK-NEXT:    bne .LBB19_10
; CHECK-NEXT:  @ %bb.9: @ %if.then58
; CHECK-NEXT:    @ in Loop: Header=BB19_4 Depth=1
...
; CHECK-NEXT:  @ %bb.11: @ in Loop: Header=BB19_4 Depth=1
; CHECK-NEXT:    mov r2, r5
; CHECK-NEXT:    mov r3, r8
; CHECK-NEXT:    mov r5, lr
; CHECK-NEXT:    mov r8, r4
; CHECK-NEXT:    b .LBB19_13
; CHECK-NEXT:  .LBB19_12: @ %if.else64
; CHECK-NEXT:    @ in Loop: Header=BB19_4 Depth=1
; CHECK-NEXT:    vmov r3, s2
; CHECK-NEXT:    vstr s2, [r6, #8]
; CHECK-NEXT:  .LBB19_13: @ %if.end69
; CHECK-NEXT:    @ in Loop: Header=BB19_4 Depth=1
; CHECK-NEXT:    mov r10, r1
; CHECK-NEXT:    b .LBB19_3
; CHECK-NEXT:  .LBB19_14: @ %do.end
