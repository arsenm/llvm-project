...
; GFX9-NEXT:    s_lshr_b32 s1, s6, 24
; GFX9-NEXT:    ds_write_b8 v0, v3 offset:8
; GFX9-NEXT:    ds_write_b8_d16_hi v0, v3 offset:10
...
; GFX9-NEXT:    s_lshr_b32 s2, s5, 8
; GFX9-NEXT:    ds_write_b8 v0, v1 offset:9
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    s_lshr_b32 s3, s5, 24
...
; GFX6-NEXT:    ds_write_b8 v0, v3 offset:8
...
; GFX6-NEXT:    s_lshr_b32 s8, s0, 8
; GFX6-NEXT:    ds_write_b8 v0, v1 offset:7
; GFX6-NEXT:    v_mov_b32_e32 v1, s1
; GFX6-NEXT:    s_lshr_b32 s9, s0, 24
...
; GFX11-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v3, s2
...
; GFX9-NEXT:    v_mov_b32_e32 v1, s5
; GFX9-NEXT:    v_mov_b32_e32 v2, s4
; GFX9-NEXT:    ds_write_b16 v0, v3 offset:8
; GFX9-NEXT:    ds_write_b16_d16_hi v0, v3 offset:10
...
; GFX7-NEXT:    v_mov_b32_e32 v2, s0
; GFX7-NEXT:    s_lshr_b32 s1, s1, 16
; GFX7-NEXT:    ds_write_b16 v0, v3 offset:8
...
; GFX6-NEXT:    v_mov_b32_e32 v2, s0
; GFX6-NEXT:    s_lshr_b32 s1, s1, 16
; GFX6-NEXT:    ds_write_b16 v0, v3 offset:8
...
; GFX9-NEXT:    v_mov_b32_e32 v2, s6
; GFX9-NEXT:    ds_write2_b32 v0, v3, v1 offset1:1
; GFX9-NEXT:    ds_write_b32 v0, v2 offset:8
; GFX9-NEXT:    s_endpgm
;
...
; GFX7-NEXT:    ds_write2_b32 v0, v3, v1 offset1:1
; GFX7-NEXT:    ds_write_b32 v0, v2 offset:8
; GFX7-NEXT:    s_endpgm
;
...
; GFX6-NEXT:    ds_write_b32 v0, v3 offset:8
...
; GFX10-NEXT:    ds_write_b32 v0, v2 offset:8
; GFX10-NEXT:    ds_write2_b32 v0, v1, v3 offset1:1
; GFX10-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v1, s1
; GFX11-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v3, s2
; GFX11-NEXT:    ds_store_2addr_b32 v0, v2, v1 offset1:1
