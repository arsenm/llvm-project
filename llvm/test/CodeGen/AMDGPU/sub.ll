...
; GFX6-NEXT:    buffer_load_ushort v2, v[0:1], s[4:7], 0 addr64 glc
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    buffer_load_ushort v0, v[0:1], s[4:7], 0 addr64 offset:2 glc
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    s_mov_b32 s2, -1
...
; GFX6-NEXT:    buffer_load_dwordx2 v[0:1], v[0:1], s[0:3], 0 addr64
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    v_sub_i32_e32 v0, vcc, v2, v0
...
; GFX6-NEXT:    buffer_load_dwordx4 v[4:7], v[4:5], s[0:3], 0 addr64
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    v_sub_i32_e32 v2, vcc, v2, v6
...
; GFX6-NEXT:    s_mov_b32 s11, s7
; GFX6-NEXT:    s_mov_b64 s[2:3], s[10:11]
; GFX6-NEXT:    buffer_load_dwordx4 v[0:3], v[12:13], s[0:3], 0 addr64
; GFX6-NEXT:    buffer_load_dwordx4 v[4:7], v[12:13], s[8:11], 0 addr64
; GFX6-NEXT:    buffer_load_dwordx4 v[8:11], v[12:13], s[8:11], 0 addr64 offset:16
; GFX6-NEXT:    buffer_load_dwordx4 v[12:15], v[12:13], s[0:3], 0 addr64 offset:16
; GFX6-NEXT:    s_mov_b32 s6, -1
...
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    v_sub_i32_e32 v6, vcc, v10, v14
; GFX6-NEXT:    v_subb_u32_e32 v7, vcc, v11, v15, vcc
; GFX6-NEXT:    v_sub_i32_e32 v4, vcc, v8, v12
; GFX6-NEXT:    v_subb_u32_e32 v5, vcc, v9, v13, vcc
...
; GFX8-NEXT:    v_mov_b32_e32 v1, s1
; GFX8-NEXT:    v_add_u32_e32 v10, vcc, s0, v0
...
; GFX8-NEXT:    v_add_u32_e32 v12, vcc, 16, v8
; GFX8-NEXT:    v_addc_u32_e32 v13, vcc, 0, v9, vcc
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, 16, v10
; GFX8-NEXT:    v_addc_u32_e32 v9, vcc, 0, v11, vcc
...
; GFX8-NEXT:    v_sub_u32_e32 v6, vcc, v14, v10
; GFX8-NEXT:    v_subb_u32_e32 v7, vcc, v15, v11, vcc
; GFX8-NEXT:    v_sub_u32_e32 v4, vcc, v12, v8
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    v_subb_u32_e32 v5, vcc, v13, v9, vcc
; GFX8-NEXT:    v_mov_b32_e32 v1, s1
