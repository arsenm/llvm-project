...
; GFX12-NEXT:  ; %bb.3:
; GFX12-NEXT:    s_bcnt1_i32_b32 s0, s6
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
...
; GFX942-NEXT:    v_mbcnt_lo_u32_b32 v1, s6, 0
; GFX942-NEXT:    v_mbcnt_hi_u32_b32 v1, s7, v1
; GFX942-NEXT:    v_cmp_eq_u32_e64 s[0:1], 0, v1
; GFX942-NEXT:    s_and_saveexec_b64 s[8:9], s[0:1]
; GFX942-NEXT:    s_cbranch_execz .LBB28_4
; GFX942-NEXT:  ; %bb.3:
; GFX942-NEXT:    s_bcnt1_i32_b64 s0, s[6:7]
; GFX942-NEXT:    v_cvt_f32_ubyte0_e32 v1, s0
...
; GFX11-NEXT:  ; %bb.3:
; GFX11-NEXT:    s_bcnt1_i32_b32 s0, s6
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX10-NEXT:    s_and_saveexec_b32 s7, s0
; GFX10-NEXT:    s_cbranch_execz .LBB28_4
; GFX10-NEXT:  ; %bb.3:
; GFX10-NEXT:    s_bcnt1_i32_b32 s0, s6
...
; GFX90A-NEXT:    s_and_saveexec_b64 s[8:9], s[0:1]
; GFX90A-NEXT:    s_cbranch_execz .LBB28_4
; GFX90A-NEXT:  ; %bb.3:
; GFX90A-NEXT:    s_bcnt1_i32_b64 s0, s[6:7]
; GFX90A-NEXT:    v_cvt_f32_ubyte0_e32 v1, s0
...
; GFX908-NEXT:    s_and_saveexec_b64 s[8:9], s[0:1]
; GFX908-NEXT:    s_cbranch_execz .LBB28_4
; GFX908-NEXT:  ; %bb.3:
; GFX908-NEXT:    s_bcnt1_i32_b64 s0, s[6:7]
; GFX908-NEXT:    v_cvt_f32_ubyte0_e32 v1, s0
...
; GFX8-NEXT:    s_and_saveexec_b64 s[8:9], s[0:1]
