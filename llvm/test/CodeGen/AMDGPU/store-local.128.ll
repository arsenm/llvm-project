...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x4
...
; GFX9-NEXT:    s_lshr_b32 s1, s7, 24
; GFX9-NEXT:    ds_write_b8 v0, v4 offset:12
; GFX9-NEXT:    ds_write_b8_d16_hi v0, v4 offset:14
...
; GFX7-NEXT:    s_lshr_b32 s6, s3, 16
; GFX7-NEXT:    ds_write_b8 v0, v1 offset:13
; GFX7-NEXT:    v_mov_b32_e32 v1, s5
; GFX7-NEXT:    s_lshr_b32 s7, s2, 8
...
; GFX7-NEXT:    s_lshr_b32 s11, s0, 8
; GFX7-NEXT:    ds_write_b8 v0, v1 offset:7
; GFX7-NEXT:    v_mov_b32_e32 v1, s1
; GFX7-NEXT:    s_lshr_b32 s12, s0, 24
...
; GFX6-NEXT:    s_lshr_b32 s5, s3, 24
; GFX6-NEXT:    ds_write_b8 v0, v4 offset:12
...
; GFX6-NEXT:    v_mov_b32_e32 v1, s2
; GFX6-NEXT:    s_lshr_b32 s10, s1, 24
...
; GFX6-NEXT:    s_lshr_b32 s11, s0, 8
; GFX6-NEXT:    ds_write_b8 v0, v1 offset:7
; GFX6-NEXT:    v_mov_b32_e32 v1, s1
; GFX6-NEXT:    s_lshr_b32 s12, s0, 24
...
; GFX11-NEXT:    v_dual_mov_b32 v6, s5 :: v_dual_mov_b32 v7, s6
; GFX11-NEXT:    s_lshr_b32 s4, s3, 8
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v4, s3 :: v_dual_mov_b32 v5, s4
; GFX11-NEXT:    v_dual_mov_b32 v8, s2 :: v_dual_mov_b32 v9, s7
...
; GFX11-NEXT:    ds_store_b8 v0, v4 offset:12
...
; GFX11-NEXT:    ds_store_b8_d16_hi v0, v4 offset:14
; GFX11-NEXT:    ds_store_b8 v0, v6 offset:15
; GFX11-NEXT:    v_dual_mov_b32 v1, s1 :: v_dual_mov_b32 v10, s8
...
; GFX9-NEXT:    v_mov_b32_e32 v2, s5
; GFX9-NEXT:    v_mov_b32_e32 v3, s4
; GFX9-NEXT:    ds_write_b16 v0, v4 offset:12
; GFX9-NEXT:    ds_write_b16_d16_hi v0, v4 offset:14
...
; GFX7-NEXT:    v_mov_b32_e32 v3, s0
; GFX7-NEXT:    s_lshr_b32 s2, s2, 16
; GFX7-NEXT:    ds_write_b16 v0, v4 offset:12
...
; GFX6-NEXT:    v_mov_b32_e32 v3, s0
; GFX6-NEXT:    s_lshr_b32 s2, s2, 16
; GFX6-NEXT:    ds_write_b16 v0, v4 offset:12
...
; GFX9-NEXT:    v_mov_b32_e32 v2, s6
; GFX9-NEXT:    v_mov_b32_e32 v3, s7
; GFX9-NEXT:    ds_write2_b32 v0, v4, v1 offset1:1
; GFX9-NEXT:    ds_write2_b32 v0, v2, v3 offset0:2 offset1:3
; GFX9-NEXT:    s_endpgm
;
...
; GFX7-NEXT:    v_mov_b32_e32 v2, s2
; GFX7-NEXT:    v_mov_b32_e32 v3, s3
; GFX7-NEXT:    ds_write2_b32 v0, v4, v1 offset1:1
; GFX7-NEXT:    ds_write2_b32 v0, v2, v3 offset0:2 offset1:3
; GFX7-NEXT:    s_endpgm
;
...
; GFX6-NEXT:    ds_write2_b32 v0, v4, v1 offset0:2 offset1:3
; GFX6-NEXT:    ds_write2_b32 v0, v2, v3 offset1:1
; GFX6-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    ds_write2_b32 v0, v3, v1 offset0:2 offset1:3
; GFX10-NEXT:    ds_write2_b32 v0, v2, v4 offset1:1
; GFX10-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    ds_store_2addr_b32 v0, v3, v1 offset1:1
; GFX11-NEXT:    ds_store_2addr_b32 v0, v2, v4 offset0:2 offset1:3
; GFX11-NEXT:    s_endpgm
...
; GFX9-NEXT:    ds_write2_b64 v4, v[2:3], v[0:1] offset1:1
; GFX9-NEXT:    s_endpgm
;
...
; GFX7-NEXT:    ds_write2_b64 v4, v[2:3], v[0:1] offset1:1
; GFX7-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_mov_b32_e32 v4, s4
; GFX11-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v3, s1
; GFX11-NEXT:    v_dual_mov_b32 v1, s3 :: v_dual_mov_b32 v2, s0
; GFX11-NEXT:    ds_store_2addr_b64 v4, v[2:3], v[0:1] offset1:1
; GFX11-NEXT:    s_endpgm
