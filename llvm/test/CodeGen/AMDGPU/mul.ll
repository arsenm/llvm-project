...
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_hi_i32 s2, s4, 0x50
; GFX10-NEXT:    s_mulk_i32 s4, 0x50
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mul_hi_i32 s2, s4, 0x50
; GFX11-NEXT:    s_mulk_i32 s4, 0x50
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v1, s2 :: v_dual_mov_b32 v0, s4
...
; GFX12-NEXT:    s_mul_u64 s[2:3], s[4:5], 0x50
...
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_hi_u32 s2, s4, 0x50
; GFX10-NEXT:    s_mulk_i32 s4, 0x50
; GFX10-NEXT:    v_mov_b32_e32 v1, s2
; GFX10-NEXT:    v_mov_b32_e32 v0, s4
; GFX10-NEXT:    s_mov_b32 s2, -1
...
; GFX11-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mul_hi_u32 s2, s4, 0x50
; GFX11-NEXT:    s_mulk_i32 s4, 0x50
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v1, s2 :: v_dual_mov_b32 v0, s4
; GFX11-NEXT:    s_mov_b32 s2, -1
...
; SI-NEXT:    s_mul_i32 s1, s6, s1
; SI-NEXT:    s_mul_i32 s2, s7, s0
; SI-NEXT:    s_mul_i32 s3, s6, s0
; SI-NEXT:    v_add_i32_e32 v0, vcc, s1, v0
; SI-NEXT:    s_mov_b32 s7, 0xf000
; SI-NEXT:    s_mov_b32 s6, -1
; SI-NEXT:    v_add_i32_e32 v1, vcc, s2, v0
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_mul_i32 s2, s6, s1
; VI-NEXT:    s_mul_i32 s3, s7, s0
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s6, v0, 0
; VI-NEXT:    s_mov_b32 s7, 0xf000
; VI-NEXT:    s_mov_b32 s6, -1
...
; VI-NEXT:    buffer_load_dwordx2 v[2:3], off, s[0:3], 0
; VI-NEXT:    s_mov_b32 s8, s4
; VI-NEXT:    s_mov_b32 s9, s5
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_mul_lo_u32 v5, v0, v3
; VI-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], v0, v2, 0
; VI-NEXT:    v_mul_lo_u32 v0, v1, v2
; VI-NEXT:    v_add_u32_e32 v1, vcc, v5, v4
; VI-NEXT:    v_add_u32_e32 v4, vcc, v1, v0
; VI-NEXT:    buffer_store_dwordx2 v[3:4], off, s[8:11], 0
; VI-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    buffer_load_dwordx2 v[2:3], off, s[0:3], 0
; GFX9-NEXT:    s_mov_b32 s8, s4
; GFX9-NEXT:    s_mov_b32 s9, s5
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    buffer_load_dwordx2 v[2:3], off, s[0:3], 0
; GFX10-NEXT:    s_mov_b32 s8, s4
; GFX10-NEXT:    s_mov_b32 s9, s5
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], 0
; GFX11-NEXT:    s_mov_b32 s8, s4
; GFX11-NEXT:    s_mov_b32 s9, s5
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], null
; GFX12-NEXT:    s_mov_b32 s8, s4
; GFX12-NEXT:    s_mov_b32 s9, s5
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; SI-LABEL: s_mul_i128:
; SI:       ; %bb.0: ; %entry
; SI-NEXT:    s_load_dwordx4 s[8:11], s[2:3], 0x13
; SI-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x1f
; SI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-NEXT:    v_mul_hi_u32 v2, s8, v1
; SI-NEXT:    v_mul_hi_u32 v5, s9, v1
; SI-NEXT:    v_mov_b32_e32 v1, s10
; SI-NEXT:    v_mul_hi_u32 v1, s4, v1
; SI-NEXT:    v_mul_hi_u32 v0, s6, v0
; SI-NEXT:    s_mul_i32 s11, s4, s11
; SI-NEXT:    s_mul_i32 s14, s6, s9
; SI-NEXT:    v_mov_b32_e32 v3, s4
; SI-NEXT:    s_mul_i32 s12, s5, s10
; SI-NEXT:    s_mul_i32 s13, s4, s10
; SI-NEXT:    s_mul_i32 s7, s7, s8
; SI-NEXT:    v_mul_hi_u32 v4, s9, v3
; SI-NEXT:    v_mul_hi_u32 v3, s8, v3
; SI-NEXT:    v_add_i32_e32 v1, vcc, s11, v1
; SI-NEXT:    v_add_i32_e32 v0, vcc, s14, v0
; SI-NEXT:    s_mul_i32 s15, s6, s8
; SI-NEXT:    v_add_i32_e32 v1, vcc, s12, v1
; SI-NEXT:    v_add_i32_e32 v0, vcc, s7, v0
; SI-NEXT:    v_mov_b32_e32 v6, s13
; SI-NEXT:    v_add_i32_e32 v6, vcc, s15, v6
; SI-NEXT:    s_mul_i32 s17, s9, s4
; SI-NEXT:    v_addc_u32_e32 v0, vcc, v0, v1, vcc
; SI-NEXT:    v_add_i32_e32 v1, vcc, s17, v3
; SI-NEXT:    s_mul_i32 s16, s8, s5
; SI-NEXT:    v_addc_u32_e32 v3, vcc, 0, v4, vcc
; SI-NEXT:    v_add_i32_e32 v1, vcc, s16, v1
; SI-NEXT:    v_addc_u32_e32 v2, vcc, 0, v2, vcc
; SI-NEXT:    s_mul_i32 s9, s9, s5
; SI-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; SI-NEXT:    s_mul_i32 s8, s8, s4
; SI-NEXT:    v_addc_u32_e64 v3, s[4:5], 0, 0, vcc
; SI-NEXT:    v_add_i32_e32 v2, vcc, s9, v2
...
; VI-LABEL: s_mul_i128:
; VI:       ; %bb.0: ; %entry
; VI-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x7c
; VI-NEXT:    s_load_dwordx4 s[8:11], s[2:3], 0x4c
; VI-NEXT:    v_mov_b32_e32 v2, 0
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v3, s4
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s8, v3, 0
; VI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
; VI-NEXT:    v_mov_b32_e32 v6, s5
; VI-NEXT:    v_mad_u64_u32 v[3:4], s[2:3], s9, v3, v[1:2]
; VI-NEXT:    s_mul_i32 s11, s4, s11
; VI-NEXT:    s_mul_i32 s12, s5, s10
; VI-NEXT:    v_mov_b32_e32 v5, v4
; VI-NEXT:    v_mov_b32_e32 v4, v2
; VI-NEXT:    v_mad_u64_u32 v[1:2], s[2:3], s8, v6, v[3:4]
; VI-NEXT:    v_mov_b32_e32 v7, s8
; VI-NEXT:    s_mul_i32 s5, s7, s8
; VI-NEXT:    v_mov_b32_e32 v4, v2
; VI-NEXT:    v_mov_b32_e32 v2, s10
; VI-NEXT:    v_mad_u64_u32 v[2:3], s[2:3], s4, v2, 0
; VI-NEXT:    v_add_u32_e32 v4, vcc, v5, v4
; VI-NEXT:    v_addc_u32_e64 v5, s[2:3], 0, 0, vcc
; VI-NEXT:    v_add_u32_e32 v3, vcc, s11, v3
; VI-NEXT:    v_add_u32_e32 v3, vcc, s12, v3
; VI-NEXT:    v_mad_u64_u32 v[2:3], s[2:3], s6, v7, v[2:3]
; VI-NEXT:    v_mad_u64_u32 v[4:5], s[2:3], s9, v6, v[4:5]
; VI-NEXT:    s_mul_i32 s7, s6, s9
...
; GFX11-NEXT:    v_dual_mov_b32 v3, s5 :: v_dual_mov_b32 v0, s2
; GFX11-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-NEXT:    s_mov_b32 s2, -1
...
; GFX12-NEXT:    s_mul_u64 s[20:21], s[14:15], s[12:13]
; GFX12-NEXT:    s_mul_u64 s[18:19], s[16:17], s[12:13]
; GFX12-NEXT:    s_mov_b32 s12, s21
; GFX12-NEXT:    s_mul_u64 s[6:7], s[6:7], s[8:9]
; GFX12-NEXT:    s_mov_b32 s2, s5
; GFX12-NEXT:    s_add_nc_u64 s[8:9], s[18:19], s[12:13]
; GFX12-NEXT:    s_mul_u64 s[10:11], s[4:5], s[10:11]
; GFX12-NEXT:    s_mul_u64 s[4:5], s[14:15], s[2:3]
; GFX12-NEXT:    s_mov_b32 s12, s9
; GFX12-NEXT:    s_mov_b32 s9, s13
; GFX12-NEXT:    s_mul_u64 s[2:3], s[16:17], s[2:3]
; GFX12-NEXT:    s_add_nc_u64 s[4:5], s[4:5], s[8:9]
; GFX12-NEXT:    s_add_nc_u64 s[6:7], s[6:7], s[10:11]
; GFX12-NEXT:    s_mov_b32 s14, s5
; GFX12-NEXT:    s_mov_b32 s9, s4
; GFX12-NEXT:    s_add_nc_u64 s[4:5], s[12:13], s[14:15]
; GFX12-NEXT:    s_mov_b32 s21, s13
; GFX12-NEXT:    s_mov_b32 s8, s13
; GFX12-NEXT:    s_add_nc_u64 s[2:3], s[2:3], s[4:5]
; GFX12-NEXT:    s_or_b64 s[4:5], s[20:21], s[8:9]
; GFX12-NEXT:    s_add_nc_u64 s[2:3], s[2:3], s[6:7]
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_dual_mov_b32 v1, s5 :: v_dual_mov_b32 v2, s2
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    v_dual_mov_b32 v3, s3 :: v_dual_mov_b32 v0, s4
; GFX12-NEXT:    s_mov_b32 s3, 0x31016000
; GFX12-NEXT:    s_mov_b32 s2, -1
