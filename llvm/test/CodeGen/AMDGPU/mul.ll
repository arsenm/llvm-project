...
; VI-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v2, v0, 0
...
; GFX1250-NEXT:    s_load_b64 s[12:13], s[4:5], 0x34 nv
; GFX1250-NEXT:    s_mov_b32 s2, -1
; GFX1250-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1250-NEXT:    s_mov_b32 s14, s2
...
; GFX10-NEXT:    s_load_dwordx4 s[12:15], s[4:5], 0x7c
; GFX10-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x24
; GFX10-NEXT:    s_mov_b32 s6, 0
; GFX10-NEXT:    s_mov_b32 s5, s6
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_i32 s3, s12, s3
; GFX10-NEXT:    s_mul_hi_u32 s4, s12, s2
; GFX10-NEXT:    s_mul_i32 s10, s14, s1
; GFX10-NEXT:    s_mul_hi_u32 s11, s14, s0
; GFX10-NEXT:    s_mul_i32 s7, s13, s2
; GFX10-NEXT:    s_mul_i32 s15, s15, s0
; GFX10-NEXT:    s_add_i32 s3, s4, s3
; GFX10-NEXT:    s_add_i32 s4, s11, s10
; GFX10-NEXT:    s_mul_i32 s2, s12, s2
; GFX10-NEXT:    s_mul_i32 s14, s14, s0
; GFX10-NEXT:    s_add_i32 s3, s3, s7
; GFX10-NEXT:    s_add_i32 s4, s4, s15
; GFX10-NEXT:    s_mul_i32 s19, s1, s12
; GFX10-NEXT:    s_mul_hi_u32 s20, s0, s12
; GFX10-NEXT:    s_add_u32 s2, s14, s2
; GFX10-NEXT:    s_mul_hi_u32 s18, s1, s12
; GFX10-NEXT:    s_addc_u32 s3, s4, s3
; GFX10-NEXT:    s_mul_i32 s17, s0, s13
; GFX10-NEXT:    s_add_u32 s4, s19, s20
; GFX10-NEXT:    s_mul_hi_u32 s16, s0, s13
; GFX10-NEXT:    s_addc_u32 s10, s18, 0
; GFX10-NEXT:    s_add_u32 s7, s17, s4
; GFX10-NEXT:    s_addc_u32 s11, s16, 0
; GFX10-NEXT:    s_mul_hi_u32 s21, s1, s13
; GFX10-NEXT:    s_mul_i32 s1, s1, s13
; GFX10-NEXT:    s_mul_i32 s4, s0, s12
; GFX10-NEXT:    s_add_u32 s0, s10, s11
; GFX10-NEXT:    s_addc_u32 s10, 0, 0
; GFX10-NEXT:    s_add_u32 s0, s1, s0
; GFX10-NEXT:    s_addc_u32 s1, s21, s10
...
; GFX10-NEXT:    s_mov_b32 s11, 0x31016000
; GFX10-NEXT:    s_mov_b32 s10, -1
; GFX10-NEXT:    buffer_store_dwordx4 v[0:3], off, s[8:11], 0
; GFX10-NEXT:    s_endpgm
;
