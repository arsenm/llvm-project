...
; GFX9-GISEL-NEXT:    s_ff1_i32_b32 s2, s4
...
; SI-NEXT:    buffer_load_ubyte v0, off, s[0:3], 0 offset:1
; SI-NEXT:    buffer_load_ubyte v1, off, s[0:3], 0 offset:3
; SI-NEXT:    buffer_load_ubyte v2, off, s[0:3], 0
; SI-NEXT:    buffer_load_ubyte v3, off, s[0:3], 0 offset:2
...
; SI-NEXT:    buffer_load_ubyte v3, off, s[4:7], 0 offset:1
; SI-NEXT:    buffer_load_ubyte v4, off, s[4:7], 0 offset:2
; SI-NEXT:    buffer_load_ubyte v5, off, s[4:7], 0 offset:3
...
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_or_b32_e32 v4, 0x100, v2
; VI-NEXT:    v_and_b32_e32 v2, 0xffff, v2
