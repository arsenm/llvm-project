...
; GFX8-NEXT:    s_ashr_i32 s6, s4, 31
; GFX8-NEXT:    s_add_i32 s4, s4, s6
; GFX8-NEXT:    v_mul_hi_u32 v1, v0, v1
; GFX8-NEXT:    s_xor_b32 s4, s4, s6
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    s_xor_b32 s2, s6, s8
; GFX8-NEXT:    v_mul_lo_u32 v5, v4, s5
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, 1, v4
; GFX8-NEXT:    v_sub_u32_e32 v5, vcc, s4, v5
; GFX8-NEXT:    v_cmp_le_u32_e32 vcc, s5, v5
; GFX8-NEXT:    v_cndmask_b32_e32 v4, v4, v6, vcc
; GFX8-NEXT:    v_subrev_u32_e64 v6, s[0:1], s5, v5
...
; GFX8-NEXT:    v_subrev_u32_e64 v6, s[0:1], s5, v5
; GFX8-NEXT:    v_cndmask_b32_e32 v5, v5, v6, vcc
; GFX8-NEXT:    v_xor_b32_e32 v4, s2, v4
; GFX8-NEXT:    v_subrev_u32_e32 v4, vcc, s2, v4
; GFX8-NEXT:    v_xor_b32_e32 v5, s6, v5
; GFX8-NEXT:    v_subrev_u32_e32 v5, vcc, s6, v5
; GFX8-NEXT:    flat_store_dword v[2:3], v4
; GFX8-NEXT:    flat_store_dword v[0:1], v5
; GFX8-NEXT:    s_endpgm
;
; GFX9-LABEL: sdivrem_i32:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[6:7], 0x10
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_load_dwordx2 s[0:1], s[6:7], 0x10
...
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[10:11], s14, v3, 0
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], s14, v4, v[1:2]
; GFX8-NEXT:    v_mul_hi_u32 v5, v3, v0
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], s15, v3, v[1:2]
...
; GFX8-NEXT:    v_mul_hi_u32 v4, s0, v0
...
; GFX8-NEXT:    v_mul_hi_u32 v3, s0, v1
...
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[10:11], s8, v4, 0
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v3, v2
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v5, v2
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], s8, v3, v[1:2]
; GFX8-NEXT:    v_mov_b32_e32 v6, s1
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], s9, v4, v[1:2]
; GFX8-NEXT:    v_mov_b32_e32 v2, s9
; GFX8-NEXT:    v_sub_u32_e32 v5, vcc, s1, v1
; GFX8-NEXT:    v_sub_u32_e32 v0, vcc, s0, v0
; GFX8-NEXT:    v_subb_u32_e64 v1, s[0:1], v6, v1, vcc
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s9, v1
; GFX8-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s8, v0
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s9, v1
; GFX8-NEXT:    v_subb_u32_e32 v5, vcc, v5, v2, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v6, v7, s[0:1]
; GFX8-NEXT:    v_subrev_u32_e32 v7, vcc, s8, v0
; GFX8-NEXT:    v_subbrev_u32_e64 v8, s[0:1], 0, v5, vcc
...
; GFX8-NEXT:    v_subb_u32_e32 v2, vcc, v5, v2, vcc
...
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[12:13], s14, v3, 0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[12:13], s14, v4, v[1:2]
; GFX9-NEXT:    v_mul_hi_u32 v5, v3, v0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[12:13], s15, v3, v[1:2]
...
; GFX9-NEXT:    v_mul_hi_u32 v3, s0, v1
...
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[12:13], s6, v5, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9-NEXT:    v_add_u32_e32 v3, v4, v3
; GFX9-NEXT:    v_add3_u32 v3, v3, v2, v6
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[12:13], s6, v3, v[1:2]
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, s0, v0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[12:13], s7, v5, v[1:2]
; GFX9-NEXT:    v_mov_b32_e32 v2, s7
; GFX9-NEXT:    v_mov_b32_e32 v4, 0
; GFX9-NEXT:    v_sub_u32_e32 v6, s1, v1
; GFX9-NEXT:    v_subb_co_u32_e64 v1, s[0:1], v7, v1, vcc
...
; GFX9-NEXT:    v_subbrev_co_u32_e64 v9, s[0:1], 0, v6, vcc
...
; GFX9-NEXT:    v_subrev_co_u32_e32 v6, vcc, s6, v8
...
; GFX9-NEXT:    v_mul_lo_u32 v3, v0, s5
; GFX9-NEXT:    v_add_u32_e32 v1, v1, v2
; GFX9-NEXT:    v_add_u32_e32 v2, 1, v0
...
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
; GFX9-NEXT:    v_subrev_u32_e32 v2, s5, v3
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v3, v2, vcc
; GFX9-NEXT:    v_add_u32_e32 v3, 1, v0
; GFX9-NEXT:    v_cmp_le_u32_e32 vcc, s5, v2
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v0, v3, vcc
; GFX9-NEXT:    v_subrev_u32_e32 v3, s5, v2
; GFX9-NEXT:    s_xor_b32 s4, s12, s4
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v2, v3, vcc
; GFX9-NEXT:    v_xor_b32_e32 v0, s4, v0
; GFX9-NEXT:    v_mul_lo_u32 v3, v1, s7
; GFX9-NEXT:    v_subrev_u32_e32 v0, s4, v0
; GFX9-NEXT:    s_ashr_i32 s4, s14, 31
; GFX9-NEXT:    s_add_i32 s5, s14, s4
...
; GFX9-NEXT:    v_mul_lo_u32 v6, v3, s5
...
; GFX9-NEXT:    v_cndmask_b32_e32 v3, v3, v6, vcc
; GFX9-NEXT:    v_subrev_u32_e32 v6, s5, v2
; GFX9-NEXT:    s_ashr_i32 s5, s11, 31
; GFX9-NEXT:    s_add_i32 s8, s11, s5
...
; GFX9-NEXT:    v_xor_b32_e32 v6, s7, v6
; GFX9-NEXT:    v_subrev_u32_e32 v3, s4, v3
; GFX9-NEXT:    v_xor_b32_e32 v7, s5, v8
; GFX9-NEXT:    v_mov_b32_e32 v8, 0
; GFX9-NEXT:    v_subrev_u32_e32 v6, s7, v6
...
; GFX10-NEXT:    s_add_i32 s4, s12, s0
; GFX10-NEXT:    s_add_i32 s5, s13, s1
; GFX10-NEXT:    s_add_i32 s12, s14, s2
; GFX10-NEXT:    s_add_i32 s13, s15, s3
; GFX10-NEXT:    s_xor_b32 s14, s4, s0
; GFX10-NEXT:    s_xor_b32 s15, s5, s1
...
; GFX10-NEXT:    s_add_i32 s4, s8, s16
; GFX10-NEXT:    s_add_i32 s5, s9, s17
...
; GFX10-NEXT:    s_xor_b32 s10, s4, s16
; GFX10-NEXT:    s_xor_b32 s11, s5, s17
...
; GFX10-NEXT:    s_load_dwordx4 s[4:7], s[6:7], 0x0
...
; GFX8-NEXT:    s_xor_b64 s[0:1], s[12:13], s[4:5]
; GFX8-NEXT:    v_mul_f32_e32 v0, 0x4f800000, v0
; GFX8-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX8-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX8-NEXT:    s_sub_u32 s18, 0, s6
; GFX8-NEXT:    s_subb_u32 s19, 0, s7
; GFX8-NEXT:    s_xor_b64 s[20:21], s[4:5], s[16:17]
; GFX8-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v0
; GFX8-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
; GFX8-NEXT:    v_trunc_f32_e32 v2, v1
; GFX8-NEXT:    v_mul_f32_e32 v1, 0xcf800000, v2
...
; GFX8-NEXT:    s_mov_b32 s17, s16
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[12:13], s18, v3, 0
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[12:13], s18, v4, v[1:2]
; GFX8-NEXT:    v_mul_hi_u32 v5, v3, v0
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[12:13], s19, v3, v[1:2]
; GFX8-NEXT:    v_mul_lo_u32 v2, v4, v0
; GFX8-NEXT:    v_mul_hi_u32 v0, v4, v0
; GFX8-NEXT:    v_mul_lo_u32 v6, v3, v1
; GFX8-NEXT:    v_mul_lo_u32 v7, v4, v1
...
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v0, v2
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[12:13], s6, v3, 0
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v4, v2
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v5, v2
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[12:13], s6, v2, v[1:2]
; GFX8-NEXT:    v_mov_b32_e32 v1, s1
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[12:13], s7, v3, v[4:5]
; GFX8-NEXT:    s_ashr_i32 s12, s15, 31
; GFX8-NEXT:    s_add_u32 s18, s14, s12
; GFX8-NEXT:    v_sub_u32_e32 v5, vcc, s1, v4
; GFX8-NEXT:    v_sub_u32_e32 v0, vcc, s0, v0
...
; GFX8-NEXT:    v_subb_u32_e32 v10, vcc, v5, v8, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v9, v4, v6, s[0:1]
; GFX8-NEXT:    v_subrev_u32_e32 v4, vcc, s6, v0
; GFX8-NEXT:    v_subbrev_u32_e64 v5, s[0:1], 0, v10, vcc
; GFX8-NEXT:    v_add_u32_e64 v11, s[0:1], 1, v3
; GFX8-NEXT:    v_addc_u32_e64 v12, s[0:1], 0, v2, s[0:1]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s7, v5
; GFX8-NEXT:    s_addc_u32 s19, s15, s12
; GFX8-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[0:1]
; GFX8-NEXT:    s_add_u32 s0, s2, s16
; GFX8-NEXT:    s_addc_u32 s1, s3, s16
; GFX8-NEXT:    s_xor_b64 s[14:15], s[0:1], s[16:17]
; GFX8-NEXT:    v_cvt_f32_u32_e32 v7, s15
; GFX8-NEXT:    v_cvt_f32_u32_e32 v13, s14
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s6, v4
; GFX8-NEXT:    v_cndmask_b32_e64 v14, 0, -1, s[0:1]
; GFX8-NEXT:    v_mul_f32_e32 v7, 0x4f800000, v7
; GFX8-NEXT:    v_add_f32_e32 v7, v7, v13
; GFX8-NEXT:    v_rcp_iflag_f32_e32 v7, v7
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s7, v5
; GFX8-NEXT:    v_cndmask_b32_e64 v13, v6, v14, s[0:1]
; GFX8-NEXT:    s_mov_b32 s13, s12
; GFX8-NEXT:    v_mul_f32_e32 v6, 0x5f7ffffc, v7
; GFX8-NEXT:    v_mul_f32_e32 v7, 0x2f800000, v6
; GFX8-NEXT:    v_trunc_f32_e32 v7, v7
; GFX8-NEXT:    v_mul_f32_e32 v14, 0xcf800000, v7
; GFX8-NEXT:    v_add_f32_e32 v6, v14, v6
; GFX8-NEXT:    v_cvt_u32_f32_e32 v14, v6
; GFX8-NEXT:    s_xor_b64 s[18:19], s[18:19], s[12:13]
; GFX8-NEXT:    s_sub_u32 s5, 0, s14
; GFX8-NEXT:    v_cvt_u32_f32_e32 v15, v7
; GFX8-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], s5, v14, 0
; GFX8-NEXT:    v_add_u32_e64 v16, s[0:1], 1, v11
; GFX8-NEXT:    v_subb_u32_e32 v8, vcc, v10, v8, vcc
; GFX8-NEXT:    v_mul_lo_u32 v10, v15, v6
; GFX8-NEXT:    v_mul_hi_u32 v18, v14, v6
; GFX8-NEXT:    v_mul_hi_u32 v19, v15, v6
; GFX8-NEXT:    v_mov_b32_e32 v6, v7
; GFX8-NEXT:    v_addc_u32_e64 v17, s[0:1], 0, v12, s[0:1]
; GFX8-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], s5, v15, v[6:7]
; GFX8-NEXT:    v_subrev_u32_e32 v20, vcc, s6, v4
; GFX8-NEXT:    s_subb_u32 s6, 0, s15
; GFX8-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], s6, v14, v[6:7]
; GFX8-NEXT:    v_subbrev_u32_e32 v8, vcc, 0, v8, vcc
; GFX8-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
; GFX8-NEXT:    v_cndmask_b32_e32 v7, v11, v16, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v11, v12, v17, vcc
; GFX8-NEXT:    v_mul_lo_u32 v12, v14, v6
; GFX8-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v9
; GFX8-NEXT:    v_cndmask_b32_e64 v9, v3, v7, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v11, v2, v11, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v3, s[2:3], v10, v12
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s[2:3]
; GFX8-NEXT:    v_add_u32_e64 v3, s[2:3], v3, v18
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[2:3]
; GFX8-NEXT:    v_mul_lo_u32 v10, v15, v6
; GFX8-NEXT:    v_add_u32_e64 v3, s[2:3], v7, v3
; GFX8-NEXT:    v_mul_hi_u32 v7, v14, v6
; GFX8-NEXT:    v_add_u32_e64 v10, s[2:3], v10, v19
; GFX8-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s[2:3]
; GFX8-NEXT:    v_add_u32_e64 v7, s[2:3], v10, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v10, 0, 1, s[2:3]
; GFX8-NEXT:    v_add_u32_e64 v10, s[2:3], v12, v10
; GFX8-NEXT:    v_mul_hi_u32 v6, v15, v6
; GFX8-NEXT:    v_add_u32_e64 v3, s[2:3], v7, v3
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s[2:3]
; GFX8-NEXT:    v_add_u32_e64 v7, s[2:3], v10, v7
; GFX8-NEXT:    v_add_u32_e64 v6, s[2:3], v6, v7
; GFX8-NEXT:    v_add_u32_e64 v10, s[2:3], v14, v3
; GFX8-NEXT:    v_addc_u32_e64 v12, s[2:3], v15, v6, s[2:3]
; GFX8-NEXT:    v_mad_u64_u32 v[6:7], s[2:3], s5, v10, 0
; GFX8-NEXT:    v_cndmask_b32_e32 v4, v4, v20, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v5, v5, v8, vcc
; GFX8-NEXT:    v_mov_b32_e32 v2, v7
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[2:3], s5, v12, v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e64 v4, v0, v4, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v5, v1, v5, s[0:1]
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s6, v10, v[2:3]
; GFX8-NEXT:    v_mul_lo_u32 v8, v12, v6
; GFX8-NEXT:    v_mul_hi_u32 v13, v10, v6
; GFX8-NEXT:    v_mul_lo_u32 v7, v10, v2
; GFX8-NEXT:    v_xor_b32_e32 v0, s20, v9
; GFX8-NEXT:    v_xor_b32_e32 v1, s21, v11
; GFX8-NEXT:    v_mov_b32_e32 v3, s21
; GFX8-NEXT:    v_subrev_u32_e32 v0, vcc, s20, v0
; GFX8-NEXT:    v_subb_u32_e32 v1, vcc, v1, v3, vcc
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v8, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v3, v13
; GFX8-NEXT:    v_mul_hi_u32 v6, v12, v6
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v8, v12, v2
...
; GFX8-NEXT:    v_mul_hi_u32 v2, v12, v2
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v6, v3
; GFX8-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v7, v6
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v2, v6
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v10, v3
; GFX8-NEXT:    v_addc_u32_e32 v2, vcc, v12, v2, vcc
; GFX8-NEXT:    v_mul_lo_u32 v6, s19, v3
; GFX8-NEXT:    v_mul_lo_u32 v7, s18, v2
; GFX8-NEXT:    v_xor_b32_e32 v8, s4, v4
; GFX8-NEXT:    v_mul_hi_u32 v4, s18, v3
; GFX8-NEXT:    v_mul_hi_u32 v3, s19, v3
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v6, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v6, v4
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v6, s19, v2
...
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v6, v7
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v3, v4
; GFX8-NEXT:    v_mul_hi_u32 v9, s19, v2
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s14, v7, 0
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v6, v4
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v9, v4
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s14, v6, v[3:4]
; GFX8-NEXT:    v_xor_b32_e32 v5, s4, v5
; GFX8-NEXT:    v_mov_b32_e32 v9, s4
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s15, v7, v[3:4]
; GFX8-NEXT:    v_subrev_u32_e32 v4, vcc, s4, v8
; GFX8-NEXT:    v_subb_u32_e32 v5, vcc, v5, v9, vcc
; GFX8-NEXT:    v_sub_u32_e32 v9, vcc, s19, v3
; GFX8-NEXT:    v_mov_b32_e32 v10, s19
; GFX8-NEXT:    v_sub_u32_e32 v2, vcc, s18, v2
; GFX8-NEXT:    v_subb_u32_e64 v3, s[0:1], v10, v3, vcc
...
; GFX8-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s15, v3
; GFX8-NEXT:    v_subb_u32_e32 v9, vcc, v9, v8, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v10, v10, v11, s[0:1]
; GFX8-NEXT:    v_subrev_u32_e32 v11, vcc, s14, v2
; GFX8-NEXT:    v_subbrev_u32_e64 v12, s[0:1], 0, v9, vcc
...
; GFX8-NEXT:    v_subb_u32_e32 v8, vcc, v9, v8, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v16, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s15, v12
; GFX8-NEXT:    v_subrev_u32_e32 v9, vcc, s14, v11
...
; GFX8-NEXT:    v_cndmask_b32_e32 v8, v12, v8, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v7, v13, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v6, v14, s[0:1]
...
; GFX8-NEXT:    v_xor_b32_e32 v3, s1, v6
; GFX8-NEXT:    v_mov_b32_e32 v6, s1
; GFX8-NEXT:    v_subrev_u32_e32 v2, vcc, s0, v2
; GFX8-NEXT:    v_subb_u32_e32 v3, vcc, v3, v6, vcc
; GFX8-NEXT:    v_xor_b32_e32 v6, s12, v9
; GFX8-NEXT:    v_xor_b32_e32 v7, s12, v8
...
; GFX9-NEXT:    v_cvt_f32_u32_e32 v1, s6
; GFX9-NEXT:    s_mov_b32 s5, s4
; GFX9-NEXT:    s_xor_b64 s[0:1], s[12:13], s[4:5]
; GFX9-NEXT:    v_mul_f32_e32 v0, 0x4f800000, v0
; GFX9-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v0, v0
...
; GFX9-NEXT:    v_cvt_u32_f32_e32 v3, v0
; GFX9-NEXT:    v_cvt_u32_f32_e32 v4, v2
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[12:13], s18, v3, 0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[12:13], s18, v4, v[1:2]
; GFX9-NEXT:    v_mul_hi_u32 v5, v3, v0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[12:13], s19, v3, v[1:2]
; GFX9-NEXT:    v_mul_lo_u32 v2, v4, v0
; GFX9-NEXT:    v_mul_hi_u32 v0, v4, v0
; GFX9-NEXT:    v_mul_lo_u32 v6, v3, v1
; GFX9-NEXT:    v_mul_lo_u32 v7, v4, v1
...
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[12:13], s6, v3, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GFX9-NEXT:    v_add_u32_e32 v4, v4, v5
; GFX9-NEXT:    v_add3_u32 v4, v4, v0, v6
; GFX9-NEXT:    v_mov_b32_e32 v0, v2
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[12:13], s6, v4, v[0:1]
; GFX9-NEXT:    v_mov_b32_e32 v2, s1
; GFX9-NEXT:    v_sub_co_u32_e32 v1, vcc, s0, v1
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[12:13], s7, v3, v[5:6]
; GFX9-NEXT:    s_ashr_i32 s12, s15, 31
; GFX9-NEXT:    s_add_u32 s14, s14, s12
; GFX9-NEXT:    v_sub_u32_e32 v6, s1, v5
; GFX9-NEXT:    v_subb_co_u32_e64 v2, s[0:1], v2, v5, vcc
...
; GFX9-NEXT:    v_subb_co_u32_e32 v11, vcc, v6, v10, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v5, v7, s[0:1]
; GFX9-NEXT:    v_subrev_co_u32_e32 v5, vcc, s6, v1
; GFX9-NEXT:    v_subbrev_co_u32_e64 v6, s[0:1], 0, v11, vcc
; GFX9-NEXT:    v_add_co_u32_e64 v12, s[0:1], 1, v3
; GFX9-NEXT:    v_addc_co_u32_e64 v13, s[0:1], 0, v4, s[0:1]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s7, v6
; GFX9-NEXT:    s_addc_u32 s15, s15, s12
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[0:1]
; GFX9-NEXT:    s_add_u32 s0, s2, s16
; GFX9-NEXT:    s_addc_u32 s1, s3, s16
; GFX9-NEXT:    s_xor_b64 s[2:3], s[0:1], s[16:17]
; GFX9-NEXT:    v_cvt_f32_u32_e32 v9, s3
; GFX9-NEXT:    v_cvt_f32_u32_e32 v14, s2
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s6, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[0:1]
; GFX9-NEXT:    v_mul_f32_e32 v9, 0x4f800000, v9
; GFX9-NEXT:    v_add_f32_e32 v9, v9, v14
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v9, v9
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s7, v6
; GFX9-NEXT:    v_cndmask_b32_e64 v14, v8, v15, s[0:1]
; GFX9-NEXT:    s_mov_b32 s13, s12
; GFX9-NEXT:    v_mul_f32_e32 v8, 0x5f7ffffc, v9
; GFX9-NEXT:    v_mul_f32_e32 v9, 0x2f800000, v8
; GFX9-NEXT:    v_trunc_f32_e32 v9, v9
; GFX9-NEXT:    v_mul_f32_e32 v15, 0xcf800000, v9
; GFX9-NEXT:    v_add_f32_e32 v8, v15, v8
; GFX9-NEXT:    v_cvt_u32_f32_e32 v15, v8
; GFX9-NEXT:    s_xor_b64 s[14:15], s[14:15], s[12:13]
; GFX9-NEXT:    s_sub_u32 s5, 0, s2
; GFX9-NEXT:    v_cvt_u32_f32_e32 v16, v9
; GFX9-NEXT:    v_mad_u64_u32 v[8:9], s[0:1], s5, v15, 0
; GFX9-NEXT:    v_add_co_u32_e64 v17, s[0:1], 1, v12
; GFX9-NEXT:    v_mul_lo_u32 v19, v16, v8
; GFX9-NEXT:    v_mul_hi_u32 v20, v15, v8
; GFX9-NEXT:    v_mul_hi_u32 v21, v16, v8
; GFX9-NEXT:    v_mov_b32_e32 v8, v9
; GFX9-NEXT:    v_addc_co_u32_e64 v18, s[0:1], 0, v13, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[8:9], s[0:1], s5, v16, v[8:9]
; GFX9-NEXT:    s_subb_u32 s20, 0, s3
; GFX9-NEXT:    v_subb_co_u32_e32 v10, vcc, v11, v10, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[8:9], s[0:1], s20, v15, v[8:9]
; GFX9-NEXT:    v_subrev_co_u32_e32 v11, vcc, s6, v5
; GFX9-NEXT:    v_mul_lo_u32 v9, v15, v8
; GFX9-NEXT:    v_subbrev_co_u32_e32 v10, vcc, 0, v10, vcc
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v14
; GFX9-NEXT:    v_add_co_u32_e64 v9, s[0:1], v19, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v14, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v9, s[0:1], v9, v20
; GFX9-NEXT:    v_cndmask_b32_e32 v12, v12, v17, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s[0:1]
; GFX9-NEXT:    v_mul_lo_u32 v17, v16, v8
; GFX9-NEXT:    v_add_u32_e32 v9, v14, v9
; GFX9-NEXT:    v_mul_hi_u32 v14, v15, v8
; GFX9-NEXT:    v_mul_hi_u32 v8, v16, v8
; GFX9-NEXT:    v_add_co_u32_e64 v17, s[0:1], v17, v21
; GFX9-NEXT:    v_cndmask_b32_e32 v13, v13, v18, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v18, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v14, s[0:1], v17, v14
; GFX9-NEXT:    v_cndmask_b32_e64 v17, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v9, s[0:1], v14, v9
; GFX9-NEXT:    v_add_u32_e32 v17, v18, v17
; GFX9-NEXT:    v_cndmask_b32_e64 v14, 0, 1, s[0:1]
; GFX9-NEXT:    v_add3_u32 v8, v17, v14, v8
; GFX9-NEXT:    v_add_co_u32_e64 v14, s[0:1], v15, v9
; GFX9-NEXT:    v_addc_co_u32_e64 v15, s[0:1], v16, v8, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[8:9], s[0:1], s5, v14, 0
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v7
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v3, v12, s[0:1]
; GFX9-NEXT:    v_mov_b32_e32 v3, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v12, v4, v13, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[6:7], s5, v15, v[3:4]
; GFX9-NEXT:    v_cndmask_b32_e32 v6, v6, v10, vcc
; GFX9-NEXT:    v_mul_lo_u32 v13, v15, v8
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[6:7], s20, v14, v[3:4]
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v2, v6, s[0:1]
; GFX9-NEXT:    v_mul_hi_u32 v16, v14, v8
; GFX9-NEXT:    v_mul_lo_u32 v2, v14, v3
; GFX9-NEXT:    v_cndmask_b32_e32 v5, v5, v11, vcc
; GFX9-NEXT:    v_mul_hi_u32 v8, v15, v8
...
; GFX9-NEXT:    v_mul_hi_u32 v9, v14, v3
...
; GFX9-NEXT:    v_add3_u32 v3, v9, v8, v3
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, v14, v2
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v1, v5, s[0:1]
; GFX9-NEXT:    v_xor_b32_e32 v1, s18, v7
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, v15, v3, vcc
; GFX9-NEXT:    v_xor_b32_e32 v4, s19, v12
; GFX9-NEXT:    v_mov_b32_e32 v7, s19
; GFX9-NEXT:    v_mul_lo_u32 v9, s15, v8
; GFX9-NEXT:    v_mul_lo_u32 v10, s14, v3
; GFX9-NEXT:    v_subrev_co_u32_e32 v1, vcc, s18, v1
; GFX9-NEXT:    v_subb_co_u32_e32 v2, vcc, v4, v7, vcc
; GFX9-NEXT:    v_mul_hi_u32 v4, s14, v8
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v9, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, v7, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v7, s15, v3
; GFX9-NEXT:    v_mul_hi_u32 v8, s15, v8
; GFX9-NEXT:    v_add_u32_e32 v4, v9, v4
; GFX9-NEXT:    v_mul_hi_u32 v9, s14, v3
; GFX9-NEXT:    v_mul_hi_u32 v11, s15, v3
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v7, v8
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v7, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v7, v4
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s2, v7, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GFX9-NEXT:    v_xor_b32_e32 v12, s4, v5
; GFX9-NEXT:    v_add_u32_e32 v5, v8, v9
; GFX9-NEXT:    v_add3_u32 v8, v5, v10, v11
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s2, v8, v[4:5]
; GFX9-NEXT:    v_xor_b32_e32 v6, s4, v6
; GFX9-NEXT:    v_mov_b32_e32 v9, s4
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s3, v7, v[4:5]
; GFX9-NEXT:    v_subrev_co_u32_e32 v5, vcc, s4, v12
; GFX9-NEXT:    v_subb_co_u32_e32 v6, vcc, v6, v9, vcc
; GFX9-NEXT:    v_mov_b32_e32 v11, s15
; GFX9-NEXT:    v_sub_co_u32_e32 v3, vcc, s14, v3
; GFX9-NEXT:    v_sub_u32_e32 v10, s15, v4
; GFX9-NEXT:    v_subb_co_u32_e64 v4, s[0:1], v11, v4, vcc
...
; GFX9-NEXT:    v_subb_co_u32_e32 v10, vcc, v10, v9, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v11, v12, s[0:1]
; GFX9-NEXT:    v_subrev_co_u32_e32 v12, vcc, s2, v3
; GFX9-NEXT:    v_subbrev_co_u32_e64 v13, s[0:1], 0, v10, vcc
...
; GFX9-NEXT:    v_subb_co_u32_e32 v9, vcc, v10, v9, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v17, 0, -1, s[0:1]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s3, v13
; GFX9-NEXT:    v_subrev_co_u32_e32 v10, vcc, s2, v12
...
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v7, v14, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v8, v15, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v10, v3, v10, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v9, v4, v9, s[0:1]
; GFX9-NEXT:    s_xor_b64 s[0:1], s[12:13], s[16:17]
; GFX9-NEXT:    v_xor_b32_e32 v3, s0, v7
; GFX9-NEXT:    v_xor_b32_e32 v4, s1, v8
; GFX9-NEXT:    v_mov_b32_e32 v7, s1
; GFX9-NEXT:    v_subrev_co_u32_e32 v3, vcc, s0, v3
; GFX9-NEXT:    v_subb_co_u32_e32 v4, vcc, v4, v7, vcc
; GFX9-NEXT:    v_xor_b32_e32 v7, s12, v10
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    v_xor_b32_e32 v8, s12, v9
...
; GFX10-NEXT:    v_mul_lo_u32 v5, v9, v0
; GFX10-NEXT:    v_mov_b32_e32 v1, v3
; GFX10-NEXT:    v_mul_lo_u32 v11, v6, v2
; GFX10-NEXT:    v_mul_hi_u32 v12, v8, v2
; GFX10-NEXT:    v_mad_u64_u32 v[3:4], s22, s20, v7, v[4:5]
; GFX10-NEXT:    v_mul_hi_u32 v4, v7, v0
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s22, s5, v6, v[1:2]
...
; GFX10-NEXT:    v_add_co_u32 v3, s23, v5, v13
...
; GFX10-NEXT:    v_add_co_u32 v3, s23, v3, v4
; GFX10-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s23
; GFX10-NEXT:    v_add_co_u32 v4, s23, v10, v15
; GFX10-NEXT:    v_mul_lo_u32 v15, v6, v0
; GFX10-NEXT:    v_cndmask_b32_e64 v10, 0, 1, s23
; GFX10-NEXT:    v_mul_hi_u32 v16, v8, v0
; GFX10-NEXT:    v_mul_hi_u32 v17, v6, v0
; GFX10-NEXT:    v_add_nc_u32_e32 v0, v5, v3
; GFX10-NEXT:    v_add_co_u32 v5, s23, v11, v14
; GFX10-NEXT:    v_add_nc_u32_e32 v3, v13, v10
; GFX10-NEXT:    v_cndmask_b32_e64 v10, 0, 1, s23
; GFX10-NEXT:    v_add_co_u32 v2, s23, v15, v2
; GFX10-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s23
; GFX10-NEXT:    v_add_co_u32 v0, s23, v4, v0
; GFX10-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s23
; GFX10-NEXT:    v_add_co_u32 v5, s23, v5, v12
; GFX10-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s23
; GFX10-NEXT:    v_add_co_u32 v7, vcc_lo, v7, v0
; GFX10-NEXT:    v_add3_u32 v1, v3, v4, v1
; GFX10-NEXT:    v_add_co_u32 v2, s23, v2, v16
; GFX10-NEXT:    v_add_nc_u32_e32 v3, v10, v5
; GFX10-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s23
; GFX10-NEXT:    v_add_co_ci_u32_e32 v9, vcc_lo, v9, v1, vcc_lo
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s23, s21, v7, 0
...
; GFX10-NEXT:    v_mad_u64_u32 v[4:5], s21, s21, v9, v[1:2]
; GFX10-NEXT:    v_mul_lo_u32 v5, v9, v0
; GFX10-NEXT:    v_mov_b32_e32 v1, v3
; GFX10-NEXT:    v_mul_lo_u32 v11, v6, v2
; GFX10-NEXT:    v_mul_hi_u32 v12, v8, v2
; GFX10-NEXT:    v_mad_u64_u32 v[3:4], s20, s20, v7, v[4:5]
; GFX10-NEXT:    v_mul_hi_u32 v4, v7, v0
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s5, s5, v6, v[1:2]
; GFX10-NEXT:    v_mul_hi_u32 v2, v6, v2
; GFX10-NEXT:    v_mul_lo_u32 v13, v7, v3
; GFX10-NEXT:    v_mul_lo_u32 v15, v9, v3
; GFX10-NEXT:    v_mul_hi_u32 v16, v7, v3
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s5, s22, v8, v[0:1]
; GFX10-NEXT:    v_mul_hi_u32 v1, v9, v3
; GFX10-NEXT:    v_add_co_u32 v3, s5, v5, v13
; GFX10-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v10, s5, v15, v10
...
; GFX10-NEXT:    v_add_co_u32 v4, s5, v10, v16
; GFX10-NEXT:    v_mul_lo_u32 v16, v6, v0
...
; GFX10-NEXT:    v_add_nc_u32_e32 v5, v13, v10
; GFX10-NEXT:    v_add_co_u32 v10, s5, v11, v15
; GFX10-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v2, s5, v16, v2
; GFX10-NEXT:    v_cndmask_b32_e64 v13, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v3, s5, v4, v3
...
; GFX10-NEXT:    v_add_co_u32 v3, vcc_lo, v7, v3
; GFX10-NEXT:    v_add_nc_u32_e32 v4, v11, v10
; GFX10-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s5
; GFX10-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v9, v1, vcc_lo
; GFX10-NEXT:    v_mul_lo_u32 v7, s1, v3
; GFX10-NEXT:    v_add_co_u32 v2, s5, v2, v4
; GFX10-NEXT:    v_add_nc_u32_e32 v5, v13, v12
; GFX10-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s5
; GFX10-NEXT:    v_mul_lo_u32 v10, s0, v1
; GFX10-NEXT:    v_mul_hi_u32 v9, s0, v3
...
; GFX10-NEXT:    v_add_co_u32 v1, s5, v7, v10
...
; GFX10-NEXT:    v_add_co_u32 v3, s5, v3, v4
; GFX10-NEXT:    v_mul_hi_u32 v8, s14, v2
; GFX10-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s5
; GFX10-NEXT:    v_mul_hi_u32 v2, s15, v2
; GFX10-NEXT:    v_mul_lo_u32 v9, s15, v6
; GFX10-NEXT:    v_add_nc_u32_e32 v1, v7, v1
; GFX10-NEXT:    v_add_co_u32 v7, s5, v0, v11
; GFX10-NEXT:    v_mul_hi_u32 v12, s14, v6
; GFX10-NEXT:    v_add_nc_u32_e32 v4, v10, v4
; GFX10-NEXT:    v_cndmask_b32_e64 v10, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v11, s5, v3, v1
; GFX10-NEXT:    v_add_co_u32 v2, s20, v9, v2
; GFX10-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s5
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s5, s6, v11, 0
; GFX10-NEXT:    v_add_co_u32 v7, s5, v7, v8
; GFX10-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v8, s5, v2, v12
; GFX10-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s20
; GFX10-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s5
; GFX10-NEXT:    v_add3_u32 v4, v4, v9, v5
; GFX10-NEXT:    v_mul_hi_u32 v5, s15, v6
; GFX10-NEXT:    v_add_nc_u32_e32 v6, v10, v7
; GFX10-NEXT:    v_add_co_u32 v7, vcc_lo, v11, 1
; GFX10-NEXT:    v_add_nc_u32_e32 v3, v3, v2
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], s5, s6, v4, v[1:2]
; GFX10-NEXT:    v_add_co_u32 v6, s5, v8, v6
; GFX10-NEXT:    v_cndmask_b32_e64 v8, 0, 1, s5
; GFX10-NEXT:    v_add_co_ci_u32_e32 v9, vcc_lo, 0, v4, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v10, vcc_lo, v7, 1
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], s5, s7, v11, v[1:2]
; GFX10-NEXT:    v_add3_u32 v5, v3, v8, v5
...
; GFX10-NEXT:    v_sub_co_u32 v3, vcc_lo, v13, s6
; GFX10-NEXT:    v_subrev_co_ci_u32_e64 v16, s0, 0, v8, vcc_lo
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s6, v13
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v8, vcc_lo, s7, v8, vcc_lo
...
; GFX10-NEXT:    v_cndmask_b32_e64 v1, v11, v7, s0
...
; GFX10-NEXT:    v_cndmask_b32_e64 v4, v4, v9, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v3, v13, v3, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v7, v15, v7, s0
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s3, v8
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v10, vcc_lo, s3, v0, vcc_lo
...
; GFX10-NEXT:    v_sub_co_u32 v12, vcc_lo, v2, s2
...
; GFX10-NEXT:    v_cndmask_b32_e64 v4, v9, v11, s0
...
; GFX10-NEXT:    v_cndmask_b32_e32 v4, v12, v9, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e32 v9, v13, v10, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e64 v6, v6, v11, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v10, v5, v15, s0
...
; GFX10-NEXT:    v_xor_b32_e32 v6, s1, v10
...
; GFX10-NEXT:    global_store_dwordx4 v14, v[0:3], s[8:9]
; GFX10-NEXT:    global_store_dwordx4 v14, v[4:7], s[10:11]
; GFX10-NEXT:    s_endpgm
...
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    s_xor_b32 s2, s6, s5
; GFX8-NEXT:    v_mul_lo_u32 v5, v4, s8
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, 1, v4
; GFX8-NEXT:    v_sub_u32_e32 v5, vcc, s4, v5
; GFX8-NEXT:    v_cmp_le_u32_e32 vcc, s8, v5
; GFX8-NEXT:    v_cndmask_b32_e32 v4, v4, v6, vcc
; GFX8-NEXT:    v_subrev_u32_e64 v6, s[0:1], s8, v5
; GFX8-NEXT:    v_cndmask_b32_e32 v5, v5, v6, vcc
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, 1, v4
; GFX8-NEXT:    v_cmp_le_u32_e32 vcc, s8, v5
; GFX8-NEXT:    v_cndmask_b32_e32 v4, v4, v6, vcc
...
; GFX8-NEXT:    v_xor_b32_e32 v5, s6, v5
; GFX8-NEXT:    v_subrev_u32_e32 v5, vcc, s6, v5
; GFX8-NEXT:    flat_store_byte v[2:3], v4
; GFX8-NEXT:    flat_store_byte v[0:1], v5
; GFX8-NEXT:    s_endpgm
;
; GFX9-LABEL: sdiv_i8:
; GFX9:       ; %bb.0:
...
; GFX8-NEXT:    v_subrev_u32_e32 v0, vcc, s0, v0
; GFX8-NEXT:    v_mul_lo_u32 v3, v1, s11
; GFX8-NEXT:    v_subrev_u32_e32 v4, vcc, s9, v2
; GFX8-NEXT:    v_sub_u32_e32 v2, vcc, s1, v3
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, 1, v1
...
; GFX8-NEXT:    v_or_b32_sdwa v6, v0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
...
; GFX10-NEXT:    s_sext_i32_i8 s0, s0
; GFX10-NEXT:    s_ashr_i32 s9, s4, 31
...
; GFX8-NEXT:    v_or_b32_sdwa v5, v2, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_mov_b32_e32 v2, s4
; GFX8-NEXT:    v_mov_b32_e32 v0, s6
; GFX8-NEXT:    v_mov_b32_e32 v3, s5
...
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v1, v1
; GFX9-NEXT:    s_sext_i32_i16 s6, s4
; GFX9-NEXT:    v_mul_lo_u32 v2, s10, v0
; GFX9-NEXT:    s_ashr_i32 s10, s6, 31
; GFX9-NEXT:    v_mul_f32_e32 v1, 0x4f7ffffe, v1
; GFX9-NEXT:    v_cvt_u32_f32_e32 v1, v1
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dword s0, s[6:7], 0x10
; GFX8-NEXT:    s_load_dwordx4 s[4:7], s[6:7], 0x0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    v_mul_hi_u32 v1, v0, v1
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v0, v1
; GFX8-NEXT:    v_mul_hi_u32 v2, s0, v0
; GFX8-NEXT:    v_mov_b32_e32 v0, s6
; GFX8-NEXT:    v_mov_b32_e32 v1, s7
; GFX8-NEXT:    v_mul_lo_u32 v3, v2, s3
...
; GFX8-NEXT:    v_cndmask_b32_e32 v3, v3, v4, vcc
; GFX8-NEXT:    v_xor_b32_e32 v2, s2, v2
; GFX8-NEXT:    v_subrev_u32_e32 v2, vcc, s2, v2
...
; GFX8-NEXT:    v_and_b32_e32 v2, 7, v4
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[6:7], 0x10
; GFX8-NEXT:    s_load_dwordx4 s[4:7], s[6:7], 0x0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    v_xor_b32_e32 v3, s8, v3
; GFX8-NEXT:    v_subrev_u32_e32 v4, vcc, s8, v3
; GFX8-NEXT:    v_and_b32_e32 v5, 0x7ffffff, v2
; GFX8-NEXT:    v_mov_b32_e32 v2, s4
; GFX8-NEXT:    v_mov_b32_e32 v3, s5
; GFX8-NEXT:    flat_store_dword v[2:3], v5
; GFX8-NEXT:    v_and_b32_e32 v2, 0x7ffffff, v4
