...
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v6, v8, s[2:3]
; GFX9-NEXT:    s_and_b32 s4, s4, 0xffff
...
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v6, v8, s[2:3]
; GFX8-NEXT:    s_and_b32 s4, s4, 0xffff
...
; GFX7-NEXT:    v_mov_b32_e32 v2, s1
; GFX7-NEXT:    v_mov_b32_e32 v1, s0
; GFX7-NEXT:    v_cndmask_b32_e32 v6, v9, v6, vcc
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[0:1], 2, v5
; GFX7-NEXT:    s_and_b32 s4, s4, 0xffff
; GFX7-NEXT:    v_mov_b32_e32 v8, s3
; GFX7-NEXT:    v_cndmask_b32_e64 v6, v6, v7, s[0:1]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[2:3], 3, v5
; GFX7-NEXT:    v_lshl_b32_e32 v7, s4, v0
; GFX7-NEXT:    v_lshl_b32_e32 v0, 0xffff, v0
; GFX7-NEXT:    v_cndmask_b32_e64 v6, v6, v8, s[2:3]
; GFX7-NEXT:    v_not_b32_e32 v0, v0
...
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v7, v9, s[2:3]
; GFX9-NEXT:    v_not_b32_e32 v1, v1
...
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v7, v9, s[2:3]
; GFX8-NEXT:    v_not_b32_e32 v1, v1
...
; GFX7-NEXT:    v_mov_b32_e32 v3, s1
; GFX7-NEXT:    v_mov_b32_e32 v2, s0
; GFX7-NEXT:    v_cndmask_b32_e32 v7, v10, v7, vcc
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[0:1], 2, v6
; GFX7-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX7-NEXT:    v_mov_b32_e32 v9, s3
; GFX7-NEXT:    v_cndmask_b32_e64 v7, v7, v8, s[0:1]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[2:3], 3, v6
; GFX7-NEXT:    v_lshlrev_b32_e32 v0, v1, v0
; GFX7-NEXT:    v_lshl_b32_e32 v1, 0xffff, v1
; GFX7-NEXT:    v_cndmask_b32_e64 v7, v7, v9, s[2:3]
; GFX7-NEXT:    v_not_b32_e32 v1, v1
...
; GFX8-NEXT:    v_mov_b32_e32 v17, s8
...
; GFX7-NEXT:    v_cndmask_b32_e64 v10, v10, v11, s[0:1]
...
; GFX7-NEXT:    v_cndmask_b32_e64 v10, v10, v12, s[2:3]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[14:15], 4, v9
; GFX7-NEXT:    v_mov_b32_e32 v14, s13
; GFX7-NEXT:    v_cndmask_b32_e64 v10, v10, v13, s[14:15]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[6:7], 5, v9
; GFX7-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX7-NEXT:    v_cndmask_b32_e64 v10, v10, v14, s[6:7]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[8:9], 6, v9
; GFX7-NEXT:    v_lshlrev_b32_e32 v0, 4, v0
; GFX7-NEXT:    s_and_b32 s4, s4, 0xffff
; GFX7-NEXT:    v_cndmask_b32_e64 v10, v10, v15, s[8:9]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[10:11], 7, v9
; GFX7-NEXT:    v_lshl_b32_e32 v11, s4, v0
; GFX7-NEXT:    v_lshl_b32_e32 v0, 0xffff, v0
; GFX7-NEXT:    v_cndmask_b32_e64 v10, v10, v16, s[10:11]
; GFX7-NEXT:    v_not_b32_e32 v0, v0
; GFX7-NEXT:    v_and_b32_e32 v0, v10, v0
...
; GFX9-NEXT:    v_mov_b32_e32 v3, s1
; GFX9-NEXT:    v_mov_b32_e32 v2, s0
; GFX9-NEXT:    v_cndmask_b32_e32 v11, v18, v11, vcc
...
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v11, v13, s[2:3]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], 4, v10
; GFX9-NEXT:    v_mov_b32_e32 v16, s6
; GFX9-NEXT:    v_mov_b32_e32 v17, s7
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v11, v14, s[4:5]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], 5, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v11, v15, s[6:7]
; GFX9-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
; GFX9-NEXT:    v_mov_b32_e32 v12, 0xffff
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v11, v16, s[8:9]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[10:11], 7, v10
; GFX9-NEXT:    v_lshlrev_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX9-NEXT:    v_lshlrev_b32_e32 v1, v1, v12
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v11, v17, s[10:11]
; GFX9-NEXT:    v_not_b32_e32 v1, v1
...
; GFX8-NEXT:    v_mov_b32_e32 v3, s1
; GFX8-NEXT:    v_mov_b32_e32 v2, s0
; GFX8-NEXT:    v_cndmask_b32_e32 v11, v18, v11, vcc
...
; GFX8-NEXT:    v_cndmask_b32_e64 v11, v11, v13, s[2:3]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[4:5], 4, v10
; GFX8-NEXT:    v_mov_b32_e32 v16, s6
; GFX8-NEXT:    v_mov_b32_e32 v17, s7
; GFX8-NEXT:    v_cndmask_b32_e64 v11, v11, v14, s[4:5]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[6:7], 5, v10
; GFX8-NEXT:    v_cndmask_b32_e64 v11, v11, v15, s[6:7]
; GFX8-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
; GFX8-NEXT:    v_mov_b32_e32 v12, 0xffff
; GFX8-NEXT:    v_cndmask_b32_e64 v11, v11, v16, s[8:9]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[10:11], 7, v10
; GFX8-NEXT:    v_lshlrev_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX8-NEXT:    v_lshlrev_b32_e32 v1, v1, v12
; GFX8-NEXT:    v_cndmask_b32_e64 v11, v11, v17, s[10:11]
; GFX8-NEXT:    v_not_b32_e32 v1, v1
...
; GFX7-NEXT:    v_mov_b32_e32 v18, s0
...
; GFX7-NEXT:    v_mov_b32_e32 v3, s1
; GFX7-NEXT:    v_mov_b32_e32 v2, s0
; GFX7-NEXT:    v_cndmask_b32_e32 v11, v18, v11, vcc
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[0:1], 2, v10
; GFX7-NEXT:    v_mov_b32_e32 v13, s3
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v11, v12, s[0:1]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[2:3], 3, v10
; GFX7-NEXT:    v_mov_b32_e32 v14, s4
; GFX7-NEXT:    v_mov_b32_e32 v15, s5
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v11, v13, s[2:3]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[4:5], 4, v10
; GFX7-NEXT:    v_mov_b32_e32 v16, s6
; GFX7-NEXT:    v_mov_b32_e32 v17, s7
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v11, v14, s[4:5]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[6:7], 5, v10
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v11, v15, s[6:7]
; GFX7-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
; GFX7-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v11, v16, s[8:9]
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[10:11], 7, v10
; GFX7-NEXT:    v_lshlrev_b32_e32 v0, v1, v0
; GFX7-NEXT:    v_lshl_b32_e32 v1, 0xffff, v1
; GFX7-NEXT:    v_cndmask_b32_e64 v11, v11, v17, s[10:11]
; GFX7-NEXT:    v_not_b32_e32 v1, v1
