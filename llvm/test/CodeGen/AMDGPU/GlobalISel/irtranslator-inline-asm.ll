...
define amdgpu_kernel void @asm_simple_memory_clobber() {
  ...
  ; CHECK-NEXT:   S_ENDPGM 0
  call void asm sideeffect "", "~{memory}"() noconvergent, !srcloc !0
  call void asm sideeffect "", ""() noconvergent, !srcloc !0
  ret void
}
...
define amdgpu_kernel void @asm_simple_vgpr_clobber() {
  ...
  ; CHECK-NEXT:   S_ENDPGM 0
  call void asm sideeffect "v_mov_b32 v0, 7", "~{v0}"() noconvergent, !srcloc !0
  ret void
}
...
define amdgpu_kernel void @asm_simple_sgpr_clobber() {
  ...
  ; CHECK-NEXT:   S_ENDPGM 0
  call void asm sideeffect "s_mov_b32 s0, 7", "~{s0}"() noconvergent, !srcloc !0
  ret void
}
...
define amdgpu_kernel void @asm_simple_agpr_clobber() {
  ...
  ; CHECK-NEXT:   S_ENDPGM 0
  call void asm sideeffect "; def a0", "~{a0}"() noconvergent, !srcloc !0
  ret void
}
...
define i32 @asm_vgpr_early_clobber() {
  ...
  call { i32, i32 } asm sideeffect "v_mov_b32 $0, 7; v_mov_b32 $1, 7", "=&v,=&v"() noconvergent, !srcloc !0
...
define i32 @test_specific_vgpr_output() nounwind {
  ...
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
entry:
  %0 = tail call i32 asm "v_mov_b32 v1, 7", "={v1}"() noconvergent nounwind
  ret i32 %0
}
...
define i32 @test_single_vgpr_output() nounwind {
  ...
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
entry:
  %0 = tail call i32 asm "v_mov_b32 $0, 7", "=v"() noconvergent nounwind
  ret i32 %0
}
...
define i32 @test_single_sgpr_output_s32() nounwind {
  ...
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
entry:
  %0 = tail call i32 asm "s_mov_b32 $0, 7", "=s"() noconvergent nounwind
  ret i32 %0
}
...
define float @test_multiple_register_outputs_same() #0 {
  ...
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
  %1 = call { float, float } asm "v_mov_b32 $0, 0; v_mov_b32 $1, 1", "=v,=v"() noconvergent
...
define double @test_multiple_register_outputs_mixed() #0 {
  ...
  %1 = call { float, double } asm "v_mov_b32 $0, 0; v_add_f64 $1, 0, 0", "=v,=v"() noconvergent
...
define float @test_vector_output() nounwind {
  ...
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
  %1 = tail call <2 x float> asm sideeffect "v_add_f64 $0, 0, 0", "={v[14:15]}"() noconvergent nounwind
...
define amdgpu_kernel void @test_input_vgpr_imm() {
  ...
  ; CHECK-NEXT:   S_ENDPGM 0
  call void asm sideeffect "v_mov_b32 v0, $0", "v"(i32 42) noconvergent
  ret void
}
...
define amdgpu_kernel void @test_input_sgpr_imm() {
  ...
  ; CHECK-NEXT:   S_ENDPGM 0
  call void asm sideeffect "s_mov_b32 s0, $0", "s"(i32 42) noconvergent
  ret void
}
...
define amdgpu_kernel void @test_input_imm() {
  ...
  ; CHECK-NEXT:   S_ENDPGM 0
  call void asm sideeffect "s_mov_b32 s0, $0", "i"(i32 42) noconvergent
  call void asm sideeffect "s_mov_b64 s[0:1], $0", "i"(i64 42) noconvergent
  ret void
}
...
define float @test_input_vgpr(i32 %src) nounwind {
  ...
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
entry:
  %0 = tail call float asm "v_add_f32 $0, 1.0, $1", "=v,v"(i32 %src) noconvergent nounwind
  ret float %0
}
...
define i32 @test_memory_constraint(ptr addrspace(3) %a) nounwind {
  ...
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
  %1 = tail call i32 asm "ds_read_b32 $0, $1", "=v,*m"(ptr addrspace(3) elementtype(i32) %a) noconvergent
  ret i32 %1
}
...
define i32 @test_vgpr_matching_constraint(i32 %a) nounwind {
  ...
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
  %and = and i32 %a, 1
  %asm = call i32 asm sideeffect ";", "=v,0"(i32 %and) noconvergent
  ret i32 %asm
}
...
define i32 @test_sgpr_matching_constraint() nounwind {
  ...
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
entry:
  %asm0 = tail call i32 asm "s_mov_b32 $0, 7", "=s"() noconvergent nounwind
  %asm1 = tail call i32 asm "s_mov_b32 $0, 8", "=s"() noconvergent nounwind
  %asm2 = tail call i32 asm "s_add_u32 $0, $1, $2", "=s,s,0"(i32 %asm0, i32 %asm1) noconvergent nounwind
  ret i32 %asm2
}
...
define void @test_many_matching_constraints(i32 %a, i32 %b, i32 %c) nounwind {
  ...
  %asm = call {i32, i32, i32} asm sideeffect "; ", "=v,=v,=v,0,2,1"(i32 %c, i32 %a, i32 %b) noconvergent
...
entry:
  %asm0 = tail call i32 asm "s_mov_b32 $0, 7", "=s"() noconvergent nounwind
  %asm1 = tail call i32 asm "v_mov_b32 $0, $1", "=v,0"(i32 %asm0) noconvergent nounwind
  ret i32 %asm1
}
...
define amdgpu_kernel void @asm_constraint_n_n()  {
  ...
  ; CHECK-NEXT:   S_ENDPGM 0
  tail call void asm sideeffect "s_trap ${0:n}", "n"(i32 10) noconvergent
  ret void
}
