...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx4 s[8:11], s[6:7], 0x20
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s3, v3, v[1:2]
; GFX8-NEXT:    v_mul_lo_u32 v2, v4, v0
; GFX8-NEXT:    s_load_dwordx8 s[0:7], s[6:7], 0x0
; GFX8-NEXT:    v_mul_lo_u32 v7, v3, v1
; GFX8-NEXT:    v_mov_b32_e32 v0, s9
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v2, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v2, v5
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v5, v4, v1
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v7, v2
; GFX8-NEXT:    v_mul_hi_u32 v7, v3, v1
...
; GFX8-NEXT:    v_mul_f32_e32 v2, 0x5f7ffffc, v6
...
; GFX8-NEXT:    v_cvt_u32_f32_e32 v4, v2
; GFX8-NEXT:    v_cvt_u32_f32_e32 v6, v3
; GFX8-NEXT:    v_mul_lo_u32 v8, s5, v1
; GFX8-NEXT:    v_mul_hi_u32 v5, s5, v5
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[12:13], s14, v4, 0
; GFX8-NEXT:    v_mul_hi_u32 v9, s4, v1
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v8, v5
; GFX8-NEXT:    v_mul_lo_u32 v10, v6, v2
; GFX8-NEXT:    v_mul_hi_u32 v11, v4, v2
; GFX8-NEXT:    v_mul_hi_u32 v12, v6, v2
; GFX8-NEXT:    v_mov_b32_e32 v2, v3
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[12:13], s14, v6, v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v5, v9
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[12:13], s15, v4, v[2:3]
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v8, v3
; GFX8-NEXT:    v_mul_lo_u32 v9, v4, v2
; GFX8-NEXT:    v_mul_hi_u32 v1, s5, v1
; GFX8-NEXT:    v_mov_b32_e32 v16, s5
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v10, v9
; GFX8-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v3, v11
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v10, v6, v2
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v9, v3
; GFX8-NEXT:    v_mul_hi_u32 v9, v4, v2
; GFX8-NEXT:    v_add_u32_e32 v10, vcc, v10, v12
; GFX8-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, v10, v9
...
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, v4, v3
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[12:13], s14, v9, 0
; GFX8-NEXT:    v_addc_u32_e32 v6, vcc, v6, v2, vcc
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v5, v7
; GFX8-NEXT:    v_mul_lo_u32 v7, v6, v3
; GFX8-NEXT:    v_mul_hi_u32 v10, v9, v3
; GFX8-NEXT:    v_mul_hi_u32 v11, v6, v3
; GFX8-NEXT:    v_mov_b32_e32 v3, v4
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[12:13], s14, v6, v[3:4]
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v8, v5
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[12:13], s15, v9, v[3:4]
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v1, v8
; GFX8-NEXT:    v_mul_lo_u32 v12, v9, v3
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[12:13], s8, v2, 0
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v7, v12
; GFX8-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v7, v10
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v10, v6, v3
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v8, v7
; GFX8-NEXT:    v_mul_hi_u32 v8, v9, v3
; GFX8-NEXT:    v_add_u32_e32 v10, vcc, v10, v11
; GFX8-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v10, v8
; GFX8-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v10, vcc, v11, v10
; GFX8-NEXT:    v_mul_hi_u32 v3, v6, v3
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v8, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v10, v8
...
; GFX8-NEXT:    v_mul_lo_u32 v8, s7, v7
; GFX8-NEXT:    v_mul_lo_u32 v9, s6, v3
; GFX8-NEXT:    v_mul_hi_u32 v10, s6, v7
; GFX8-NEXT:    v_mul_hi_u32 v7, s7, v7
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[12:13], s8, v1, v[5:6]
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v8, v9
; GFX8-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v8, v10
; GFX8-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v10, s7, v3
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v9, v8
; GFX8-NEXT:    v_mul_hi_u32 v9, s6, v3
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v10, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v7, v9
; GFX8-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, v10, v9
; GFX8-NEXT:    v_add_u32_e32 v13, vcc, v7, v8
; GFX8-NEXT:    v_mul_hi_u32 v3, s7, v3
; GFX8-NEXT:    v_mad_u64_u32 v[7:8], s[12:13], s10, v13, 0
; GFX8-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, v9, v10
; GFX8-NEXT:    v_add_u32_e32 v14, vcc, v3, v9
; GFX8-NEXT:    v_mov_b32_e32 v3, v8
; GFX8-NEXT:    v_mad_u64_u32 v[8:9], s[12:13], s10, v14, v[3:4]
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[12:13], s9, v2, v[5:6]
; GFX8-NEXT:    v_mad_u64_u32 v[8:9], s[12:13], s11, v13, v[8:9]
; GFX8-NEXT:    v_sub_u32_e32 v3, vcc, s5, v5
; GFX8-NEXT:    v_sub_u32_e32 v15, vcc, s7, v8
; GFX8-NEXT:    v_mov_b32_e32 v10, s1
; GFX8-NEXT:    v_sub_u32_e32 v4, vcc, s4, v4
; GFX8-NEXT:    v_mov_b32_e32 v9, s0
; GFX8-NEXT:    v_subb_u32_e64 v5, s[0:1], v16, v5, vcc
...
; GFX8-NEXT:    v_subrev_u32_e32 v17, vcc, s8, v4
; GFX8-NEXT:    v_subbrev_u32_e64 v18, s[0:1], 0, v3, vcc
; GFX8-NEXT:    v_add_u32_e64 v19, s[0:1], 1, v2
; GFX8-NEXT:    v_addc_u32_e64 v20, s[0:1], 0, v1, s[0:1]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s9, v18
; GFX8-NEXT:    v_cndmask_b32_e64 v21, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s8, v17
; GFX8-NEXT:    v_subb_u32_e32 v0, vcc, v3, v0, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v22, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s9, v18
; GFX8-NEXT:    v_subrev_u32_e32 v3, vcc, s8, v17
; GFX8-NEXT:    v_cndmask_b32_e64 v21, v21, v22, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v22, s[0:1], 1, v19
; GFX8-NEXT:    v_subbrev_u32_e32 v24, vcc, 0, v0, vcc
; GFX8-NEXT:    v_addc_u32_e64 v23, s[0:1], 0, v20, s[0:1]
; GFX8-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v21
; GFX8-NEXT:    v_cndmask_b32_e32 v0, v19, v22, vcc
; GFX8-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v16
; GFX8-NEXT:    v_mov_b32_e32 v6, s7
; GFX8-NEXT:    v_cndmask_b32_e32 v19, v20, v23, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v0, v2, v0, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e32 v2, v17, v3, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v3, v18, v24, vcc
; GFX8-NEXT:    v_sub_u32_e32 v7, vcc, s6, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v1, v1, v19, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v4, v4, v2, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v5, v5, v3, s[0:1]
; GFX8-NEXT:    v_subb_u32_e64 v8, s[0:1], v6, v8, vcc
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s11, v8
...
; GFX8-NEXT:    v_subb_u32_e32 v6, vcc, v15, v2, vcc
; GFX8-NEXT:    v_subrev_u32_e32 v15, vcc, s10, v7
; GFX8-NEXT:    v_subbrev_u32_e64 v16, s[0:1], 0, v6, vcc
; GFX8-NEXT:    v_add_u32_e64 v17, s[0:1], 1, v13
; GFX8-NEXT:    v_addc_u32_e64 v18, s[0:1], 0, v14, s[0:1]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s11, v16
; GFX8-NEXT:    v_cndmask_b32_e64 v19, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s10, v15
; GFX8-NEXT:    v_subb_u32_e32 v2, vcc, v6, v2, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v20, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s11, v16
; GFX8-NEXT:    v_subrev_u32_e32 v6, vcc, s10, v15
; GFX8-NEXT:    v_cndmask_b32_e64 v19, v19, v20, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v20, s[0:1], 1, v17
; GFX8-NEXT:    v_subbrev_u32_e32 v22, vcc, 0, v2, vcc
; GFX8-NEXT:    v_addc_u32_e64 v21, s[0:1], 0, v18, s[0:1]
; GFX8-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v19
; GFX8-NEXT:    v_cndmask_b32_e32 v2, v17, v20, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v17, v18, v21, vcc
; GFX8-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v3
; GFX8-NEXT:    v_mov_b32_e32 v12, s3
; GFX8-NEXT:    v_cndmask_b32_e64 v2, v13, v2, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v3, v14, v17, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e32 v6, v15, v6, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v13, v16, v22, vcc
; GFX8-NEXT:    v_mov_b32_e32 v11, s2
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v7, v6, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v8, v13, s[0:1]
; GFX8-NEXT:    flat_store_dwordx4 v[9:10], v[0:3]
; GFX8-NEXT:    flat_store_dwordx4 v[11:12], v[4:7]
; GFX8-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v5, v4, v1
; GFX9-NEXT:    v_add_u32_e32 v2, v6, v2
...
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s16, v3, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GFX9-NEXT:    v_add_u32_e32 v4, v4, v5
; GFX9-NEXT:    v_add3_u32 v4, v4, v0, v6
; GFX9-NEXT:    v_mov_b32_e32 v0, v2
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s16, v4, v[0:1]
; GFX9-NEXT:    v_sub_co_u32_e32 v2, vcc, s12, v1
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s17, v3, v[5:6]
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    v_subb_co_u32_e64 v1, s[0:1], v8, v5, vcc
...
; GFX9-NEXT:    v_sub_u32_e32 v5, s13, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v6, v8, s[0:1]
; GFX9-NEXT:    v_cvt_f32_u32_e32 v6, s19
; GFX9-NEXT:    v_subb_co_u32_e32 v9, vcc, v5, v7, vcc
; GFX9-NEXT:    v_cvt_f32_u32_e32 v5, s18
; GFX9-NEXT:    v_mul_f32_e32 v6, 0x4f800000, v6
; GFX9-NEXT:    v_subrev_co_u32_e32 v10, vcc, s16, v2
; GFX9-NEXT:    v_add_f32_e32 v5, v6, v5
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v5, v5
; GFX9-NEXT:    v_subbrev_co_u32_e64 v11, s[0:1], 0, v9, vcc
...
; GFX9-NEXT:    v_mul_f32_e32 v14, 0xcf800000, v6
; GFX9-NEXT:    v_add_f32_e32 v5, v14, v5
; GFX9-NEXT:    v_cvt_u32_f32_e32 v14, v5
; GFX9-NEXT:    v_addc_co_u32_e64 v13, s[0:1], 0, v4, s[0:1]
; GFX9-NEXT:    v_cvt_u32_f32_e32 v15, v6
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s2, v14, 0
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s17, v11
; GFX9-NEXT:    v_cndmask_b32_e64 v16, 0, -1, s[0:1]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s16, v10
; GFX9-NEXT:    v_mul_lo_u32 v18, v15, v5
; GFX9-NEXT:    v_mul_hi_u32 v19, v14, v5
; GFX9-NEXT:    v_mul_hi_u32 v20, v15, v5
; GFX9-NEXT:    v_mov_b32_e32 v5, v6
; GFX9-NEXT:    v_cndmask_b32_e64 v17, 0, -1, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s2, v15, v[5:6]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s17, v11
; GFX9-NEXT:    v_cndmask_b32_e64 v16, v16, v17, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s3, v14, v[5:6]
; GFX9-NEXT:    v_subb_co_u32_e32 v7, vcc, v9, v7, vcc
; GFX9-NEXT:    v_mul_lo_u32 v6, v14, v5
; GFX9-NEXT:    v_add_co_u32_e64 v17, s[0:1], 1, v12
; GFX9-NEXT:    v_addc_co_u32_e64 v21, s[0:1], 0, v13, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v18, v6
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v6, v19
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v18, v15, v5
; GFX9-NEXT:    v_add_u32_e32 v6, v9, v6
; GFX9-NEXT:    v_mul_hi_u32 v9, v14, v5
; GFX9-NEXT:    v_mul_hi_u32 v5, v15, v5
; GFX9-NEXT:    v_add_co_u32_e32 v18, vcc, v18, v20
; GFX9-NEXT:    v_cndmask_b32_e64 v19, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v9, vcc, v18, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v18, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v9, v6
; GFX9-NEXT:    v_add_u32_e32 v18, v19, v18
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX9-NEXT:    v_add3_u32 v5, v18, v9, v5
; GFX9-NEXT:    v_add_co_u32_e32 v9, vcc, v14, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v14, vcc, v15, v5, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s2, v9, 0
; GFX9-NEXT:    v_subrev_co_u32_e32 v15, vcc, s16, v10
; GFX9-NEXT:    v_mul_lo_u32 v18, v14, v5
; GFX9-NEXT:    v_mul_hi_u32 v19, v9, v5
; GFX9-NEXT:    v_mul_hi_u32 v20, v14, v5
; GFX9-NEXT:    v_mov_b32_e32 v5, v6
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s2, v14, v[5:6]
; GFX9-NEXT:    v_subbrev_co_u32_e32 v7, vcc, 0, v7, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s3, v9, v[5:6]
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v16
; GFX9-NEXT:    v_cndmask_b32_e32 v12, v12, v17, vcc
; GFX9-NEXT:    v_mul_lo_u32 v6, v9, v5
...
; GFX9-NEXT:    v_cndmask_b32_e32 v10, v11, v7, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v18, v6
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v6, v19
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v11, v14, v5
; GFX9-NEXT:    v_add_u32_e32 v6, v7, v6
; GFX9-NEXT:    v_mul_hi_u32 v7, v9, v5
; GFX9-NEXT:    v_mul_hi_u32 v5, v14, v5
; GFX9-NEXT:    v_add_co_u32_e32 v11, vcc, v11, v20
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v3, v12, s[0:1]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX9-NEXT:    v_add3_u32 v5, v11, v7, v5
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v9, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, v14, v5, vcc
; GFX9-NEXT:    v_mul_lo_u32 v9, s15, v6
; GFX9-NEXT:    v_mul_lo_u32 v11, s14, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v2, v8, s[0:1]
; GFX9-NEXT:    v_mul_hi_u32 v2, s14, v6
; GFX9-NEXT:    v_mul_hi_u32 v6, s15, v6
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, v9, v11
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v8, v2
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v8, s15, v5
; GFX9-NEXT:    v_add_u32_e32 v2, v9, v2
; GFX9-NEXT:    v_mul_hi_u32 v9, s14, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v4, v4, v13, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v8, v6
; GFX9-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v6, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v12, vcc, v6, v2
; GFX9-NEXT:    v_mul_hi_u32 v13, s15, v5
...
; GFX10-NEXT:    v_mad_u64_u32 v[3:4], s3, s1, v7, v[4:5]
; GFX10-NEXT:    s_subb_u32 s3, 0, s19
; GFX10-NEXT:    v_mul_hi_u32 v4, v9, v0
...
; GFX10-NEXT:    v_add_co_u32 v6, s4, v6, v12
; GFX10-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s4
; GFX10-NEXT:    v_add_co_u32 v4, s4, v13, v4
; GFX10-NEXT:    v_cndmask_b32_e64 v13, 0, 1, s4
; GFX10-NEXT:    v_add_co_u32 v1, s4, v1, v15
; GFX10-NEXT:    v_cndmask_b32_e64 v15, 0, 1, s4
; GFX10-NEXT:    v_add_co_u32 v2, s4, v16, v2
; GFX10-NEXT:    v_cndmask_b32_e64 v16, 0, 1, s4
; GFX10-NEXT:    v_add_co_u32 v6, s4, v6, v11
; GFX10-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s4
; GFX10-NEXT:    v_add_co_u32 v4, s4, v4, v14
...
; GFX10-NEXT:    v_add_co_u32 v2, s4, v2, v17
; GFX10-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s4
; GFX10-NEXT:    v_add_co_u32 v4, s4, v4, v6
...
; GFX10-NEXT:    v_add_co_u32 v1, s4, v2, v1
...
; GFX10-NEXT:    v_mul_lo_u32 v12, v10, v2
...
; GFX10-NEXT:    v_mul_hi_u32 v1, v8, v2
; GFX10-NEXT:    v_mul_hi_u32 v2, v10, v2
; GFX10-NEXT:    v_mul_lo_u32 v5, v7, v3
; GFX10-NEXT:    v_mul_lo_u32 v13, v9, v3
; GFX10-NEXT:    v_mul_hi_u32 v14, v7, v3
; GFX10-NEXT:    v_mul_lo_u32 v15, v8, v0
; GFX10-NEXT:    v_mul_lo_u32 v16, v10, v0
...
; GFX10-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s0
; GFX10-NEXT:    v_add3_u32 v3, v11, v5, v3
; GFX10-NEXT:    v_add_co_u32 v4, vcc_lo, v7, v4
; GFX10-NEXT:    v_add3_u32 v0, v6, v2, v0
...
; GFX8-NEXT:    v_cndmask_b32_e32 v4, v2, v4, vcc
; GFX8-NEXT:    v_sub_u32_e32 v2, vcc, s8, v3
...
; GFX9-NEXT:    v_mul_hi_u32 v2, v0, v2
; GFX9-NEXT:    s_load_dwordx4 s[4:7], s[6:7], 0x0
; GFX9-NEXT:    v_mul_hi_u32 v3, v1, v3
; GFX9-NEXT:    v_add_u32_e32 v0, v0, v2
...
; GFX8-NEXT:    v_subrev_u32_e64 v6, s[0:1], s5, v5
; GFX8-NEXT:    v_cndmask_b32_e32 v5, v5, v6, vcc
; GFX8-NEXT:    v_and_b32_e32 v4, 0x7ffffff, v4
; GFX8-NEXT:    flat_store_dword v[2:3], v4
; GFX8-NEXT:    v_and_b32_e32 v2, 0x7ffffff, v5
