...
; CHECK-NEXT:    v_ashrrev_i32_e32 v14, 31, v5
...
; CHECK-NEXT:    v_mul_hi_u32 v13, v8, v2
; CHECK-NEXT:    v_mul_hi_u32 v9, v11, v2
; CHECK-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v10, v8, v[6:7]
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v4, v14
; CHECK-NEXT:    v_addc_u32_e32 v4, vcc, v5, v14, vcc
; CHECK-NEXT:    v_mul_lo_u32 v5, v8, v2
; CHECK-NEXT:    v_xor_b32_e32 v6, v3, v14
; CHECK-NEXT:    v_xor_b32_e32 v7, v4, v14
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v12, v5
; CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v3, v13
; CHECK-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; CHECK-NEXT:    v_mul_lo_u32 v5, v11, v2
...
; CHECK-NEXT:    v_mul_lo_u32 v5, v6, v2
; CHECK-NEXT:    v_mul_hi_u32 v8, v6, v3
; CHECK-NEXT:    v_mul_hi_u32 v3, v7, v3
; CHECK-NEXT:    v_mul_hi_u32 v9, v7, v2
...
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v3, v4
...
; CHECK-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v1, v8, v[3:4]
; CHECK-NEXT:    v_subb_u32_e64 v4, s[4:5], v7, v3, vcc
...
; CHECK-NEXT:    v_xor_b32_e32 v0, v0, v14
; CHECK-NEXT:    v_xor_b32_e32 v1, v1, v14
; CHECK-NEXT:    v_sub_i32_e32 v0, vcc, v0, v14
; CHECK-NEXT:    v_subb_u32_e32 v1, vcc, v1, v14, vcc
...
; CHECK-NEXT:    s_xor_b64 s[0:1], s[10:11], s[6:7]
...
; CHECK-NEXT:    v_mad_u64_u32 v[0:1], s[10:11], s3, v3, 0
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], s3, v4, v[1:2]
; CHECK-NEXT:    v_mul_hi_u32 v5, v3, v0
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], s5, v3, v[1:2]
...
; CHECK-NEXT:    v_mad_u64_u32 v[0:1], s[10:11], s8, v4, 0
; CHECK-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v5, v2
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], s8, v2, v[1:2]
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], s9, v4, v[1:2]
...
; CHECK-NEXT:    v_subb_u32_e64 v1, s[0:1], v4, v1, vcc
...
; GISEL-NEXT:    v_mov_b32_e32 v4, v10
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v13, v15, v[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v16, v15, v9
; GISEL-NEXT:    v_mul_hi_u32 v17, v12, v9
; GISEL-NEXT:    v_mul_hi_u32 v13, v15, v9
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v14, v12, v[10:11]
...
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v16, v10
...
; GISEL-NEXT:    v_addc_u32_e64 v7, s[4:5], v7, v12, s[4:5]
; GISEL-NEXT:    v_xor_b32_e32 v6, v6, v12
; GISEL-NEXT:    v_xor_b32_e32 v7, v7, v12
...
; GISEL-NEXT:    v_subbrev_u32_e64 v13, s[4:5], 0, v14, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v16, 0
...
; GISEL-NEXT:    v_cndmask_b32_e64 v15, v15, v20, s[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v20, v17, v0
; GISEL-NEXT:    v_mul_hi_u32 v21, v16, v0
; GISEL-NEXT:    v_mul_hi_u32 v22, v17, v0
; GISEL-NEXT:    v_mov_b32_e32 v0, v1
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v17, v[0:1]
; GISEL-NEXT:    v_subb_u32_e32 v8, vcc, v14, v8, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v19, v16, v[0:1]
; GISEL-NEXT:    v_sub_i32_e32 v1, vcc, v12, v5
; GISEL-NEXT:    v_subbrev_u32_e32 v5, vcc, 0, v8, vcc
; GISEL-NEXT:    v_mul_lo_u32 v8, v16, v0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v15
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v12, v1, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v13, v5, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v20, v8
; GISEL-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v21
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v13, v17, v0
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v8, v1
; GISEL-NEXT:    v_mul_hi_u32 v8, v16, v0
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v13, v22
...
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, v16, v1
; GISEL-NEXT:    v_addc_u32_e32 v13, vcc, v17, v0, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v8, 0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; GISEL-NEXT:    v_cndmask_b32_e32 v9, v10, v12, vcc
...
; GISEL-NEXT:    v_xor_b32_e32 v14, v9, v4
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v19, v8, v[0:1]
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v2, v15
; GISEL-NEXT:    v_addc_u32_e32 v2, vcc, v3, v15, vcc
; GISEL-NEXT:    v_mul_lo_u32 v3, v8, v0
...
; GISEL-NEXT:    v_mul_hi_u32 v2, v8, v0
...
; GISEL-NEXT:    v_mul_hi_u32 v8, v16, v1
...
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v8, v1
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v0, v1
; GISEL-NEXT:    v_mov_b32_e32 v0, v3
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v6, v1, v[0:1]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v14, v4
...
; CGP-NEXT:    v_mul_hi_u32 v16, v5, v2
; CGP-NEXT:    v_mul_hi_u32 v12, v14, v2
; CGP-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v13, v5, v[3:4]
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v10, v17
; CGP-NEXT:    v_mul_lo_u32 v10, v5, v2
; CGP-NEXT:    v_addc_u32_e32 v4, vcc, v11, v17, vcc
; CGP-NEXT:    v_xor_b32_e32 v11, v3, v17
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v15, v10
; CGP-NEXT:    v_xor_b32_e32 v13, v4, v17
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v16
; CGP-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v10, v14, v2
...
; CGP-NEXT:    v_mul_lo_u32 v4, v13, v3
; CGP-NEXT:    v_mul_lo_u32 v5, v11, v2
; CGP-NEXT:    v_mul_hi_u32 v10, v11, v3
; CGP-NEXT:    v_mul_hi_u32 v3, v13, v3
; CGP-NEXT:    v_mul_hi_u32 v12, v13, v2
...
; CGP-NEXT:    v_mul_hi_u32 v14, v7, v4
; CGP-NEXT:    v_mul_hi_u32 v10, v12, v4
; CGP-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v11, v7, v[5:6]
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v8, v15
; CGP-NEXT:    v_mul_lo_u32 v8, v7, v4
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, v9, v15, vcc
; CGP-NEXT:    v_xor_b32_e32 v9, v5, v15
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v13, v8
; CGP-NEXT:    v_xor_b32_e32 v11, v6, v15
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v14
; CGP-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v8, v12, v4
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v6, v5
; CGP-NEXT:    v_mul_hi_u32 v6, v7, v4
...
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v5, v6
...
; CGP-NEXT:    v_xor_b32_e32 v2, v2, v15
; CGP-NEXT:    v_xor_b32_e32 v3, v3, v15
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v2, v15
; CGP-NEXT:    v_subb_u32_e32 v3, vcc, v3, v15, vcc
...
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v6, v3
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v0, v2
; CHECK-NEXT:    v_mul_hi_u32 v6, v11, v1
...
; CHECK-NEXT:    v_subb_u32_e64 v2, vcc, v11, v1, s[4:5]
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, v11, v1
...
; GISEL-NEXT:    v_sub_i32_e32 v1, vcc, v12, v5
; GISEL-NEXT:    v_subbrev_u32_e32 v17, vcc, 0, v11, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v12, v1, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v11, v11, v17, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v14, v18
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e32 v8, v9, v12, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v9, v10, v11, vcc
...
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v0, v1
; GISEL-NEXT:    v_mov_b32_e32 v0, v3
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v5, v1, v[0:1]
...
; CGP-NEXT:    v_mul_hi_u32 v15, v21, v1
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v10, v0, 0
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v13, v12
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v15, v12
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v10, v12, v[1:2]
; CGP-NEXT:    v_sub_i32_e32 v13, vcc, v20, v0
; CGP-NEXT:    v_subb_u32_e64 v15, s[4:5], v21, v12, vcc
; CGP-NEXT:    v_sub_i32_e64 v0, s[4:5], v21, v12
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v13, v10
; CGP-NEXT:    v_subbrev_u32_e32 v0, vcc, 0, v0, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v1, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v15
; CGP-NEXT:    v_sub_i32_e32 v16, vcc, v13, v10
; CGP-NEXT:    v_cndmask_b32_e64 v12, -1, v1, s[4:5]
; CGP-NEXT:    v_subbrev_u32_e32 v17, vcc, 0, v0, vcc
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v6, v[14:15]
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v16, v10
; CGP-NEXT:    v_cndmask_b32_e64 v18, 0, -1, vcc
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], -1, v5, v[0:1]
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v17
; CGP-NEXT:    v_cndmask_b32_e32 v14, -1, v18, vcc
; CGP-NEXT:    v_mul_lo_u32 v19, v5, v0
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v16, v10
; CGP-NEXT:    v_subbrev_u32_e32 v18, vcc, 0, v17, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v14
; CGP-NEXT:    v_cndmask_b32_e32 v14, v16, v1, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v8, v15, v16, vcc
...
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v6
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v2, v4
; CGP-NEXT:    v_mul_hi_u32 v6, v15, v3
; CGP-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v10, v2, 0
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v5, v4
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v6, v4
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v10, v4, v[3:4]
...
; CGP-NEXT:    v_cndmask_b32_e32 v7, -1, v7, vcc
...
; CHECK-NEXT:    v_mul_hi_u32 v2, v11, v5
...
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v15, v13, v[11:12]
; GISEL-NEXT:    v_ashrrev_i32_e32 v4, 31, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v4
; GISEL-NEXT:    v_mul_lo_u32 v11, v13, v10
; GISEL-NEXT:    v_addc_u32_e32 v1, vcc, v1, v4, vcc
; GISEL-NEXT:    v_xor_b32_e32 v12, v0, v4
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v17, v11
; GISEL-NEXT:    v_xor_b32_e32 v15, v1, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
...
; GISEL-NEXT:    v_sub_i32_e32 v8, vcc, v12, v0
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v9, v13, v[10:11]
; GISEL-NEXT:    v_ashrrev_i32_e32 v12, 31, v7
; GISEL-NEXT:    v_subb_u32_e64 v11, s[4:5], v15, v10, vcc
...
; GISEL-NEXT:    v_cvt_f32_u32_e32 v12, v6
; GISEL-NEXT:    v_cvt_f32_u32_e32 v13, v7
; GISEL-NEXT:    v_subb_u32_e32 v14, vcc, v0, v9, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v11, v9
; GISEL-NEXT:    v_mac_f32_e32 v12, 0x4f800000, v13
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v0, v12
; GISEL-NEXT:    v_cndmask_b32_e64 v10, v1, v10, s[4:5]
...
; GISEL-NEXT:    v_cvt_u32_f32_e32 v16, v0
; GISEL-NEXT:    v_subbrev_u32_e64 v13, s[4:5], 0, v14, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v13, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[4:5]
; GISEL-NEXT:    v_sub_i32_e64 v18, s[4:5], 0, v6
; GISEL-NEXT:    v_cvt_u32_f32_e32 v17, v1
; GISEL-NEXT:    v_subb_u32_e64 v19, s[4:5], 0, v7, s[4:5]
...
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v12, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v20, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v13, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v15, v15, v20, s[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v20, v17, v0
; GISEL-NEXT:    v_mul_hi_u32 v21, v16, v0
; GISEL-NEXT:    v_mul_hi_u32 v22, v17, v0
; GISEL-NEXT:    v_mov_b32_e32 v0, v1
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v17, v[0:1]
; GISEL-NEXT:    v_subb_u32_e32 v9, vcc, v14, v9, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v19, v16, v[0:1]
; GISEL-NEXT:    v_sub_i32_e32 v1, vcc, v12, v5
; GISEL-NEXT:    v_subbrev_u32_e32 v5, vcc, 0, v9, vcc
; GISEL-NEXT:    v_mul_lo_u32 v9, v16, v0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v15
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v12, v1, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v13, v5, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v20, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v21
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v13, v17, v0
...
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v13, v9
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v9
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v16, v1
; GISEL-NEXT:    v_addc_u32_e32 v13, vcc, v17, v0, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v13, v[0:1]
; GISEL-NEXT:    v_ashrrev_i32_e32 v15, 31, v3
; GISEL-NEXT:    v_xor_b32_e32 v14, v8, v4
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v19, v9, v[0:1]
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v2, v15
; GISEL-NEXT:    v_addc_u32_e32 v2, vcc, v3, v15, vcc
...
; GISEL-NEXT:    v_mul_lo_u32 v3, v13, v0
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v2, v1
; GISEL-NEXT:    v_mul_hi_u32 v2, v9, v0
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v12
; GISEL-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v4, v16, v10
...
; CGP-NEXT:    v_xor_b32_e32 v15, v9, v14
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
...
; CGP-NEXT:    v_mov_b32_e32 v4, v9
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v12, v6, v[4:5]
; CGP-NEXT:    v_mul_lo_u32 v14, v6, v8
; CGP-NEXT:    v_mul_hi_u32 v15, v11, v8
; CGP-NEXT:    v_mul_hi_u32 v4, v6, v8
...
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v14, v9
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
...
; GISEL-NEXT:    v_mul_lo_u32 v8, v12, v5
...
; GISEL-NEXT:    v_sub_i32_e32 v6, vcc, v12, v7
...
; GISEL-NEXT:    v_subb_u32_e32 v8, vcc, v5, v3, vcc
; GISEL-NEXT:    v_mul_f32_e32 v5, 0x2f800000, v4
; GISEL-NEXT:    v_trunc_f32_e32 v5, v5
; GISEL-NEXT:    v_mac_f32_e32 v4, 0xcf800000, v5
; GISEL-NEXT:    v_cvt_u32_f32_e32 v9, v4
; GISEL-NEXT:    v_sub_i32_e32 v12, vcc, 0, v2
; GISEL-NEXT:    v_cvt_u32_f32_e32 v10, v5
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v9, 0
; GISEL-NEXT:    v_subb_u32_e32 v13, vcc, 0, v3, vcc
; GISEL-NEXT:    v_mul_lo_u32 v16, v10, v4
; GISEL-NEXT:    v_mul_hi_u32 v17, v9, v4
; GISEL-NEXT:    v_mul_hi_u32 v18, v10, v4
; GISEL-NEXT:    v_mov_b32_e32 v4, v5
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v10, v[4:5]
; GISEL-NEXT:    v_sub_i32_e32 v14, vcc, v6, v1
; GISEL-NEXT:    v_subbrev_u32_e64 v15, s[4:5], 0, v8, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v15, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v19, 0, -1, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v13, v9, v[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v14, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v15, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v19, v19, v5, s[4:5]
...
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v17, v10, v4
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v16, v5
; GISEL-NEXT:    v_mul_hi_u32 v16, v9, v4
...
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v9, 0
; GISEL-NEXT:    v_sub_i32_e32 v16, vcc, v14, v1
; GISEL-NEXT:    v_mov_b32_e32 v1, v5
; GISEL-NEXT:    v_mul_lo_u32 v17, v10, v4
; GISEL-NEXT:    v_mul_hi_u32 v18, v9, v4
; GISEL-NEXT:    v_mul_hi_u32 v20, v10, v4
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v10, v[1:2]
...
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v15, v8, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v7
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v6, v1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v6, v9, v4
; GISEL-NEXT:    v_add_i32_e64 v7, s[4:5], 0, v11
; GISEL-NEXT:    v_mul_lo_u32 v11, v10, v4
; GISEL-NEXT:    v_add_i32_e64 v6, s[4:5], v17, v6
; GISEL-NEXT:    v_cndmask_b32_e64 v8, 0, 1, s[4:5]
...
; GISEL-NEXT:    v_add_i32_e64 v6, s[4:5], v9, v6
; GISEL-NEXT:    v_addc_u32_e64 v4, s[4:5], v10, v4, s[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v8, v3, v6
; GISEL-NEXT:    v_mul_lo_u32 v9, v7, v4
; GISEL-NEXT:    v_cndmask_b32_e32 v10, v0, v5, vcc
; GISEL-NEXT:    v_mul_hi_u32 v0, v7, v6
; GISEL-NEXT:    v_mul_hi_u32 v6, v3, v6
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v8, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v5, v0
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
