...
; GFX9: ;;#ASMSTART
; GFX9-NEXT: ;;#ASMEND
; GFX9: image_gather4_c_b_cl v[41:44], v[32:39], s[4:11], s[4:7] dmask:0x1
...
; GFX10: image_gather4_c_b_cl v[41:44], v[32:39], s[4:11], s[4:7] dmask:0x1 dim:SQ_RSRC_IMG_2D
...
; GFX9: buffer_store_dword v56, off, s[0:3], s33 offset:16 ; 4-byte Folded Spill
...
; GFX9: image_gather4_c_b_cl v[0:3], v[56:63], s[36:43], s[4:7] dmask:0x1
; GFX9-NEXT: s_getpc_b64 s[4:5]
; GFX9-NEXT: s_add_u32 s4, s4, extern_func@gotpcrel32@lo+4
; GFX9-NEXT: s_addc_u32 s5, s5, extern_func@gotpcrel32@hi+12
; GFX9-NEXT: s_load_dwordx2 s[4:5], s[4:5], 0x0
...
; GFX9-NEXT: s_swappc_b64 s[30:31], s[4:5]
; GFX9-NEXT: image_gather4_c_b_cl v[0:3], v[56:63], s[36:43], s[4:7] dmask:0x1

; GFX9: buffer_load_dword v60, off, s[0:3], s33 ; 4-byte Folded Reload
