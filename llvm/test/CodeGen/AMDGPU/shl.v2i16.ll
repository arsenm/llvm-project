...
; CI-NEXT:    s_lshl_b32 s6, s2, s3
; CI-NEXT:    s_lshl_b32 s4, s4, s5
; CI-NEXT:    s_lshl_b32 s4, s4, 16
; CI-NEXT:    s_and_b32 s5, s6, 0xffff
...
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    v_lshrrev_b32_e32 v3, 16, v2
; CI-NEXT:    v_lshl_b32_e32 v2, s0, v2
; CI-NEXT:    v_lshl_b32_e32 v3, s1, v3
; CI-NEXT:    v_and_b32_e32 v2, 0xffff, v2
; CI-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; CI-NEXT:    v_or_b32_e32 v2, v2, v3
; CI-NEXT:    buffer_store_dword v2, v[0:1], s[4:7], 0 addr64
