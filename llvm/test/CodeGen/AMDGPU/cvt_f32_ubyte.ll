...
; RUN: llc -mtriple=amdgpu6.00-- < %s | FileCheck %s -check-prefixes=GCN,SI
; RUN: llc -mtriple=amdgpu8.02-- -mattr=-flat-for-global < %s | FileCheck %s -check-prefixes=GCN,VI
; RUN: llc -mtriple=amdgpu10.10-- < %s | FileCheck %s -check-prefixes=GFX10
; RUN: llc -mtriple=amdgpu9.08-- -start-before=amdgpu-isel < %s | FileCheck %s -check-prefixes=GFX9
; RUN: llc -mtriple=amdgpu11.00-- -mattr=+real-true16 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-TRUE16
; RUN: llc -mtriple=amdgpu11.00-- -mattr=-real-true16 < %s | FileCheck %s -check-prefixes=GFX11,GFX11-FAKE16
