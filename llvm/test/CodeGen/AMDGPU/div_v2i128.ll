...
; SDAG-NEXT:    s_or_b64 exec, exec, s[6:7]
; SDAG-NEXT:    v_mul_lo_u32 v20, v33, v3
; SDAG-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v33, v2, 0
; SDAG-NEXT:    v_mul_lo_u32 v21, v27, v2
; SDAG-NEXT:    v_mul_lo_u32 v23, v35, v31
; SDAG-NEXT:    v_mul_lo_u32 v24, v32, v30
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v31, v33, 0
; SDAG-NEXT:    v_mul_lo_u32 v22, v14, v7
; SDAG-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v14, v6, 0
; SDAG-NEXT:    v_mul_lo_u32 v25, v15, v6
; SDAG-NEXT:    v_mul_lo_u32 v35, v19, v37
; SDAG-NEXT:    v_mul_lo_u32 v38, v18, v36
; SDAG-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v37, v14, 0
; SDAG-NEXT:    v_add_i32_e32 v11, vcc, v11, v20
; SDAG-NEXT:    v_mov_b32_e32 v19, v3
; SDAG-NEXT:    v_sub_i32_e32 v16, vcc, v16, v2
; SDAG-NEXT:    v_mov_b32_e32 v20, 0
; SDAG-NEXT:    v_add_i32_e64 v13, s[4:5], v13, v22
; SDAG-NEXT:    v_add_i32_e64 v11, s[4:5], v11, v21
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v30, v33, v[19:20]
; SDAG-NEXT:    v_xor_b32_e32 v16, v16, v28
; SDAG-NEXT:    v_add_i32_e64 v13, s[4:5], v13, v25
; SDAG-NEXT:    v_mov_b32_e32 v19, v7
; SDAG-NEXT:    v_mad_u64_u32 v[21:22], s[4:5], v36, v14, v[19:20]
; SDAG-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v32, v31, v[10:11]
; SDAG-NEXT:    v_mov_b32_e32 v7, v3
; SDAG-NEXT:    v_mov_b32_e32 v3, v20
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v31, v27, v[2:3]
; SDAG-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v18, v37, v[12:13]
; SDAG-NEXT:    v_mov_b32_e32 v14, v22
; SDAG-NEXT:    v_mov_b32_e32 v22, v20
; SDAG-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v37, v15, v[21:22]
; SDAG-NEXT:    v_add_i32_e64 v11, s[4:5], v23, v11
; SDAG-NEXT:    v_mov_b32_e32 v20, v2
; SDAG-NEXT:    v_mov_b32_e32 v2, v3
; SDAG-NEXT:    v_add_i32_e64 v2, s[4:5], v7, v2
; SDAG-NEXT:    v_addc_u32_e64 v3, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v7, vcc, v17, v20, vcc
; SDAG-NEXT:    v_add_i32_e64 v17, s[4:5], v35, v13
; SDAG-NEXT:    v_mov_b32_e32 v13, v19
; SDAG-NEXT:    v_add_i32_e64 v13, s[4:5], v14, v13
; SDAG-NEXT:    v_addc_u32_e64 v14, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_add_i32_e64 v11, s[4:5], v24, v11
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v30, v27, v[2:3]
; SDAG-NEXT:    v_xor_b32_e32 v7, v7, v29
; SDAG-NEXT:    v_add_i32_e64 v17, s[4:5], v38, v17
; SDAG-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v36, v15, v[13:14]
; SDAG-NEXT:    v_add_i32_e64 v2, s[4:5], v2, v10
; SDAG-NEXT:    v_addc_u32_e64 v3, s[4:5], v3, v11, s[4:5]
; SDAG-NEXT:    v_add_i32_e64 v10, s[4:5], v13, v12
; SDAG-NEXT:    v_addc_u32_e64 v11, s[4:5], v14, v17, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v0, vcc, v0, v2, vcc
; SDAG-NEXT:    v_subb_u32_e32 v1, vcc, v1, v3, vcc
...
; SDAG-NEXT:    s_or_b64 exec, exec, s[6:7]
; SDAG-NEXT:    v_mul_lo_u32 v24, v32, v11
; SDAG-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v32, v10, 0
; SDAG-NEXT:    v_mul_lo_u32 v25, v30, v10
; SDAG-NEXT:    v_mul_lo_u32 v27, v33, v8
; SDAG-NEXT:    v_mul_lo_u32 v28, v31, v9
; SDAG-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v8, v32, 0
; SDAG-NEXT:    v_mul_lo_u32 v26, v20, v15
; SDAG-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v20, v14, 0
; SDAG-NEXT:    v_mul_lo_u32 v29, v21, v14
; SDAG-NEXT:    v_mul_lo_u32 v33, v23, v12
; SDAG-NEXT:    v_mul_lo_u32 v34, v22, v13
; SDAG-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v12, v20, 0
; SDAG-NEXT:    v_add_i32_e32 v17, vcc, v17, v24
; SDAG-NEXT:    v_mov_b32_e32 v23, v11
; SDAG-NEXT:    v_sub_i32_e32 v0, vcc, v0, v10
; SDAG-NEXT:    v_mov_b32_e32 v24, 0
; SDAG-NEXT:    v_add_i32_e64 v19, s[4:5], v19, v26
; SDAG-NEXT:    v_add_i32_e64 v17, s[4:5], v17, v25
; SDAG-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v9, v32, v[23:24]
; SDAG-NEXT:    v_add_i32_e64 v19, s[4:5], v19, v29
; SDAG-NEXT:    v_mov_b32_e32 v23, v15
; SDAG-NEXT:    v_mad_u64_u32 v[25:26], s[4:5], v13, v20, v[23:24]
; SDAG-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v31, v8, v[16:17]
; SDAG-NEXT:    v_mov_b32_e32 v23, v11
; SDAG-NEXT:    v_mov_b32_e32 v11, v24
; SDAG-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v8, v30, v[10:11]
; SDAG-NEXT:    v_mad_u64_u32 v[17:18], s[4:5], v22, v12, v[18:19]
; SDAG-NEXT:    v_mov_b32_e32 v8, v26
; SDAG-NEXT:    v_mov_b32_e32 v26, v24
; SDAG-NEXT:    v_mad_u64_u32 v[19:20], s[4:5], v12, v21, v[25:26]
; SDAG-NEXT:    v_add_i32_e64 v12, s[4:5], v27, v16
; SDAG-NEXT:    v_mov_b32_e32 v16, v10
; SDAG-NEXT:    v_mov_b32_e32 v10, v11
; SDAG-NEXT:    v_add_i32_e64 v10, s[4:5], v23, v10
; SDAG-NEXT:    v_addc_u32_e64 v11, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v1, vcc, v1, v16, vcc
; SDAG-NEXT:    v_add_i32_e64 v16, s[4:5], v33, v18
; SDAG-NEXT:    v_mov_b32_e32 v22, v19
; SDAG-NEXT:    v_mov_b32_e32 v18, v20
; SDAG-NEXT:    v_add_i32_e64 v18, s[4:5], v8, v18
; SDAG-NEXT:    v_addc_u32_e64 v19, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_add_i32_e64 v12, s[4:5], v28, v12
; SDAG-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v9, v30, v[10:11]
; SDAG-NEXT:    v_add_i32_e64 v16, s[4:5], v34, v16
; SDAG-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v13, v21, v[18:19]
; SDAG-NEXT:    v_add_i32_e64 v8, s[4:5], v8, v15
; SDAG-NEXT:    v_addc_u32_e64 v9, s[4:5], v9, v12, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v2, vcc, v2, v8, vcc
; SDAG-NEXT:    v_subb_u32_e32 v3, vcc, v3, v9, vcc
; SDAG-NEXT:    v_add_i32_e32 v8, vcc, v10, v17
; SDAG-NEXT:    v_addc_u32_e32 v9, vcc, v11, v16, vcc
; SDAG-NEXT:    v_sub_i32_e32 v4, vcc, v4, v14
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, v5, v22, vcc
