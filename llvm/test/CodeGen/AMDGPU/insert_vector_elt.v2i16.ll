...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx4 s[0:3], s[6:7], 0x0
; GFX9-NEXT:    s_load_dword s4, s[6:7], 0x30
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_load_dword s2, s[2:3], 0x0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; CI-NEXT:    s_load_dword s4, s[6:7], 0xc
...
; GFX11-NEXT:    s_load_b32 s0, s[2:3], 0x30
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    s_load_b64 s[4:5], s[2:3], 0x10
; GFX11-NEXT:    s_load_b128 s[0:3], s[2:3], 0x0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_bfi_b32 v1, s3, v4, v1
; GFX9-NEXT:    v_bfi_b32 v0, s2, v3, v0
; GFX9-NEXT:    global_store_dwordx2 v2, v[0:1], s[0:1]
; GFX9-NEXT:    s_endpgm
;
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx4 s[12:15], s[6:7], 0x0
; GFX9-NEXT:    s_load_dwordx2 s[16:17], s[6:7], 0x10
; GFX9-NEXT:    v_lshlrev_b32_e32 v4, 4, v0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_dwordx4 v[0:3], v4, s[14:15]
; GFX9-NEXT:    s_cmp_eq_u32 s17, 6
; GFX9-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s17, 7
; GFX9-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s17, 4
; GFX9-NEXT:    s_cselect_b64 s[2:3], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s17, 5
; GFX9-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s17, 2
; GFX9-NEXT:    s_cselect_b64 s[6:7], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s17, 3
; GFX9-NEXT:    s_cselect_b64 s[8:9], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s17, 0
; GFX9-NEXT:    s_cselect_b64 s[10:11], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s17, 1
...
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v2, v9, s[2:3]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v0, v9, s[10:11]
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v8, v9, vcc
; GFX9-NEXT:    v_perm_b32 v3, v5, v3, s14
; GFX9-NEXT:    v_perm_b32 v2, v6, v2, s14
; GFX9-NEXT:    v_perm_b32 v1, v7, v1, s14
; GFX9-NEXT:    v_perm_b32 v0, v8, v0, s14
...
; CI-NEXT:    v_addc_u32_e32 v11, vcc, 0, v9, vcc
; CI-NEXT:    s_waitcnt vmcnt(1)
; CI-NEXT:    v_bfi_b32 v3, s1, v12, v3
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    flat_store_dwordx4 v[10:11], v[4:7]
; CI-NEXT:    flat_store_dwordx4 v[8:9], v[0:3]
; CI-NEXT:    s_endpgm
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx4 s[28:31], s[6:7], 0x0
; GFX9-NEXT:    s_load_dwordx2 s[34:35], s[6:7], 0x10
; GFX9-NEXT:    v_lshlrev_b32_e32 v0, 5, v0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_dwordx4 v[1:4], v0, s[30:31]
; GFX9-NEXT:    global_load_dwordx4 v[5:8], v0, s[30:31] offset:16
; GFX9-NEXT:    s_cmp_eq_u32 s35, 6
; GFX9-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 7
; GFX9-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 4
; GFX9-NEXT:    s_cselect_b64 s[2:3], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 5
; GFX9-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 2
; GFX9-NEXT:    s_cselect_b64 s[6:7], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 3
; GFX9-NEXT:    s_cselect_b64 s[8:9], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 0
; GFX9-NEXT:    s_cselect_b64 s[10:11], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 1
; GFX9-NEXT:    s_cselect_b64 s[12:13], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 14
; GFX9-NEXT:    s_cselect_b64 s[14:15], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 15
; GFX9-NEXT:    s_cselect_b64 s[16:17], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 12
; GFX9-NEXT:    s_cselect_b64 s[18:19], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 13
; GFX9-NEXT:    s_cselect_b64 s[20:21], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 10
; GFX9-NEXT:    s_cselect_b64 s[22:23], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 11
; GFX9-NEXT:    s_cselect_b64 s[24:25], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 8
; GFX9-NEXT:    s_cselect_b64 s[26:27], -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s35, 9
; GFX9-NEXT:    v_mov_b32_e32 v17, s34
; GFX9-NEXT:    s_mov_b32 s30, 0x5040100
; GFX9-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NEXT:    v_lshrrev_b32_e32 v9, 16, v4
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_lshrrev_b32_e32 v13, 16, v8
...
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v8, v17, s[14:15]
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v17, s[16:17]
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v7, v17, s[18:19]
; GFX9-NEXT:    v_cndmask_b32_e64 v14, v14, v17, s[20:21]
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v6, v17, s[22:23]
; GFX9-NEXT:    v_cndmask_b32_e64 v15, v15, v17, s[24:25]
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v5, v17, s[26:27]
; GFX9-NEXT:    v_cndmask_b32_e32 v16, v16, v17, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v9, v9, v17, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v3, v17, s[2:3]
; GFX9-NEXT:    v_cndmask_b32_e64 v10, v10, v17, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v2, v17, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v11, v17, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v1, v17, s[10:11]
; GFX9-NEXT:    v_cndmask_b32_e64 v12, v12, v17, s[12:13]
; GFX9-NEXT:    v_perm_b32 v8, v13, v8, s30
; GFX9-NEXT:    v_perm_b32 v7, v14, v7, s30
; GFX9-NEXT:    v_perm_b32 v6, v15, v6, s30
; GFX9-NEXT:    v_perm_b32 v5, v16, v5, s30
; GFX9-NEXT:    v_perm_b32 v4, v9, v4, s30
; GFX9-NEXT:    v_perm_b32 v3, v10, v3, s30
; GFX9-NEXT:    v_perm_b32 v2, v11, v2, s30
; GFX9-NEXT:    v_perm_b32 v1, v12, v1, s30
; GFX9-NEXT:    global_store_dwordx4 v0, v[5:8], s[28:29] offset:16
; GFX9-NEXT:    global_store_dwordx4 v0, v[1:4], s[28:29]
; GFX9-NEXT:    s_endpgm
;
