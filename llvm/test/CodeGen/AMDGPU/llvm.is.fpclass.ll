...
; GFX7GLISEL-NEXT:    v_cmp_class_f32_e64 s[4:5], s4, 3
...
; GFX8CHECK-NEXT:    v_cmp_class_f32_e64 s[2:3], s4, 3
...
; GFX9CHECK-NEXT:    v_cmp_class_f32_e64 s[2:3], s4, 3
...
; GFX10CHECK-NEXT:    v_cmp_class_f32_e64 s2, s4, 3
...
; GFX11CHECK-NEXT:    v_cmp_class_f32_e64 s2, s4, 3
...
; GFX7SELDAG:       ; %bb.0:
; GFX7SELDAG-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
...
; GFX7GLISEL:       ; %bb.0:
; GFX7GLISEL-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
; GFX7GLISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8SELDAG:       ; %bb.0:
; GFX8SELDAG-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x24
...
; GFX8GLISEL:       ; %bb.0:
; GFX8GLISEL-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x24
...
; GFX10CHECK:       ; %bb.0:
; GFX10CHECK-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x24
; GFX10CHECK-NEXT:    v_mov_b32_e32 v0, 0
; GFX10CHECK-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11CHECK:       ; %bb.0:
; GFX11CHECK-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX11CHECK-NEXT:    v_mov_b32_e32 v0, 0
; GFX11CHECK-NEXT:    s_waitcnt lgkmcnt(0)
