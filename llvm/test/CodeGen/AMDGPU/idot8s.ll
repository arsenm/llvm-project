...
; GFX8-NEXT:    v_bfe_i32 v1, v4, 0, 4
; GFX8-NEXT:    v_bfe_i32 v3, v4, 4, 4
; GFX8-NEXT:    v_bfe_i32 v6, v4, 8, 4
; GFX8-NEXT:    v_bfe_i32 v8, v4, 12, 4
; GFX8-NEXT:    v_bfe_i32 v10, v4, 16, 4
...
; GFX8-NEXT:    v_mad_i32_i24 v1, v3, v5, v1
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_add3_u32 v2, v3, s2, v4
...
; GFX9-DL-NEXT:    v_dot8_i32_i4 v1, v1, v2, s2
...
; GFX10-DL-XNACK-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; GFX10-DL-XNACK-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
...
; GFX10-DL-XNACK-NEXT:    s_add_u32 s12, s12, s9
...
; GFX10-DL-NOXNACK-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; GFX10-DL-NOXNACK-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
...
; GFX10-DL-NOXNACK-NEXT:    s_add_u32 s12, s12, s9
...
; GFX8-NEXT:    v_lshlrev_b16_sdwa v18, v5, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-NEXT:    v_lshlrev_b16_sdwa v19, v5, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-NEXT:    v_lshlrev_b16_sdwa v4, v5, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_3
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_mad_u16 v3, v5, v16, v3
...
; GFX8-NEXT:    v_mad_u16 v3, v7, v12, v3
...
; GFX8-NEXT:    v_ashrrev_i32_e32 v0, 28, v0
; GFX8-NEXT:    v_mad_i32_i24 v1, v14, v15, v1
; GFX8-NEXT:    v_mad_i32_i24 v0, v4, v0, v1
...
; GFX9-NEXT:    v_mul_i32_i24_e32 v1, v1, v2
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_mad_i32_i24 v2, v3, v4, s2
...
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    v_mad_i32_i24 v2, v3, v4, s2
...
; GFX8-NEXT:    v_mov_b32_e32 v3, 12
; GFX8-NEXT:    s_mov_b32 s14, -1
; GFX8-NEXT:    s_mov_b32 s15, 0xe80000
; GFX8-NEXT:    s_add_u32 s12, s12, s9
; GFX8-NEXT:    s_addc_u32 s13, s13, 0
; GFX8-NEXT:    s_waitcnt vmcnt(2)
; GFX8-NEXT:    v_lshrrev_b32_e32 v6, 20, v4
; GFX8-NEXT:    v_lshrrev_b32_e32 v7, 28, v4
; GFX8-NEXT:    v_lshrrev_b32_e32 v10, 4, v4
; GFX8-NEXT:    v_lshlrev_b16_e32 v16, 12, v4
...
; GFX8-NEXT:    v_lshlrev_b16_sdwa v19, v3, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_3
; GFX8-NEXT:    v_lshlrev_b16_sdwa v2, v3, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-NEXT:    v_lshrrev_b32_e32 v8, 12, v4
; GFX8-NEXT:    v_lshrrev_b32_e32 v9, 8, v4
...
; GFX8-NEXT:    v_mul_lo_u16_sdwa v2, v6, v2 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX8-NEXT:    v_mul_lo_u16_sdwa v6, v7, v12 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX8-NEXT:    v_mul_lo_u16_e32 v15, v4, v19
; GFX8-NEXT:    v_mul_lo_u16_e32 v10, v10, v17
; GFX8-NEXT:    v_mul_lo_u16_sdwa v7, v8, v13 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX8-NEXT:    v_mul_lo_u16_e32 v8, v9, v14
; GFX8-NEXT:    v_mul_lo_u16_sdwa v9, v3, v11 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX8-NEXT:    v_or_b32_sdwa v6, v20, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX8-NEXT:    v_or_b32_sdwa v3, v15, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX8-NEXT:    v_or_b32_sdwa v7, v8, v7 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX8-NEXT:    v_or_b32_sdwa v8, v10, v9 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
