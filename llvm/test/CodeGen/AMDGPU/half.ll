...
; CIVI-NEXT:    v_mov_b32_e32 v5, s3
; CIVI-NEXT:    v_mov_b32_e32 v3, s5
; CIVI-NEXT:    v_mov_b32_e32 v1, s1
; CIVI-NEXT:    v_mov_b32_e32 v4, s2
; CIVI-NEXT:    flat_store_short v[2:3], v5
; CIVI-NEXT:    flat_store_dword v[0:1], v4
; CIVI-NEXT:    s_endpgm
;
...
; CI-NEXT:    s_load_dwordx4 s[0:3], s[6:7], 0x4
; CI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dword s0, s[6:7], 0x8
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_cvt_f32_f16_e32 v0, s0
; VI-NEXT:    s_load_dwordx2 s[0:1], s[6:7], 0x0
...
; GFX11-NEXT:    v_cvt_f32_f16_e32 v0, s4
; GFX11-NEXT:    v_cvt_f32_f16_e32 v16, s0
...
; CI-NEXT:    s_add_u32 s2, s0, 16
; CI-NEXT:    s_addc_u32 s3, s1, 0
; CI-NEXT:    s_add_u32 s4, s0, 48
; CI-NEXT:    s_addc_u32 s5, s1, 0
; CI-NEXT:    s_add_u32 s6, s0, 32
; CI-NEXT:    s_addc_u32 s7, s1, 0
; CI-NEXT:    v_mov_b32_e32 v21, s5
; CI-NEXT:    v_mov_b32_e32 v20, s4
; CI-NEXT:    v_mov_b32_e32 v23, s7
; CI-NEXT:    v_mov_b32_e32 v22, s6
...
; VI-NEXT:    v_cvt_f32_f16_e32 v14, v5
; VI-NEXT:    v_cvt_f32_f16_e32 v12, v4
; VI-NEXT:    v_cvt_f32_f16_sdwa v15, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f32_f16_sdwa v13, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f32_f16_e32 v6, v3
; VI-NEXT:    v_cvt_f32_f16_e32 v4, v2
...
; VI-NEXT:    flat_store_dwordx4 v[22:23], v[16:19]
; VI-NEXT:    flat_store_dwordx4 v[20:21], v[12:15]
; VI-NEXT:    flat_store_dwordx4 v[24:25], v[4:7]
; VI-NEXT:    flat_store_dwordx4 v[26:27], v[8:11]
; VI-NEXT:    s_endpgm
;
...
; CI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v2
; CI-NEXT:    v_cvt_f64_f32_e32 v[0:1], v1
; CI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v3
; CI-NEXT:    flat_store_dwordx2 v[8:9], v[4:5]
...
; VI-NEXT:    s_add_u32 s8, s0, 0x50
; VI-NEXT:    v_mov_b32_e32 v12, s4
; VI-NEXT:    s_addc_u32 s9, s1, 0
; VI-NEXT:    s_add_u32 s10, s0, 64
; VI-NEXT:    s_addc_u32 s11, s1, 0
; VI-NEXT:    v_mov_b32_e32 v15, s7
; VI-NEXT:    s_add_u32 s12, s0, 0x70
; VI-NEXT:    v_mov_b32_e32 v11, s1
; VI-NEXT:    v_mov_b32_e32 v14, s6
; VI-NEXT:    s_addc_u32 s13, s1, 0
; VI-NEXT:    v_mov_b32_e32 v10, s0
; VI-NEXT:    s_add_u32 s14, s0, 0x60
; VI-NEXT:    s_addc_u32 s15, s1, 0
...
; VI-NEXT:    s_waitcnt vmcnt(1)
; VI-NEXT:    v_cvt_f32_f16_e32 v24, v6
; VI-NEXT:    v_cvt_f32_f16_sdwa v25, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f32_f16_e32 v28, v4
; VI-NEXT:    v_cvt_f32_f16_sdwa v29, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_cvt_f32_f16_e32 v4, v3
; VI-NEXT:    v_cvt_f32_f16_sdwa v6, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f32_f16_e32 v30, v5
; VI-NEXT:    v_cvt_f32_f16_sdwa v31, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f64_f32_e32 v[3:4], v4
; VI-NEXT:    v_cvt_f64_f32_e32 v[5:6], v6
; VI-NEXT:    v_cvt_f32_f16_e32 v18, v2
; VI-NEXT:    v_cvt_f32_f16_e32 v26, v7
; VI-NEXT:    v_cvt_f32_f16_sdwa v27, v7 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    flat_store_dwordx4 v[8:9], v[3:6]
; VI-NEXT:    v_cvt_f32_f16_e32 v7, v0
; VI-NEXT:    v_cvt_f32_f16_sdwa v4, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f32_f16_sdwa v6, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f32_f16_e32 v0, v1
; VI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v18
; VI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v4
; VI-NEXT:    v_cvt_f32_f16_sdwa v8, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f64_f32_e32 v[0:1], v0
; VI-NEXT:    v_mov_b32_e32 v19, s11
; VI-NEXT:    flat_store_dwordx4 v[12:13], v[2:5]
; VI-NEXT:    v_cvt_f64_f32_e32 v[12:13], v30
; VI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v8
; VI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v7
; VI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v6
; VI-NEXT:    v_cvt_f64_f32_e32 v[8:9], v26
; VI-NEXT:    flat_store_dwordx4 v[14:15], v[0:3]
; VI-NEXT:    v_cvt_f64_f32_e32 v[14:15], v31
; VI-NEXT:    flat_store_dwordx4 v[10:11], v[4:7]
; VI-NEXT:    v_cvt_f64_f32_e32 v[10:11], v27
; VI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v28
; VI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v29
...
; CI-NEXT:    flat_store_short v[0:1], v2
; CI-NEXT:    flat_store_dword v[3:4], v5
; CI-NEXT:    s_endpgm
;
...
; VI-NEXT:    v_cvt_f16_f32_e32 v6, v0
...
; CI-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; CI-NEXT:    v_lshlrev_b32_e32 v20, 16, v1
; CI-NEXT:    v_or_b32_e32 v1, v2, v3
; CI-NEXT:    v_lshlrev_b32_e32 v2, 16, v7
; CI-NEXT:    v_lshlrev_b32_e32 v5, 16, v5
; CI-NEXT:    v_or_b32_e32 v0, v0, v20
...
; CI-NEXT:    v_or_b32_e32 v7, v10, v4
; CI-NEXT:    v_or_b32_e32 v6, v8, v5
; CI-NEXT:    v_or_b32_e32 v5, v14, v9
; CI-NEXT:    v_or_b32_e32 v4, v12, v11
...
; VI-NEXT:    v_cvt_f16_f32_sdwa v3, v3 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; VI-NEXT:    v_cvt_f16_f32_e32 v2, v2
; VI-NEXT:    v_cvt_f16_f32_sdwa v20, v1 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; VI-NEXT:    v_cvt_f16_f32_e32 v0, v0
...
; VI-NEXT:    v_or_b32_e32 v3, v6, v7
; VI-NEXT:    v_or_b32_e32 v2, v4, v5
; VI-NEXT:    v_or_b32_e32 v7, v10, v11
; VI-NEXT:    v_or_b32_e32 v6, v8, v9
; VI-NEXT:    v_or_b32_e32 v5, v14, v15
; VI-NEXT:    v_or_b32_e32 v4, v12, v13
