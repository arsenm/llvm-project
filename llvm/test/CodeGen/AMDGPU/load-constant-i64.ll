...
; GFX8-NEXT:    flat_store_dwordx2 v[4:5], v[6:7]
; GFX8-NEXT:    v_mov_b32_e32 v5, s1
; GFX8-NEXT:    v_mov_b32_e32 v1, s5
; GFX8-NEXT:    v_mov_b32_e32 v2, s6
; GFX8-NEXT:    v_mov_b32_e32 v3, s7
...
; GFX6-NEXT:    buffer_store_dwordx4 v[12:15], off, s[16:19], 0
; GFX6-NEXT:    s_endpgm
;
...
; GFX8-NEXT:    s_add_u32 s0, s16, 48
; GFX8-NEXT:    v_mov_b32_e32 v13, s1
; GFX8-NEXT:    s_addc_u32 s1, s17, 0
...
; GFX6-NEXT:    buffer_store_dwordx4 v[8:11], off, s[36:39], 0 offset:80
; GFX6-NEXT:    buffer_store_dwordx4 v[12:15], off, s[36:39], 0 offset:64
...
; GFX6-NEXT:    buffer_store_dwordx4 v[4:7], off, s[36:39], 0 offset:32
; GFX6-NEXT:    buffer_store_dwordx4 v[8:11], off, s[36:39], 0 offset:16
; GFX6-NEXT:    buffer_store_dwordx4 v[12:15], off, s[36:39], 0
; GFX6-NEXT:    s_endpgm
;
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mov_b32_e32 v12, s16
; GFX7-NEXT:    s_add_u32 s16, s36, 0x70
; GFX7-NEXT:    v_mov_b32_e32 v13, s17
; GFX7-NEXT:    s_addc_u32 s17, s37, 0
; GFX7-NEXT:    v_mov_b32_e32 v16, s16
; GFX7-NEXT:    v_mov_b32_e32 v1, s29
; GFX7-NEXT:    v_mov_b32_e32 v2, s30
; GFX7-NEXT:    v_mov_b32_e32 v3, s31
; GFX7-NEXT:    v_mov_b32_e32 v0, s28
; GFX7-NEXT:    v_mov_b32_e32 v17, s17
; GFX7-NEXT:    s_add_u32 s16, s36, 0x60
; GFX7-NEXT:    flat_store_dwordx4 v[16:17], v[0:3]
; GFX7-NEXT:    s_addc_u32 s17, s37, 0
; GFX7-NEXT:    v_mov_b32_e32 v0, s16
...
; GFX7-NEXT:    v_mov_b32_e32 v1, s17
; GFX7-NEXT:    s_add_u32 s16, s36, 0x50
; GFX7-NEXT:    flat_store_dwordx4 v[0:1], v[4:7]
; GFX7-NEXT:    s_addc_u32 s17, s37, 0
; GFX7-NEXT:    v_mov_b32_e32 v0, s16
; GFX7-NEXT:    v_mov_b32_e32 v8, s20
; GFX7-NEXT:    v_mov_b32_e32 v9, s21
; GFX7-NEXT:    v_mov_b32_e32 v10, s22
; GFX7-NEXT:    v_mov_b32_e32 v11, s23
; GFX7-NEXT:    v_mov_b32_e32 v1, s17
; GFX7-NEXT:    s_add_u32 s16, s36, 64
; GFX7-NEXT:    flat_store_dwordx4 v[0:1], v[8:11]
; GFX7-NEXT:    s_addc_u32 s17, s37, 0
; GFX7-NEXT:    v_mov_b32_e32 v0, s16
; GFX7-NEXT:    v_mov_b32_e32 v14, s18
; GFX7-NEXT:    v_mov_b32_e32 v15, s19
; GFX7-NEXT:    v_mov_b32_e32 v1, s17
; GFX7-NEXT:    flat_store_dwordx4 v[0:1], v[12:15]
; GFX7-NEXT:    v_mov_b32_e32 v1, s13
; GFX7-NEXT:    v_mov_b32_e32 v12, s0
; GFX7-NEXT:    s_add_u32 s0, s36, 48
; GFX7-NEXT:    v_mov_b32_e32 v13, s1
...
; GFX8-NEXT:    s_add_u32 s16, s36, 0x70
...
; GFX8-NEXT:    s_add_u32 s16, s36, 0x60
; GFX8-NEXT:    flat_store_dwordx4 v[16:17], v[0:3]
; GFX8-NEXT:    s_addc_u32 s17, s37, 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s16
...
; GFX8-NEXT:    v_mov_b32_e32 v1, s17
; GFX8-NEXT:    s_add_u32 s16, s36, 0x50
; GFX8-NEXT:    flat_store_dwordx4 v[0:1], v[4:7]
; GFX8-NEXT:    s_addc_u32 s17, s37, 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s16
