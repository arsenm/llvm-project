...
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v23, v13, 0
; GFX9-NEXT:    v_mov_b32_e32 v8, 0
; GFX9-NEXT:    v_mul_lo_u32 v9, v10, v4
; GFX9-NEXT:    v_mul_lo_u32 v15, v13, v5
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v13, v4, 0
; GFX9-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v22, v13, v[7:8]
; GFX9-NEXT:    v_add3_u32 v5, v5, v15, v9
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v23, v[4:5]
; GFX9-NEXT:    v_mov_b32_e32 v9, v14
; GFX9-NEXT:    v_mov_b32_e32 v14, v8
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v23, v10, v[13:14]
...
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v9, v7
...
; GFX9-NEXT:    v_add3_u32 v5, v11, v5, v12
; GFX9-NEXT:    v_add_co_u32_e64 v4, s[4:5], v7, v4
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v1, v13, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v5, s[4:5], v8, v5, s[4:5]
...
; GFX9-NEXT:    v_mov_b32_e32 v10, 0
; GFX9-NEXT:    v_mul_lo_u32 v16, v13, v6
; GFX9-NEXT:    v_mul_lo_u32 v17, v12, v7
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v12, v6, 0
; GFX9-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v5, v12, v[9:10]
; GFX9-NEXT:    v_add3_u32 v7, v7, v17, v16
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v14, v4, v[6:7]
; GFX9-NEXT:    v_mov_b32_e32 v16, v12
; GFX9-NEXT:    v_mov_b32_e32 v12, v10
; GFX9-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v4, v13, v[11:12]
...
; GFX9-NEXT:    v_add_co_u32_e32 v9, vcc, v16, v4
; GFX9-NEXT:    v_addc_co_u32_e64 v10, s[4:5], 0, 0, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v5, v13, v[9:10]
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v0, v8
; GFX9-NEXT:    v_add3_u32 v7, v12, v7, v11
; GFX9-NEXT:    v_add_co_u32_e64 v4, s[4:5], v4, v6
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v1, v14, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v5, s[4:5], v5, v7, s[4:5]
; GFX9-NEXT:    v_subb_co_u32_e32 v2, vcc, v2, v4, vcc
; GFX9-NEXT:    v_subb_co_u32_e32 v3, vcc, v3, v5, vcc
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
