...
; VI-NEXT:    s_and_b32 s4, s2, 0xffffff
; VI-NEXT:    s_and_b32 s5, s3, 0xffffff
...
; GFX9-NEXT:    s_and_b32 s0, s6, 0xffffff
; GFX9-NEXT:    s_and_b32 s1, s7, 0xffffff
...
; SI-NEXT:    buffer_load_ushort v0, v[2:3], s[4:7], 0 addr64
; SI-NEXT:    v_lshlrev_b32_e32 v3, 1, v1
...
; SI-NEXT:    s_load_dword s0, s[2:3], 0xd
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_and_b32 s1, s6, 0xffffff
; SI-NEXT:    s_and_b32 s2, s0, 0xffffff
; SI-NEXT:    s_mul_i32 s1, s1, s2
; SI-NEXT:    v_mov_b32_e32 v1, s0
; SI-NEXT:    v_mov_b32_e32 v0, s1
; SI-NEXT:    v_mul_hi_u32_u24_e32 v1, s6, v1
; SI-NEXT:    s_mov_b32 s7, 0xf000
; SI-NEXT:    s_mov_b32 s6, -1
...
; VI-NEXT:    s_and_b32 s5, s3, 0xffff
; VI-NEXT:    s_mul_i32 s4, s4, s5
...
; SI-NEXT:    v_mul_hi_u32_u24_e32 v1, s4, v0
