...
; GFX11-NEXT:    scratch_store_b32 off, v47, s33 offset:1616 ; 4-byte Folded Spill
; GFX11-NEXT:    s_mov_b32 exec_lo, s0
; GFX11-NEXT:    s_mov_b32 s0, 0
...
; GFX11-NEXT:    scratch_store_b32 off, v40, s33 offset:40
; GFX11-NEXT:    scratch_store_b32 off, v41, s33 offset:36
; GFX11-NEXT:    scratch_store_b32 off, v42, s33 offset:32
; GFX11-NEXT:    scratch_store_b32 off, v43, s33 offset:28
; GFX11-NEXT:    scratch_store_b32 off, v44, s33 offset:24
; GFX11-NEXT:    scratch_store_b32 off, v45, s33 offset:20
; GFX11-NEXT:    scratch_store_b32 off, v46, s33 offset:16
...
; GFX11-NEXT:    v_writelane_b32 v47, s30, 0
; GFX11-NEXT:    scratch_store_b128 off, v[0:3], s0
; GFX11-NEXT:    scratch_store_b128 off, v[0:3], s1
...
; GFX11-NEXT:    v_writelane_b32 v47, s31, 1
; GFX11-NEXT:    s_swappc_b64 s[30:31], s[0:1]
...
; GFX11-NEXT:    s_waitcnt vmcnt(4)
; GFX11-NEXT:    v_mov_b32_e32 v46, v13
; GFX11-NEXT:    s_waitcnt vmcnt(3)
; GFX11-NEXT:    v_dual_mov_b32 v14, v1 :: v_dual_mov_b32 v45, v12
; GFX11-NEXT:    s_waitcnt vmcnt(2)
; GFX11-NEXT:    v_dual_mov_b32 v12, v15 :: v_dual_mov_b32 v1, v4
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    scratch_store_b128 off, v[16:19], s33 offset:1600 ; 16-byte Folded Spill
; GFX11-NEXT:    s_clause 0x2
...
; GFX11-NEXT:    v_dual_mov_b32 v6, v9 :: v_dual_mov_b32 v7, v10
; GFX11-NEXT:    s_waitcnt vmcnt(2)
; GFX11-NEXT:    v_mov_b32_e32 v8, v19
; GFX11-NEXT:    s_waitcnt vmcnt(1)
; GFX11-NEXT:    v_mov_b32_e32 v10, v21
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    scratch_store_b128 off, v[24:27], s33 offset:1584 ; 16-byte Folded Spill
; GFX11-NEXT:    scratch_load_b128 v[24:27], off, s33 offset:576
; GFX11-NEXT:    v_mov_b32_e32 v9, v20
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    scratch_store_b128 off, v[24:27], s33 offset:1568 ; 16-byte Folded Spill
; GFX11-NEXT:    scratch_load_b128 v[24:27], off, s33 offset:592
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    scratch_store_b128 off, v[24:27], s33 offset:1552 ; 16-byte Folded Spill
; GFX11-NEXT:    scratch_load_b128 v[24:27], off, s33 offset:608
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    scratch_store_b128 off, v[24:27], s33 offset:1536 ; 16-byte Folded Spill
; GFX11-NEXT:    scratch_store_b128 off, v[32:35], s32
; GFX11-NEXT:    v_dual_mov_b32 v32, v36 :: v_dual_mov_b32 v35, v50
; GFX11-NEXT:    v_dual_mov_b32 v33, v48 :: v_dual_mov_b32 v34, v49
; GFX11-NEXT:    v_dual_mov_b32 v48, v51 :: v_dual_mov_b32 v49, v52
; GFX11-NEXT:    v_dual_mov_b32 v50, v53 :: v_dual_mov_b32 v51, v54
; GFX11-NEXT:    v_mov_b32_e32 v52, v40
; GFX11-NEXT:    v_mov_b32_e32 v54, v42
; GFX11-NEXT:    v_mov_b32_e32 v40, v44
; GFX11-NEXT:    v_mov_b32_e32 v42, v57
; GFX11-NEXT:    v_mov_b32_e32 v44, v59
; GFX11-NEXT:    scratch_store_b32 off, v11, s2
; GFX11-NEXT:    s_add_i32 s2, s32, 0x90
; GFX11-NEXT:    v_dual_mov_b32 v36, v55 :: v_dual_mov_b32 v53, v41
; GFX11-NEXT:    scratch_store_b128 off, v[4:7], s2
; GFX11-NEXT:    s_add_i32 s2, s32, 0x80
; GFX11-NEXT:    v_mov_b32_e32 v55, v43
; GFX11-NEXT:    scratch_store_b128 off, v[0:3], s2
; GFX11-NEXT:    v_mov_b32_e32 v0, 24
; GFX11-NEXT:    s_add_i32 s2, s32, 0x70
; GFX11-NEXT:    v_mov_b32_e32 v41, v56
...
; GFX11-NEXT:    scratch_store_b96 off, v[44:46], s2
...
; GFX11-NEXT:    scratch_load_b128 v[1:4], off, s33 offset:1600
; GFX11-NEXT:    scratch_load_b128 v[13:16], off, s33 offset:1584
...
; GFX11-NEXT:    scratch_load_b32 v46, off, s33 offset:16
; GFX11-NEXT:    scratch_load_b32 v45, off, s33 offset:20
; GFX11-NEXT:    scratch_load_b32 v44, off, s33 offset:24
; GFX11-NEXT:    scratch_load_b32 v43, off, s33 offset:28
; GFX11-NEXT:    scratch_load_b32 v42, off, s33 offset:32
; GFX11-NEXT:    scratch_load_b32 v41, off, s33 offset:36
; GFX11-NEXT:    scratch_load_b32 v40, off, s33 offset:40
; GFX11-NEXT:    v_readlane_b32 s31, v47, 1
; GFX11-NEXT:    v_readlane_b32 s30, v47, 0
; GFX11-NEXT:    s_or_saveexec_b32 s0, -1
; GFX11-NEXT:    scratch_load_b32 v47, off, s33 offset:1616 ; 4-byte Folded Reload
; GFX11-NEXT:    s_mov_b32 exec_lo, s0
