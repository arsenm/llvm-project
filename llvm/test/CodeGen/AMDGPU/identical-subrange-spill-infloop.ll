...
; CHECK-NEXT:    s_mov_b32 s13, s4
; CHECK-NEXT:    s_movk_i32 s6, 0xf0
; CHECK-NEXT:    s_load_dwordx4 s[8:11], s[14:15], 0x0
...
; CHECK-NEXT:    image_sample_lz v3, v[2:3], s[60:67], s[28:31] dmask:0x1
...
; CHECK-NEXT:    image_sample_lz v3, v[1:2], s[60:67], s[28:31] dmask:0x1
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_andn2_saveexec_b64 s[16:17], s[68:69]
; CHECK-NEXT:    s_cbranch_execz .LBB0_10
; CHECK-NEXT:  ; %bb.4: ; %bb32
; CHECK-NEXT:    s_and_saveexec_b64 s[12:13], s[34:35]
; CHECK-NEXT:    s_xor_b64 s[18:19], exec, s[12:13]
...
; CHECK-NEXT:    image_sample_lz v1, v[2:3], s[52:59], s[12:15] dmask:0x1
...
; CHECK-NEXT:    buffer_store_dwordx3 v[1:3], off, s[12:15], 0
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    buffer_store_dwordx4 v[0:3], off, s[12:15], 0
; CHECK-NEXT:    ; implicit-def: $vgpr0
; CHECK-NEXT:  .LBB0_6: ; %Flow12
; CHECK-NEXT:    s_andn2_saveexec_b64 s[12:13], s[18:19]
; CHECK-NEXT:    s_cbranch_execz .LBB0_9
; CHECK-NEXT:  ; %bb.7: ; %bb33.preheader
; CHECK-NEXT:    s_mov_b32 s20, 0
; CHECK-NEXT:    s_mov_b32 s14, s20
; CHECK-NEXT:    s_mov_b32 s15, s20
