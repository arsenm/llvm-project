...
; GCN-IR-NEXT:    s_load_dwordx2 s[8:9], s[2:3], 0xd
...
; GCN-NEXT:    s_mul_i32 s8, s7, s5
; GCN-NEXT:    s_sub_i32 s6, s6, s8
; GCN-NEXT:    s_add_i32 s9, s7, 1
; GCN-NEXT:    s_sub_i32 s8, s6, s5
; GCN-NEXT:    s_cmp_ge_u32 s6, s5
; GCN-NEXT:    s_cselect_b32 s7, s9, s7
; GCN-NEXT:    s_cselect_b32 s6, s8, s6
; GCN-NEXT:    s_add_i32 s8, s7, 1
; GCN-NEXT:    s_cmp_ge_u32 s6, s5
; GCN-NEXT:    s_cselect_b32 s5, s8, s7
...
; GCN-IR-NEXT:    s_sub_i32 s2, 0, s5
; GCN-IR-NEXT:    s_abs_i32 s6, s3
; GCN-IR-NEXT:    s_xor_b32 s4, s3, s4
...
; GCN-IR-NEXT:    s_mul_i32 s8, s7, s5
; GCN-IR-NEXT:    s_sub_i32 s6, s6, s8
; GCN-IR-NEXT:    s_add_i32 s9, s7, 1
; GCN-IR-NEXT:    s_sub_i32 s8, s6, s5
; GCN-IR-NEXT:    s_cmp_ge_u32 s6, s5
; GCN-IR-NEXT:    s_cselect_b32 s7, s9, s7
; GCN-IR-NEXT:    s_cselect_b32 s6, s8, s6
; GCN-IR-NEXT:    s_add_i32 s8, s7, 1
; GCN-IR-NEXT:    s_cmp_ge_u32 s6, s5
; GCN-IR-NEXT:    s_cselect_b32 s5, s8, s7
...
; GCN-NEXT:    s_load_dword s1, s[2:3], 0xe
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_ashr_i64 s[4:5], s[0:1], 33
; GCN-NEXT:    s_abs_i32 s5, s4
; GCN-NEXT:    v_cvt_f32_u32_e32 v0, s5
; GCN-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-NEXT:    v_mul_lo_u32 v1, s2, v0
; GCN-NEXT:    s_mov_b32 s2, -1
; GCN-NEXT:    s_ashr_i64 s[6:7], s[2:3], 33
...
; GCN-NEXT:    s_mul_i32 s8, s6, s5
; GCN-NEXT:    s_sub_i32 s7, s7, s8
; GCN-NEXT:    s_add_i32 s9, s6, 1
; GCN-NEXT:    s_sub_i32 s8, s7, s5
; GCN-NEXT:    s_cmp_ge_u32 s7, s5
; GCN-NEXT:    s_cselect_b32 s6, s9, s6
; GCN-NEXT:    s_cselect_b32 s7, s8, s7
; GCN-NEXT:    s_add_i32 s8, s6, 1
; GCN-NEXT:    s_cmp_ge_u32 s7, s5
; GCN-NEXT:    s_cselect_b32 s5, s8, s6
; GCN-NEXT:    s_xor_b32 s5, s5, s4
; GCN-NEXT:    s_sub_i32 s4, s5, s4
; GCN-NEXT:    s_ashr_i32 s5, s4, 31
; GCN-NEXT:    v_mov_b32_e32 v1, s5
...
; GCN-IR-NEXT:    s_load_dword s1, s[2:3], 0xe
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_ashr_i64 s[4:5], s[0:1], 33
; GCN-IR-NEXT:    s_abs_i32 s5, s4
; GCN-IR-NEXT:    v_cvt_f32_u32_e32 v0, s5
; GCN-IR-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-IR-NEXT:    v_mul_lo_u32 v1, s2, v0
; GCN-IR-NEXT:    s_mov_b32 s2, -1
; GCN-IR-NEXT:    s_ashr_i64 s[6:7], s[2:3], 33
; GCN-IR-NEXT:    s_abs_i32 s7, s6
; GCN-IR-NEXT:    v_mul_hi_u32 v1, v0, v1
; GCN-IR-NEXT:    s_xor_b32 s4, s6, s4
; GCN-IR-NEXT:    s_ashr_i32 s4, s4, 31
; GCN-IR-NEXT:    s_mov_b32 s3, 0xf000
; GCN-IR-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; GCN-IR-NEXT:    v_mul_hi_u32 v0, s7, v0
; GCN-IR-NEXT:    v_readfirstlane_b32 s6, v0
; GCN-IR-NEXT:    s_mul_i32 s8, s6, s5
; GCN-IR-NEXT:    s_sub_i32 s7, s7, s8
; GCN-IR-NEXT:    s_add_i32 s9, s6, 1
; GCN-IR-NEXT:    s_sub_i32 s8, s7, s5
; GCN-IR-NEXT:    s_cmp_ge_u32 s7, s5
; GCN-IR-NEXT:    s_cselect_b32 s6, s9, s6
; GCN-IR-NEXT:    s_cselect_b32 s7, s8, s7
; GCN-IR-NEXT:    s_add_i32 s8, s6, 1
; GCN-IR-NEXT:    s_cmp_ge_u32 s7, s5
; GCN-IR-NEXT:    s_cselect_b32 s5, s8, s6
; GCN-IR-NEXT:    s_xor_b32 s5, s5, s4
; GCN-IR-NEXT:    s_sub_i32 s4, s5, s4
; GCN-IR-NEXT:    s_ashr_i32 s5, s4, 31
; GCN-IR-NEXT:    v_mov_b32_e32 v1, s5
...
; GCN-NEXT:    s_load_dword s1, s[2:3], 0xe
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_ashr_i64 s[4:5], s[0:1], 39
; GCN-NEXT:    s_abs_i32 s5, s4
; GCN-NEXT:    v_cvt_f32_u32_e32 v0, s5
; GCN-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-NEXT:    v_mul_lo_u32 v1, s2, v0
; GCN-NEXT:    s_mov_b32 s2, -1
; GCN-NEXT:    s_ashr_i64 s[6:7], s[2:3], 39
; GCN-NEXT:    s_abs_i32 s7, s6
; GCN-NEXT:    v_mul_hi_u32 v1, v0, v1
; GCN-NEXT:    s_xor_b32 s4, s6, s4
; GCN-NEXT:    s_ashr_i32 s4, s4, 31
...
; GCN-IR-NEXT:    s_load_dword s1, s[2:3], 0xe
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_ashr_i64 s[4:5], s[0:1], 39
; GCN-IR-NEXT:    s_abs_i32 s5, s4
; GCN-IR-NEXT:    v_cvt_f32_u32_e32 v0, s5
; GCN-IR-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-IR-NEXT:    v_mul_lo_u32 v1, s2, v0
; GCN-IR-NEXT:    s_mov_b32 s2, -1
; GCN-IR-NEXT:    s_ashr_i64 s[6:7], s[2:3], 39
; GCN-IR-NEXT:    s_abs_i32 s7, s6
; GCN-IR-NEXT:    v_mul_hi_u32 v1, v0, v1
; GCN-IR-NEXT:    s_xor_b32 s4, s6, s4
; GCN-IR-NEXT:    s_ashr_i32 s4, s4, 31
...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_load_dwordx8 s[8:15], s[2:3], 0xd
; GCN-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x9
; GCN-NEXT:    s_mov_b32 s7, 0xf000
; GCN-NEXT:    s_mov_b32 s6, -1
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_ashr_i64 s[2:3], s[12:13], 40
...
; GCN-IR:       ; %bb.0:
; GCN-IR-NEXT:    s_load_dwordx8 s[8:15], s[2:3], 0xd
; GCN-IR-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x9
; GCN-IR-NEXT:    s_mov_b32 s7, 0xf000
; GCN-IR-NEXT:    s_mov_b32 s6, -1
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_ashr_i64 s[2:3], s[12:13], 40
...
; GCN-IR-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GCN-IR-NEXT:    s_xor_b32 s1, s8, s2
...
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v3, s0
; GCN-IR-NEXT:    s_xor_b32 s0, s0, s10
; GCN-IR-NEXT:    s_ashr_i32 s0, s0, 30
...
; GCN-NEXT:    v_alignbit_b32 v1, s1, v1, 24
...
; GCN-IR-NEXT:    s_xor_b64 s[0:1], s[4:5], s[0:1]
; GCN-IR-NEXT:    s_xor_b64 s[2:3], s[10:11], s[0:1]
; GCN-IR-NEXT:    s_sub_u32 s0, s2, s0
; GCN-IR-NEXT:    s_subb_u32 s1, s3, s1
...
; GCN-NEXT:    s_sub_u32 s5, 0, s2
; GCN-NEXT:    s_subb_u32 s6, 0, s3
...
; GCN-NEXT:    v_cvt_i32_f32_e32 v1, v1
; GCN-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v0|, s6
; GCN-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; GCN-IR-NEXT:    v_cvt_i32_f32_e32 v1, v1
; GCN-IR-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v0|, s6
; GCN-IR-NEXT:    s_and_b64 s[4:5], s[4:5], exec
