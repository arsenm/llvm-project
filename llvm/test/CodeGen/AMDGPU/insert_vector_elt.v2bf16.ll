...
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx4 s[0:3], s[6:7], 0x0
; SI-NEXT:    s_load_dwordx2 s[4:5], s[6:7], 0x4
...
; VI-NEXT:    v_lshlrev_b32_e64 v2, v2, s1
; VI-NEXT:    s_waitcnt vmcnt(0)
...
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_load_dwordx2 s[4:5], s[6:7], 0x10
; GFX900-NEXT:    s_load_dwordx4 s[0:3], s[6:7], 0x0
; GFX900-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX900-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX940:       ; %bb.0:
; GFX940-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x10
; GFX940-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x0
; GFX940-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX940-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX940-NEXT:    s_waitcnt lgkmcnt(0)
; GFX940-NEXT:    global_load_dword v1, v0, s[0:1]
...
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_load_dwordx4 s[0:3], s[6:7], 0x0
; GFX900-NEXT:    s_load_dword s4, s[6:7], 0x30
...
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_load_dwordx4 s[0:3], s[6:7], 0x0
; GFX900-NEXT:    s_load_dword s4, s[6:7], 0x10
; GFX900-NEXT:    v_lshlrev_b32_e32 v2, 3, v0
...
; GFX940-NEXT:    global_load_dwordx2 v[0:1], v2, s[6:7]
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    v_perm_b32 v0, s0, v0, v3
; GFX940-NEXT:    global_store_dwordx2 v2, v[0:1], s[4:5] sc0 sc1
; GFX940-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
...
; GFX940-NEXT:    global_load_dwordx2 v[0:1], v2, s[6:7]
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    v_perm_b32 v1, s0, v1, v3
; GFX940-NEXT:    global_store_dwordx2 v2, v[0:1], s[4:5] sc0 sc1
; GFX940-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
...
; SI-NEXT:    s_lshl_b64 s[4:5], 0xffff, s5
; SI-NEXT:    v_mov_b32_e32 v4, s6
; SI-NEXT:    v_mov_b32_e32 v5, s6
; SI-NEXT:    s_mov_b64 s[2:3], s[10:11]
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_bfi_b32 v3, s5, v5, v3
...
; GFX900-NEXT:    s_waitcnt vmcnt(0)
; GFX900-NEXT:    v_bfi_b32 v1, s3, v4, v1
; GFX900-NEXT:    v_bfi_b32 v0, s2, v3, v0
; GFX900-NEXT:    global_store_dwordx2 v2, v[0:1], s[0:1]
; GFX900-NEXT:    s_endpgm
;
...
; GFX940-NEXT:    s_waitcnt lgkmcnt(0)
; GFX940-NEXT:    global_load_dwordx2 v[0:1], v2, s[6:7]
; GFX940-NEXT:    s_lshl_b32 s1, s1, 4
; GFX940-NEXT:    s_pack_ll_b32_b16 s2, s0, s0
; GFX940-NEXT:    s_lshl_b64 s[0:1], 0xffff, s1
; GFX940-NEXT:    v_mov_b32_e32 v3, s2
; GFX940-NEXT:    v_mov_b32_e32 v4, s2
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    v_bfi_b32 v1, s1, v4, v1
...
; SI-NEXT:    s_load_dwordx2 s[16:17], s[6:7], 0x4
; SI-NEXT:    s_mov_b32 s3, 0x100f000
...
; SI-NEXT:    s_cmp_eq_u32 s17, 6
; SI-NEXT:    s_cselect_b64 vcc, -1, 0
; SI-NEXT:    s_cmp_eq_u32 s17, 7
; SI-NEXT:    s_cselect_b64 s[0:1], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s17, 4
; SI-NEXT:    s_mov_b64 s[14:15], s[2:3]
; SI-NEXT:    s_cselect_b64 s[2:3], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s17, 5
; SI-NEXT:    s_cselect_b64 s[4:5], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s17, 2
; SI-NEXT:    s_cselect_b64 s[6:7], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s17, 3
; SI-NEXT:    s_cselect_b64 s[8:9], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s17, 0
; SI-NEXT:    s_cselect_b64 s[10:11], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s17, 1
...
; SI-NEXT:    s_cselect_b64 vcc, -1, 0
; SI-NEXT:    v_cndmask_b32_e64 v6, v6, v10, s[0:1]
; SI-NEXT:    v_cndmask_b32_e64 v2, v2, v10, s[2:3]
; SI-NEXT:    v_cndmask_b32_e64 v7, v7, v10, s[4:5]
; SI-NEXT:    v_cndmask_b32_e64 v1, v1, v10, s[6:7]
; SI-NEXT:    v_cndmask_b32_e64 v8, v8, v10, s[8:9]
; SI-NEXT:    v_cndmask_b32_e64 v0, v0, v10, s[10:11]
...
; SI-NEXT:    buffer_store_dwordx4 v[0:3], v[4:5], s[12:15], 0 addr64
; SI-NEXT:    s_endpgm
;
; VI-LABEL: v_insertelement_v8bf16_dynamic:
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx4 s[0:3], s[6:7], 0x0
; VI-NEXT:    s_load_dwordx2 s[12:13], s[6:7], 0x10
; VI-NEXT:    v_lshlrev_b32_e32 v4, 4, v0
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v1, s3
; VI-NEXT:    v_add_u32_e32 v0, vcc, s2, v4
...
; VI-NEXT:    v_mov_b32_e32 v5, s1
; VI-NEXT:    v_add_u32_e32 v4, vcc, s0, v4
; VI-NEXT:    s_cmp_eq_u32 s13, 6
; VI-NEXT:    v_addc_u32_e32 v5, vcc, 0, v5, vcc
; VI-NEXT:    s_cselect_b64 vcc, -1, 0
; VI-NEXT:    s_cmp_eq_u32 s13, 7
; VI-NEXT:    s_cselect_b64 s[0:1], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s13, 4
; VI-NEXT:    s_cselect_b64 s[2:3], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s13, 5
; VI-NEXT:    s_cselect_b64 s[4:5], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s13, 2
; VI-NEXT:    s_cselect_b64 s[6:7], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s13, 3
; VI-NEXT:    s_cselect_b64 s[8:9], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s13, 0
; VI-NEXT:    s_cselect_b64 s[10:11], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s13, 1
...
; VI-NEXT:    v_cndmask_b32_e32 v3, v3, v10, vcc
; VI-NEXT:    s_cselect_b64 vcc, -1, 0
; VI-NEXT:    v_cndmask_b32_e64 v6, v6, v10, s[0:1]
; VI-NEXT:    v_cndmask_b32_e64 v7, v7, v10, s[4:5]
; VI-NEXT:    v_cndmask_b32_e64 v8, v8, v10, s[8:9]
; VI-NEXT:    v_cndmask_b32_e32 v9, v9, v10, vcc
; VI-NEXT:    v_cndmask_b32_e64 v2, v2, v10, s[2:3]
; VI-NEXT:    v_cndmask_b32_e64 v1, v1, v10, s[6:7]
; VI-NEXT:    v_cndmask_b32_e64 v0, v0, v10, s[10:11]
...
; VI-NEXT:    v_or_b32_sdwa v3, v3, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_load_dwordx4 s[12:15], s[6:7], 0x0
; GFX900-NEXT:    s_load_dwordx2 s[16:17], s[6:7], 0x10
; GFX900-NEXT:    v_lshlrev_b32_e32 v4, 4, v0
; GFX900-NEXT:    s_waitcnt lgkmcnt(0)
; GFX900-NEXT:    global_load_dwordx4 v[0:3], v4, s[14:15]
; GFX900-NEXT:    s_cmp_eq_u32 s17, 6
; GFX900-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s17, 7
; GFX900-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s17, 4
; GFX900-NEXT:    s_cselect_b64 s[2:3], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s17, 5
; GFX900-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s17, 2
; GFX900-NEXT:    s_cselect_b64 s[6:7], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s17, 3
; GFX900-NEXT:    s_cselect_b64 s[8:9], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s17, 0
; GFX900-NEXT:    s_cselect_b64 s[10:11], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s17, 1
; GFX900-NEXT:    v_mov_b32_e32 v9, s16
...
; GFX900-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX900-NEXT:    v_cndmask_b32_e64 v5, v5, v9, s[0:1]
; GFX900-NEXT:    v_cndmask_b32_e64 v2, v2, v9, s[2:3]
; GFX900-NEXT:    v_cndmask_b32_e64 v6, v6, v9, s[4:5]
; GFX900-NEXT:    v_cndmask_b32_e64 v1, v1, v9, s[6:7]
; GFX900-NEXT:    v_cndmask_b32_e64 v7, v7, v9, s[8:9]
; GFX900-NEXT:    v_cndmask_b32_e64 v0, v0, v9, s[10:11]
; GFX900-NEXT:    v_cndmask_b32_e32 v8, v8, v9, vcc
; GFX900-NEXT:    v_perm_b32 v3, v5, v3, s14
; GFX900-NEXT:    v_perm_b32 v2, v6, v2, s14
; GFX900-NEXT:    v_perm_b32 v1, v7, v1, s14
; GFX900-NEXT:    v_perm_b32 v0, v8, v0, s14
; GFX900-NEXT:    global_store_dwordx4 v4, v[0:3], s[12:13]
; GFX900-NEXT:    s_endpgm
;
; GFX940-LABEL: v_insertelement_v8bf16_dynamic:
; GFX940:       ; %bb.0:
; GFX940-NEXT:    s_load_dwordx4 s[12:15], s[2:3], 0x0
; GFX940-NEXT:    s_load_dwordx2 s[16:17], s[2:3], 0x10
; GFX940-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX940-NEXT:    v_lshlrev_b32_e32 v4, 4, v0
; GFX940-NEXT:    s_waitcnt lgkmcnt(0)
; GFX940-NEXT:    global_load_dwordx4 v[0:3], v4, s[14:15]
; GFX940-NEXT:    s_cmp_eq_u32 s17, 6
; GFX940-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s17, 7
; GFX940-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s17, 4
; GFX940-NEXT:    s_cselect_b64 s[2:3], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s17, 5
; GFX940-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s17, 2
; GFX940-NEXT:    s_cselect_b64 s[6:7], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s17, 3
; GFX940-NEXT:    s_cselect_b64 s[8:9], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s17, 0
; GFX940-NEXT:    s_cselect_b64 s[10:11], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s17, 1
; GFX940-NEXT:    v_mov_b32_e32 v9, s16
; GFX940-NEXT:    s_mov_b32 s14, 0x5040100
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    v_lshrrev_b32_e32 v5, 16, v3
; GFX940-NEXT:    v_lshrrev_b32_e32 v6, 16, v2
; GFX940-NEXT:    v_lshrrev_b32_e32 v7, 16, v1
; GFX940-NEXT:    v_lshrrev_b32_e32 v8, 16, v0
; GFX940-NEXT:    v_cndmask_b32_e32 v3, v3, v9, vcc
; GFX940-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX940-NEXT:    v_cndmask_b32_e64 v5, v5, v9, s[0:1]
; GFX940-NEXT:    v_cndmask_b32_e64 v2, v2, v9, s[2:3]
; GFX940-NEXT:    v_cndmask_b32_e64 v6, v6, v9, s[4:5]
; GFX940-NEXT:    v_cndmask_b32_e64 v1, v1, v9, s[6:7]
; GFX940-NEXT:    v_cndmask_b32_e64 v7, v7, v9, s[8:9]
; GFX940-NEXT:    v_cndmask_b32_e64 v0, v0, v9, s[10:11]
; GFX940-NEXT:    v_cndmask_b32_e32 v8, v8, v9, vcc
; GFX940-NEXT:    v_perm_b32 v3, v5, v3, s14
; GFX940-NEXT:    v_perm_b32 v2, v6, v2, s14
; GFX940-NEXT:    v_perm_b32 v1, v7, v1, s14
; GFX940-NEXT:    v_perm_b32 v0, v8, v0, s14
; GFX940-NEXT:    global_store_dwordx4 v4, v[0:3], s[12:13] sc0 sc1
; GFX940-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
  %in.gep = getelementptr inbounds <8 x bfloat>, ptr addrspace(1) %in, i64 %tid.ext
...
; GFX940-NEXT:    s_waitcnt vmcnt(1)
; GFX940-NEXT:    v_perm_b32 v1, s0, v1, v9
; GFX940-NEXT:    s_waitcnt vmcnt(0)
...
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx4 s[28:31], s[6:7], 0x0
; SI-NEXT:    s_load_dwordx2 s[34:35], s[6:7], 0x4
; SI-NEXT:    s_mov_b32 s3, 0x100f000
; SI-NEXT:    s_mov_b32 s2, 0
; SI-NEXT:    v_lshlrev_b32_e32 v0, 5, v0
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b64 s[0:1], s[30:31]
; SI-NEXT:    v_mov_b32_e32 v1, 0
; SI-NEXT:    buffer_load_dwordx4 v[2:5], v[0:1], s[0:3], 0 addr64
; SI-NEXT:    buffer_load_dwordx4 v[6:9], v[0:1], s[0:3], 0 addr64 offset:16
; SI-NEXT:    s_cmp_eq_u32 s35, 6
; SI-NEXT:    s_cselect_b64 vcc, -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 7
; SI-NEXT:    s_cselect_b64 s[0:1], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 4
; SI-NEXT:    s_mov_b64 s[30:31], s[2:3]
; SI-NEXT:    s_cselect_b64 s[2:3], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 5
; SI-NEXT:    s_cselect_b64 s[4:5], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 2
; SI-NEXT:    s_cselect_b64 s[6:7], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 3
; SI-NEXT:    s_cselect_b64 s[8:9], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 0
; SI-NEXT:    s_cselect_b64 s[10:11], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 1
; SI-NEXT:    s_cselect_b64 s[12:13], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 14
; SI-NEXT:    s_cselect_b64 s[14:15], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 15
; SI-NEXT:    s_cselect_b64 s[16:17], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 12
; SI-NEXT:    s_cselect_b64 s[18:19], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 13
; SI-NEXT:    s_cselect_b64 s[20:21], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 10
; SI-NEXT:    s_cselect_b64 s[22:23], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 11
; SI-NEXT:    s_cselect_b64 s[24:25], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 8
; SI-NEXT:    s_cselect_b64 s[26:27], -1, 0
; SI-NEXT:    s_cmp_eq_u32 s35, 9
...
; SI-NEXT:    v_cndmask_b32_e32 v5, v5, v18, vcc
; SI-NEXT:    s_cselect_b64 vcc, -1, 0
; SI-NEXT:    v_lshrrev_b32_e32 v11, 16, v4
; SI-NEXT:    v_lshrrev_b32_e32 v12, 16, v3
; SI-NEXT:    v_lshrrev_b32_e32 v13, 16, v2
; SI-NEXT:    v_cndmask_b32_e64 v9, v9, v18, s[14:15]
; SI-NEXT:    v_cndmask_b32_e64 v14, v14, v18, s[16:17]
; SI-NEXT:    v_cndmask_b32_e64 v8, v8, v18, s[18:19]
; SI-NEXT:    v_cndmask_b32_e64 v15, v15, v18, s[20:21]
; SI-NEXT:    v_cndmask_b32_e64 v7, v7, v18, s[22:23]
; SI-NEXT:    v_cndmask_b32_e64 v16, v16, v18, s[24:25]
; SI-NEXT:    v_cndmask_b32_e64 v6, v6, v18, s[26:27]
; SI-NEXT:    v_cndmask_b32_e32 v17, v17, v18, vcc
; SI-NEXT:    v_cndmask_b32_e64 v10, v10, v18, s[0:1]
; SI-NEXT:    v_cndmask_b32_e64 v4, v4, v18, s[2:3]
; SI-NEXT:    v_cndmask_b32_e64 v11, v11, v18, s[4:5]
; SI-NEXT:    v_cndmask_b32_e64 v3, v3, v18, s[6:7]
; SI-NEXT:    v_cndmask_b32_e64 v12, v12, v18, s[8:9]
; SI-NEXT:    v_cndmask_b32_e64 v2, v2, v18, s[10:11]
; SI-NEXT:    v_cndmask_b32_e64 v13, v13, v18, s[12:13]
...
; SI-NEXT:    buffer_store_dwordx4 v[6:9], v[0:1], s[28:31], 0 addr64 offset:16
; SI-NEXT:    buffer_store_dwordx4 v[2:5], v[0:1], s[28:31], 0 addr64
; SI-NEXT:    s_endpgm
;
; VI-LABEL: v_insertelement_v16bf16_dynamic:
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx4 s[0:3], s[6:7], 0x0
; VI-NEXT:    s_load_dwordx2 s[28:29], s[6:7], 0x10
; VI-NEXT:    v_lshlrev_b32_e32 v8, 5, v0
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    v_addc_u32_e32 v9, vcc, 0, v9, vcc
; VI-NEXT:    v_add_u32_e32 v10, vcc, 16, v8
; VI-NEXT:    s_cmp_eq_u32 s29, 14
; VI-NEXT:    v_addc_u32_e32 v11, vcc, 0, v9, vcc
; VI-NEXT:    s_cselect_b64 vcc, -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 15
; VI-NEXT:    s_cselect_b64 s[0:1], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 12
; VI-NEXT:    s_cselect_b64 s[2:3], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 13
; VI-NEXT:    s_cselect_b64 s[4:5], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 10
; VI-NEXT:    s_cselect_b64 s[6:7], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 11
; VI-NEXT:    s_cselect_b64 s[8:9], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 8
; VI-NEXT:    s_cselect_b64 s[10:11], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 9
; VI-NEXT:    s_cselect_b64 s[12:13], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 6
; VI-NEXT:    s_cselect_b64 s[14:15], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 7
; VI-NEXT:    s_cselect_b64 s[16:17], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 4
; VI-NEXT:    s_cselect_b64 s[18:19], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 5
; VI-NEXT:    s_cselect_b64 s[20:21], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 2
; VI-NEXT:    s_cselect_b64 s[22:23], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 3
; VI-NEXT:    s_cselect_b64 s[24:25], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 0
; VI-NEXT:    s_cselect_b64 s[26:27], -1, 0
; VI-NEXT:    s_cmp_eq_u32 s29, 1
...
; VI-NEXT:    v_lshrrev_b32_e32 v19, 16, v4
; VI-NEXT:    v_cndmask_b32_e32 v3, v3, v20, vcc
; VI-NEXT:    s_cselect_b64 vcc, -1, 0
; VI-NEXT:    v_lshrrev_b32_e32 v13, 16, v2
; VI-NEXT:    v_lshrrev_b32_e32 v14, 16, v1
; VI-NEXT:    v_lshrrev_b32_e32 v15, 16, v0
; VI-NEXT:    v_cndmask_b32_e64 v16, v16, v20, s[16:17]
; VI-NEXT:    v_cndmask_b32_e64 v17, v17, v20, s[20:21]
; VI-NEXT:    v_cndmask_b32_e64 v18, v18, v20, s[24:25]
; VI-NEXT:    v_cndmask_b32_e32 v19, v19, v20, vcc
; VI-NEXT:    v_cndmask_b32_e64 v12, v12, v20, s[0:1]
; VI-NEXT:    v_cndmask_b32_e64 v13, v13, v20, s[4:5]
; VI-NEXT:    v_cndmask_b32_e64 v14, v14, v20, s[8:9]
; VI-NEXT:    v_cndmask_b32_e64 v15, v15, v20, s[12:13]
; VI-NEXT:    v_cndmask_b32_e64 v7, v7, v20, s[14:15]
; VI-NEXT:    v_cndmask_b32_e64 v6, v6, v20, s[18:19]
; VI-NEXT:    v_cndmask_b32_e64 v5, v5, v20, s[22:23]
; VI-NEXT:    v_cndmask_b32_e64 v4, v4, v20, s[26:27]
...
; VI-NEXT:    v_cndmask_b32_e64 v2, v2, v20, s[2:3]
; VI-NEXT:    v_cndmask_b32_e64 v1, v1, v20, s[6:7]
; VI-NEXT:    v_cndmask_b32_e64 v0, v0, v20, s[10:11]
...
; VI-NEXT:    v_or_b32_sdwa v6, v6, v17 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; VI-NEXT:    v_or_b32_sdwa v5, v5, v18 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; VI-NEXT:    v_or_b32_sdwa v4, v4, v19 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; VI-NEXT:    v_or_b32_sdwa v3, v3, v12 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_load_dwordx4 s[28:31], s[6:7], 0x0
; GFX900-NEXT:    s_load_dwordx2 s[34:35], s[6:7], 0x10
; GFX900-NEXT:    v_lshlrev_b32_e32 v0, 5, v0
; GFX900-NEXT:    s_waitcnt lgkmcnt(0)
; GFX900-NEXT:    global_load_dwordx4 v[1:4], v0, s[30:31]
; GFX900-NEXT:    global_load_dwordx4 v[5:8], v0, s[30:31] offset:16
; GFX900-NEXT:    s_cmp_eq_u32 s35, 6
; GFX900-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 7
; GFX900-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 4
; GFX900-NEXT:    s_cselect_b64 s[2:3], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 5
; GFX900-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 2
; GFX900-NEXT:    s_cselect_b64 s[6:7], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 3
; GFX900-NEXT:    s_cselect_b64 s[8:9], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 0
; GFX900-NEXT:    s_cselect_b64 s[10:11], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 1
; GFX900-NEXT:    s_cselect_b64 s[12:13], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 14
; GFX900-NEXT:    s_cselect_b64 s[14:15], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 15
; GFX900-NEXT:    s_cselect_b64 s[16:17], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 12
; GFX900-NEXT:    s_cselect_b64 s[18:19], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 13
; GFX900-NEXT:    s_cselect_b64 s[20:21], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 10
; GFX900-NEXT:    s_cselect_b64 s[22:23], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 11
; GFX900-NEXT:    s_cselect_b64 s[24:25], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 8
; GFX900-NEXT:    s_cselect_b64 s[26:27], -1, 0
; GFX900-NEXT:    s_cmp_eq_u32 s35, 9
; GFX900-NEXT:    v_mov_b32_e32 v17, s34
; GFX900-NEXT:    s_mov_b32 s30, 0x5040100
; GFX900-NEXT:    s_waitcnt vmcnt(1)
; GFX900-NEXT:    v_lshrrev_b32_e32 v9, 16, v4
; GFX900-NEXT:    s_waitcnt vmcnt(0)
; GFX900-NEXT:    v_lshrrev_b32_e32 v13, 16, v8
; GFX900-NEXT:    v_lshrrev_b32_e32 v14, 16, v7
; GFX900-NEXT:    v_lshrrev_b32_e32 v15, 16, v6
; GFX900-NEXT:    v_lshrrev_b32_e32 v16, 16, v5
; GFX900-NEXT:    v_cndmask_b32_e32 v4, v4, v17, vcc
; GFX900-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX900-NEXT:    v_lshrrev_b32_e32 v10, 16, v3
; GFX900-NEXT:    v_lshrrev_b32_e32 v11, 16, v2
; GFX900-NEXT:    v_lshrrev_b32_e32 v12, 16, v1
; GFX900-NEXT:    v_cndmask_b32_e64 v8, v8, v17, s[14:15]
; GFX900-NEXT:    v_cndmask_b32_e64 v13, v13, v17, s[16:17]
; GFX900-NEXT:    v_cndmask_b32_e64 v7, v7, v17, s[18:19]
; GFX900-NEXT:    v_cndmask_b32_e64 v14, v14, v17, s[20:21]
; GFX900-NEXT:    v_cndmask_b32_e64 v6, v6, v17, s[22:23]
; GFX900-NEXT:    v_cndmask_b32_e64 v15, v15, v17, s[24:25]
; GFX900-NEXT:    v_cndmask_b32_e64 v5, v5, v17, s[26:27]
; GFX900-NEXT:    v_cndmask_b32_e32 v16, v16, v17, vcc
; GFX900-NEXT:    v_cndmask_b32_e64 v9, v9, v17, s[0:1]
; GFX900-NEXT:    v_cndmask_b32_e64 v3, v3, v17, s[2:3]
; GFX900-NEXT:    v_cndmask_b32_e64 v10, v10, v17, s[4:5]
; GFX900-NEXT:    v_cndmask_b32_e64 v2, v2, v17, s[6:7]
; GFX900-NEXT:    v_cndmask_b32_e64 v11, v11, v17, s[8:9]
; GFX900-NEXT:    v_cndmask_b32_e64 v1, v1, v17, s[10:11]
; GFX900-NEXT:    v_cndmask_b32_e64 v12, v12, v17, s[12:13]
; GFX900-NEXT:    v_perm_b32 v8, v13, v8, s30
; GFX900-NEXT:    v_perm_b32 v7, v14, v7, s30
; GFX900-NEXT:    v_perm_b32 v6, v15, v6, s30
; GFX900-NEXT:    v_perm_b32 v5, v16, v5, s30
; GFX900-NEXT:    v_perm_b32 v4, v9, v4, s30
; GFX900-NEXT:    v_perm_b32 v3, v10, v3, s30
; GFX900-NEXT:    v_perm_b32 v2, v11, v2, s30
; GFX900-NEXT:    v_perm_b32 v1, v12, v1, s30
; GFX900-NEXT:    global_store_dwordx4 v0, v[5:8], s[28:29] offset:16
; GFX900-NEXT:    global_store_dwordx4 v0, v[1:4], s[28:29]
; GFX900-NEXT:    s_endpgm
;
; GFX940-LABEL: v_insertelement_v16bf16_dynamic:
; GFX940:       ; %bb.0:
; GFX940-NEXT:    s_load_dwordx4 s[28:31], s[2:3], 0x0
; GFX940-NEXT:    s_load_dwordx2 s[34:35], s[2:3], 0x10
; GFX940-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX940-NEXT:    v_lshlrev_b32_e32 v8, 5, v0
; GFX940-NEXT:    s_waitcnt lgkmcnt(0)
; GFX940-NEXT:    global_load_dwordx4 v[0:3], v8, s[30:31]
; GFX940-NEXT:    global_load_dwordx4 v[4:7], v8, s[30:31] offset:16
; GFX940-NEXT:    s_cmp_eq_u32 s35, 6
; GFX940-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 7
; GFX940-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 4
; GFX940-NEXT:    s_cselect_b64 s[2:3], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 5
; GFX940-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 2
; GFX940-NEXT:    s_cselect_b64 s[6:7], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 3
; GFX940-NEXT:    s_cselect_b64 s[8:9], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 0
; GFX940-NEXT:    s_cselect_b64 s[10:11], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 1
; GFX940-NEXT:    s_cselect_b64 s[12:13], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 14
; GFX940-NEXT:    s_cselect_b64 s[14:15], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 15
; GFX940-NEXT:    s_cselect_b64 s[16:17], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 12
; GFX940-NEXT:    s_cselect_b64 s[18:19], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 13
; GFX940-NEXT:    s_cselect_b64 s[20:21], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 10
; GFX940-NEXT:    s_cselect_b64 s[22:23], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 11
; GFX940-NEXT:    s_cselect_b64 s[24:25], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 8
; GFX940-NEXT:    s_cselect_b64 s[26:27], -1, 0
; GFX940-NEXT:    s_cmp_eq_u32 s35, 9
; GFX940-NEXT:    v_mov_b32_e32 v17, s34
; GFX940-NEXT:    s_mov_b32 s30, 0x5040100
; GFX940-NEXT:    s_waitcnt vmcnt(1)
; GFX940-NEXT:    v_lshrrev_b32_e32 v9, 16, v3
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    v_lshrrev_b32_e32 v13, 16, v7
; GFX940-NEXT:    v_lshrrev_b32_e32 v14, 16, v6
; GFX940-NEXT:    v_lshrrev_b32_e32 v15, 16, v5
; GFX940-NEXT:    v_lshrrev_b32_e32 v16, 16, v4
; GFX940-NEXT:    v_cndmask_b32_e32 v3, v3, v17, vcc
; GFX940-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX940-NEXT:    v_lshrrev_b32_e32 v10, 16, v2
; GFX940-NEXT:    v_lshrrev_b32_e32 v11, 16, v1
; GFX940-NEXT:    v_lshrrev_b32_e32 v12, 16, v0
; GFX940-NEXT:    v_cndmask_b32_e64 v7, v7, v17, s[14:15]
; GFX940-NEXT:    v_cndmask_b32_e64 v13, v13, v17, s[16:17]
; GFX940-NEXT:    v_cndmask_b32_e64 v6, v6, v17, s[18:19]
; GFX940-NEXT:    v_cndmask_b32_e64 v14, v14, v17, s[20:21]
; GFX940-NEXT:    v_cndmask_b32_e64 v5, v5, v17, s[22:23]
; GFX940-NEXT:    v_cndmask_b32_e64 v15, v15, v17, s[24:25]
; GFX940-NEXT:    v_cndmask_b32_e64 v4, v4, v17, s[26:27]
; GFX940-NEXT:    v_cndmask_b32_e32 v16, v16, v17, vcc
; GFX940-NEXT:    v_cndmask_b32_e64 v9, v9, v17, s[0:1]
; GFX940-NEXT:    v_cndmask_b32_e64 v2, v2, v17, s[2:3]
; GFX940-NEXT:    v_cndmask_b32_e64 v10, v10, v17, s[4:5]
; GFX940-NEXT:    v_cndmask_b32_e64 v1, v1, v17, s[6:7]
; GFX940-NEXT:    v_cndmask_b32_e64 v11, v11, v17, s[8:9]
; GFX940-NEXT:    v_cndmask_b32_e64 v0, v0, v17, s[10:11]
; GFX940-NEXT:    v_cndmask_b32_e64 v12, v12, v17, s[12:13]
; GFX940-NEXT:    v_perm_b32 v7, v13, v7, s30
; GFX940-NEXT:    v_perm_b32 v6, v14, v6, s30
; GFX940-NEXT:    v_perm_b32 v5, v15, v5, s30
; GFX940-NEXT:    v_perm_b32 v4, v16, v4, s30
; GFX940-NEXT:    v_perm_b32 v3, v9, v3, s30
; GFX940-NEXT:    v_perm_b32 v2, v10, v2, s30
; GFX940-NEXT:    v_perm_b32 v1, v11, v1, s30
; GFX940-NEXT:    v_perm_b32 v0, v12, v0, s30
; GFX940-NEXT:    global_store_dwordx4 v8, v[4:7], s[28:29] offset:16 sc0 sc1
; GFX940-NEXT:    global_store_dwordx4 v8, v[0:3], s[28:29] sc0 sc1
; GFX940-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
  %in.gep = getelementptr inbounds <16 x bfloat>, ptr addrspace(1) %in, i64 %tid.ext
