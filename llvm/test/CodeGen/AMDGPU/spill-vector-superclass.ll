...
define amdgpu_kernel void @test_spill_av_class(<4 x i32> %arg) #0 {
  ...
  ; GCN-NEXT:   INLINEASM &"; def $0", 33 /* sideeffect isconvergent attdialect */, 1769482 /* regdef:VGPR_32 */, def undef %22.sub0
  ...
  ; GCN-NEXT:   INLINEASM &"; use $0", 33 /* sideeffect isconvergent attdialect */, 3080201 /* reguse:VReg_64 */, %23
  ; GCN-NEXT:   S_ENDPGM 0
