...
; CI-NEXT:    s_ashr_i64 s[4:5], s[2:3], 48
; CI-NEXT:    s_sub_i32 s10, 0, s3
; CI-NEXT:    s_sub_i32 s11, 0, s2
; CI-NEXT:    s_sub_i32 s7, 0, s7
; CI-NEXT:    s_sub_i32 s6, 0, s6
; CI-NEXT:    s_ashr_i32 s5, s2, 16
; CI-NEXT:    s_sext_i32_i16 s8, s3
; CI-NEXT:    s_sext_i32_i16 s9, s2
; CI-NEXT:    s_sext_i32_i16 s10, s10
; CI-NEXT:    s_sext_i32_i16 s11, s11
; CI-NEXT:    s_sext_i32_i16 s7, s7
; CI-NEXT:    s_sext_i32_i16 s6, s6
; CI-NEXT:    s_max_i32 s5, s5, s6
; CI-NEXT:    s_max_i32 s4, s4, s7
; CI-NEXT:    s_max_i32 s6, s9, s11
; CI-NEXT:    s_max_i32 s7, s8, s10
; CI-NEXT:    s_add_i32 s7, s7, 2
; CI-NEXT:    s_add_i32 s6, s6, 2
; CI-NEXT:    s_lshl_b32 s4, s4, 16
; CI-NEXT:    s_and_b32 s7, s7, 0xffff
; CI-NEXT:    s_lshl_b32 s5, s5, 16
; CI-NEXT:    s_and_b32 s6, s6, 0xffff
; CI-NEXT:    s_or_b32 s4, s4, s7
...
; CI-NEXT:    s_mov_b32 s10, s14
; CI-NEXT:    s_mov_b32 s11, s15
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    s_mov_b32 s8, s6
; CI-NEXT:    s_mov_b32 s9, s7
; CI-NEXT:    s_mov_b32 s6, s14
; CI-NEXT:    s_mov_b32 s7, s15
; CI-NEXT:    buffer_load_sshort v0, off, s[4:7], 0 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_load_sshort v1, off, s[4:7], 0 offset:2 glc
; CI-NEXT:    s_waitcnt vmcnt(0)
...
; CI-NEXT:    s_mov_b32 s13, s1
; CI-NEXT:    s_mov_b32 s1, s3
; CI-NEXT:    s_mov_b32 s0, s2
; CI-NEXT:    s_mov_b32 s2, s14
; CI-NEXT:    s_mov_b32 s3, s15
; CI-NEXT:    v_max_i32_e32 v4, v0, v2
; CI-NEXT:    v_max_i32_e32 v5, v1, v3
; CI-NEXT:    v_min_i32_e32 v0, v0, v2
; CI-NEXT:    v_min_i32_e32 v1, v1, v3
; CI-NEXT:    buffer_store_short v5, off, s[12:15], 0 offset:2
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_store_short v4, off, s[12:15], 0
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_store_short v1, off, s[0:3], 0 offset:2
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_store_short v0, off, s[0:3], 0
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    s_endpgm
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v2, s2
; VI-NEXT:    s_ashr_i32 s2, s4, 16
; VI-NEXT:    s_sext_i32_i16 s4, s4
; VI-NEXT:    s_ashr_i32 s8, s6, 16
; VI-NEXT:    s_sext_i32_i16 s6, s6
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_max_i32 s0, s2, s8
...
; VI-NEXT:    s_max_i32 s9, s1, s5
; VI-NEXT:    s_max_i32 s11, s3, s7
; VI-NEXT:    s_or_b32 s0, s10, s0
; VI-NEXT:    s_lshl_b32 s9, s9, 16
; VI-NEXT:    s_and_b32 s11, s11, 0xffff
; VI-NEXT:    v_mov_b32_e32 v4, s0
; VI-NEXT:    s_min_i32 s0, s2, s8
...
; CI-NEXT:    buffer_store_byte v0, off, s[12:15], 0
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    s_endpgm
  %val0 = load volatile <2 x i16>, ptr addrspace(1) %ptr0
  %val1 = load volatile <2 x i16>, ptr addrspace(1) %ptr1
