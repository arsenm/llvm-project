...
define amdgpu_kernel void @partial_copy(<4 x i32> %arg) #0 {
  ...
  ; REGALLOC-GFX908-NEXT:   INLINEASM &"; use $0", 33 /* sideeffect isconvergent attdialect */, 1703945 /* reguse:AGPR_32 */, undef %5:agpr_32
  ; REGALLOC-GFX908-NEXT:   INLINEASM &"; def $0", 33 /* sideeffect isconvergent attdialect */, 5701642 /* regdef:VReg_128 */, def %26
  ; REGALLOC-GFX908-NEXT:   [[COPY:%[0-9]+]]:av_128 = COPY %26
  ; REGALLOC-GFX908-NEXT:   INLINEASM &"; def $0", 33 /* sideeffect isconvergent attdialect */, 3080202 /* regdef:VReg_64 */, def %23
  ...
  ; PEI-GFX908-NEXT:   INLINEASM &"; use $0", 33 /* sideeffect isconvergent attdialect */, 1703945 /* reguse:AGPR_32 */, undef renamable $agpr0
  ; PEI-GFX908-NEXT:   INLINEASM &"; def $0", 33 /* sideeffect isconvergent attdialect */, 5701642 /* regdef:VReg_128 */, def renamable $vgpr0_vgpr1_vgpr2_vgpr3
  ; PEI-GFX908-NEXT:   renamable $agpr0_agpr1_agpr2_agpr3 = COPY killed renamable $vgpr0_vgpr1_vgpr2_vgpr3, implicit $exec
  ; PEI-GFX908-NEXT:   INLINEASM &"; def $0", 33 /* sideeffect isconvergent attdialect */, 3080202 /* regdef:VReg_64 */, def renamable $vgpr0_vgpr1
  ...
  ; REGALLOC-GFX90A-NEXT:   INLINEASM &"; use $0", 33 /* sideeffect isconvergent attdialect */, 1703945 /* reguse:AGPR_32 */, undef %5:agpr_32
  ; REGALLOC-GFX90A-NEXT:   INLINEASM &"; def $0", 33 /* sideeffect isconvergent attdialect */, 6029322 /* regdef:VReg_128_Align2 */, def %25
  ; REGALLOC-GFX90A-NEXT:   [[COPY:%[0-9]+]]:av_128_align2 = COPY %25
  ; REGALLOC-GFX90A-NEXT:   INLINEASM &"; def $0", 33 /* sideeffect isconvergent attdialect */, 3407882 /* regdef:VReg_64_Align2 */, def %23
  ...
  ; PEI-GFX90A-NEXT:   INLINEASM &"; use $0", 33 /* sideeffect isconvergent attdialect */, 1703945 /* reguse:AGPR_32 */, undef renamable $agpr0
  ; PEI-GFX90A-NEXT:   INLINEASM &"; def $0", 33 /* sideeffect isconvergent attdialect */, 6029322 /* regdef:VReg_128_Align2 */, def renamable $vgpr0_vgpr1_vgpr2_vgpr3
  ; PEI-GFX90A-NEXT:   renamable $agpr0_agpr1_agpr2_agpr3 = COPY killed renamable $vgpr0_vgpr1_vgpr2_vgpr3, implicit $exec
  ; PEI-GFX90A-NEXT:   INLINEASM &"; def $0", 33 /* sideeffect isconvergent attdialect */, 3407882 /* regdef:VReg_64_Align2 */, def renamable $vgpr0_vgpr1
