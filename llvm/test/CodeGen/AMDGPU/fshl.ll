...
; GFX10-NEXT:    v_alignbit_b32 v0, s4, s5, 1
...
; GFX11-NEXT:    v_alignbit_b32 v0, s4, s5, 1
...
; SI-LABEL: fshl_v2i32:
; SI:       ; %bb.0: ; %entry
; SI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0xf
; SI-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0xb
...
; GFX10-NEXT:    v_alignbit_b32 v1, s2, v0, s1
; GFX10-NEXT:    v_alignbit_b32 v0, s3, v3, s0
...
; SI-NEXT:    s_load_dwordx4 s[16:19], s[2:3], 0x15
; SI-NEXT:    s_load_dwordx2 s[12:13], s[2:3], 0x9
; SI-NEXT:    s_mov_b32 s15, 0xf000
; SI-NEXT:    s_mov_b32 s14, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_not_b32 s1, s19
; SI-NEXT:    v_mov_b32_e32 v0, s11
; SI-NEXT:    v_alignbit_b32 v0, s7, v0, 1
; SI-NEXT:    s_lshr_b32 s0, s7, 1
; SI-NEXT:    v_mov_b32_e32 v1, s1
; SI-NEXT:    v_alignbit_b32 v3, s0, v0, v1
; SI-NEXT:    v_mov_b32_e32 v0, s10
; SI-NEXT:    s_not_b32 s1, s18
; SI-NEXT:    v_alignbit_b32 v0, s6, v0, 1
; SI-NEXT:    s_lshr_b32 s0, s6, 1
; SI-NEXT:    v_mov_b32_e32 v1, s1
; SI-NEXT:    v_alignbit_b32 v2, s0, v0, v1
; SI-NEXT:    v_mov_b32_e32 v0, s9
; SI-NEXT:    s_not_b32 s1, s17
; SI-NEXT:    v_alignbit_b32 v0, s5, v0, 1
; SI-NEXT:    s_lshr_b32 s0, s5, 1
; SI-NEXT:    v_mov_b32_e32 v1, s1
; SI-NEXT:    v_alignbit_b32 v1, s0, v0, v1
; SI-NEXT:    v_mov_b32_e32 v0, s8
; SI-NEXT:    s_not_b32 s1, s16
; SI-NEXT:    v_alignbit_b32 v0, s4, v0, 1
; SI-NEXT:    s_lshr_b32 s0, s4, 1
...
; GFX9-NEXT:    s_lshr_b32 s2, s7, 1
; GFX9-NEXT:    v_alignbit_b32 v0, s7, v0, 1
; GFX9-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-NEXT:    v_alignbit_b32 v3, s2, v0, v1
; GFX9-NEXT:    v_mov_b32_e32 v0, s10
; GFX9-NEXT:    s_not_b32 s3, s14
; GFX9-NEXT:    v_alignbit_b32 v0, s6, v0, 1
; GFX9-NEXT:    s_lshr_b32 s2, s6, 1
; GFX9-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-NEXT:    v_alignbit_b32 v2, s2, v0, v1
; GFX9-NEXT:    v_mov_b32_e32 v0, s9
; GFX9-NEXT:    s_not_b32 s3, s13
; GFX9-NEXT:    v_alignbit_b32 v0, s5, v0, 1
; GFX9-NEXT:    s_lshr_b32 s2, s5, 1
; GFX9-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-NEXT:    v_alignbit_b32 v1, s2, v0, v1
; GFX9-NEXT:    v_mov_b32_e32 v0, s8
; GFX9-NEXT:    s_not_b32 s3, s12
; GFX9-NEXT:    v_alignbit_b32 v0, s4, v0, 1
; GFX9-NEXT:    s_lshr_b32 s2, s4, 1
; GFX9-NEXT:    v_mov_b32_e32 v5, s3
; GFX9-NEXT:    v_alignbit_b32 v0, s2, v0, v5
...
; SI-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_lshl_b32 s4, s2, 7
; SI-NEXT:    s_or_b32 s4, s3, s4
; SI-NEXT:    s_cmp_eq_u32 s4, 0
; SI-NEXT:    s_cselect_b32 s4, s2, s3
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_mov_b32 s2, -1
