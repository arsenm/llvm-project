...
; SI-NEXT:    s_load_dwordx2 s[6:7], s[2:3], 0x1d
...
; GFX11-NEXT:    s_load_b64 s[0:1], s[2:3], 0x74
; GFX11-NEXT:    s_load_b64 s[4:5], s[2:3], 0x4c
...
; SI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
; SI-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x13
; SI-NEXT:    s_load_dword s6, s[2:3], 0x1d
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x4c
; VI-NEXT:    s_load_dword s4, s[2:3], 0x74
; VI-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x24
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_clause 0x2
; GFX11-NEXT:    s_load_b32 s4, s[2:3], 0x74
; GFX11-NEXT:    s_load_b64 s[0:1], s[2:3], 0x4c
; GFX11-NEXT:    s_load_b64 s[2:3], s[2:3], 0x24
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    s_brev_b32 s5, -2
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_lshlrev_b32_e64 v1, 16, s4
...
; SI-NEXT:    s_and_b32 s4, s3, 0x80000000
; SI-NEXT:    s_mov_b32 s3, 0xf000
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    s_and_b32 s1, s3, 0x80000000
; VI-NEXT:    v_mov_b32_e32 v0, s0
...
; SI-NEXT:    v_mov_b32_e32 v0, 0
; SI-NEXT:    s_and_b32 s4, s3, 0x80000000
; SI-NEXT:    s_or_b32 s4, s4, 0x3ff00000
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    v_mov_b32_e32 v1, s4
; SI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; SI-NEXT:    s_endpgm
...
; VI-NEXT:    s_and_b32 s1, s3, 0x80000000
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_or_b32 s0, s1, 0x3ff00000
...
; SI-NEXT:    v_mov_b32_e32 v0, 0
; SI-NEXT:    s_and_b32 s4, s3, 0x80000000
; SI-NEXT:    s_or_b32 s4, s4, 0x40240000
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    v_mov_b32_e32 v1, s4
; SI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; SI-NEXT:    s_endpgm
...
; VI-NEXT:    s_and_b32 s1, s3, 0x80000000
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_or_b32 s0, s1, 0x40240000
; VI-NEXT:    v_mov_b32_e32 v3, s0
; VI-NEXT:    flat_store_dwordx2 v[0:1], v[2:3]
; VI-NEXT:    s_endpgm
;
...
; VI-NEXT:    v_bfi_b32 v3, s8, v3, v1
; VI-NEXT:    v_bfi_b32 v1, s8, v4, v5
...
; GFX11-NEXT:    v_dual_mov_b32 v3, s11 :: v_dual_mov_b32 v0, s4
; GFX11-NEXT:    v_mov_b32_e32 v2, s6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_bfi_b32 v1, 0x7fffffff, s5, v1
; GFX11-NEXT:    v_bfi_b32 v3, 0x7fffffff, s7, v3
...
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx16 s[4:19], s[2:3], 0x11
...
; SI-NEXT:    v_bfi_b32 v3, s0, v3, v1
; SI-NEXT:    v_bfi_b32 v1, s0, v5, v6
; SI-NEXT:    v_bfi_b32 v5, s0, v7, v8
; SI-NEXT:    v_mov_b32_e32 v0, s4
; SI-NEXT:    v_mov_b32_e32 v2, s6
; SI-NEXT:    buffer_store_dwordx2 v[4:5], off, s[20:23], 0 offset:16
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
; VI-NEXT:    s_load_dwordx16 s[4:19], s[2:3], 0x44
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    v_bfi_b32 v3, s10, v3, v1
; VI-NEXT:    v_bfi_b32 v1, s10, v5, v6
; VI-NEXT:    v_bfi_b32 v5, s10, v7, v8
...
; SI-NEXT:    v_bfi_b32 v7, s0, v7, v1
; SI-NEXT:    v_bfi_b32 v5, s0, v3, v5
; SI-NEXT:    v_bfi_b32 v3, s0, v8, v9
; SI-NEXT:    v_bfi_b32 v1, s0, v10, v11
; SI-NEXT:    v_mov_b32_e32 v4, s4
; SI-NEXT:    v_mov_b32_e32 v6, s6
; SI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[20:23], 0 offset:16
; SI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[20:23], 0
; SI-NEXT:    s_endpgm
;
...
; VI-NEXT:    v_bfi_b32 v5, s12, v3, v5
; VI-NEXT:    v_bfi_b32 v3, s12, v8, v9
; VI-NEXT:    v_mov_b32_e32 v9, s3
; VI-NEXT:    v_mov_b32_e32 v0, s8
; VI-NEXT:    v_mov_b32_e32 v2, s10
; VI-NEXT:    v_bfi_b32 v7, s12, v7, v1
; VI-NEXT:    v_bfi_b32 v1, s12, v10, v11
