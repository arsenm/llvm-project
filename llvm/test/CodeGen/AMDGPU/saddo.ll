...
; SI-NEXT:    s_add_u32 s2, s6, s0
; SI-NEXT:    s_addc_u32 s3, s7, s1
; SI-NEXT:    v_mov_b32_e32 v1, s7
; SI-NEXT:    v_cmp_lt_i64_e32 vcc, s[2:3], v[0:1]
; SI-NEXT:    v_cmp_lt_i64_e64 s[0:1], s[0:1], 0
...
; GFX10-NEXT:    s_add_u32 s2, s6, s0
; GFX10-NEXT:    s_addc_u32 s3, s7, s1
; GFX10-NEXT:    v_cmp_lt_i64_e64 s0, s[0:1], 0
; GFX10-NEXT:    v_cmp_lt_i64_e64 s1, s[2:3], s[6:7]
; GFX10-NEXT:    s_xor_b32 s0, s0, s1
; GFX10-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s0
; GFX10-NEXT:    v_add_co_u32 v0, s0, s2, v0
...
; SI-NEXT:    s_mov_b32 s12, s0
; SI-NEXT:    s_mov_b32 s13, s1
...
; SI-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[0:1]
; SI-NEXT:    buffer_store_dword v2, off, s[12:15], 0
...
; VI-NEXT:    v_cmp_lt_i64_e64 s[4:5], s[6:7], 0
; VI-NEXT:    v_cmp_lt_i64_e32 vcc, s[2:3], v[4:5]
; VI-NEXT:    v_mov_b32_e32 v5, s3
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_mov_b32_e32 v4, s2
; VI-NEXT:    s_xor_b64 s[0:1], s[4:5], vcc
...
; SI-NEXT:    buffer_store_dwordx2 v[4:5], off, s[12:15], 0
; SI-NEXT:    s_xor_b64 s[0:1], vcc, s[0:1]
; SI-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[0:1]
; SI-NEXT:    buffer_store_byte v0, off, s[4:7], 0
; SI-NEXT:    s_endpgm
