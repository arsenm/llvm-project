...
; VI-NEXT:    v_cndmask_b32_e32 v3, v0, v2, vcc
; VI-NEXT:    s_cselect_b64 vcc, -1, 0
; VI-NEXT:    s_cmp_lg_u32 s8, 1
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx8 s[8:15], s[6:7], 0x40
; VI-NEXT:    s_load_dwordx4 s[16:19], s[6:7], 0x60
...
; SI-NEXT:    s_lshl_b64 s[4:5], 0xffff, s4
; SI-NEXT:    s_andn2_b64 s[6:7], s[2:3], s[4:5]
; SI-NEXT:    s_and_b32 s5, s5, 0x50005
; SI-NEXT:    s_and_b32 s4, s4, 0x50005
; SI-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; SI-NEXT:    s_mov_b32 s3, 0x100f000
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    v_mov_b32_e32 v1, s5
; SI-NEXT:    v_mov_b32_e32 v0, s4
; SI-NEXT:    buffer_store_short v1, off, s[0:3], 0 offset:4
...
; VI-NEXT:    s_lshl_b64 s[4:5], 0xffff, s4
; VI-NEXT:    s_andn2_b64 s[6:7], s[2:3], s[4:5]
...
; SI-NEXT:    s_lshl_b32 s2, s4, 3
; SI-NEXT:    s_lshl_b64 s[2:3], 0xff, s2
; SI-NEXT:    s_and_b32 s5, s3, 0x5050505
; SI-NEXT:    s_and_b32 s4, s2, 0x5050505
; SI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    s_lshl_b64 s[2:3], 0xff, s2
; VI-NEXT:    s_and_b32 s5, s3, 0x5050505
; VI-NEXT:    s_and_b32 s4, s2, 0x5050505
; VI-NEXT:    s_waitcnt lgkmcnt(0)
