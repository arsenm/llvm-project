...
; GCN-NEXT:    v_cndmask_b32_e32 v16, v9, v11, vcc
; GCN-NEXT:    v_cndmask_b32_e32 v8, v8, v10, vcc
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v12
; GCN-NEXT:    v_add_u32_e32 v18, 26, v7
; GCN-NEXT:    v_cndmask_b32_e32 v17, v8, v0, vcc
; GCN-NEXT:    v_lshrrev_b64 v[8:9], v13, v[0:1]
; GCN-NEXT:    v_lshlrev_b64 v[10:11], v18, v[4:5]
; GCN-NEXT:    v_subrev_u32_e32 v7, 38, v7
; GCN-NEXT:    v_lshlrev_b64 v[12:13], v7, v[0:1]
; GCN-NEXT:    v_lshlrev_b64 v[14:15], v18, v[0:1]
; GCN-NEXT:    v_cndmask_b32_e32 v1, v16, v1, vcc
; GCN-NEXT:    v_or_b32_e32 v0, v11, v9
; GCN-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v18
; GCN-NEXT:    v_or_b32_e32 v7, v10, v8
; GCN-NEXT:    v_cndmask_b32_e32 v0, v13, v0, vcc
; GCN-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v18
; GCN-NEXT:    v_cndmask_b32_e64 v0, v0, v5, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v5, v12, v7, vcc
; GCN-NEXT:    v_cndmask_b32_e64 v4, v5, v4, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v5, 0, v15, vcc
; GCN-NEXT:    v_cndmask_b32_e32 v7, 0, v14, vcc
...
; GCN-NEXT:    v_add_u32_e32 v17, 26, v6
; GCN-NEXT:    v_cndmask_b32_e32 v16, v7, v0, vcc
; GCN-NEXT:    v_lshrrev_b64 v[7:8], v12, v[0:1]
; GCN-NEXT:    v_lshlrev_b64 v[9:10], v17, v[2:3]
; GCN-NEXT:    v_subrev_u32_e32 v6, 38, v6
; GCN-NEXT:    v_lshlrev_b64 v[11:12], v6, v[0:1]
; GCN-NEXT:    v_lshlrev_b64 v[13:14], v17, v[0:1]
; GCN-NEXT:    v_cndmask_b32_e32 v1, v15, v1, vcc
; GCN-NEXT:    v_or_b32_e32 v0, v10, v8
; GCN-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v17
; GCN-NEXT:    v_or_b32_e32 v6, v9, v7
; GCN-NEXT:    v_cndmask_b32_e32 v0, v12, v0, vcc
; GCN-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v17
; GCN-NEXT:    v_cndmask_b32_e64 v0, v0, v3, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v3, v11, v6, vcc
; GCN-NEXT:    v_cndmask_b32_e64 v2, v3, v2, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e32 v3, 0, v14, vcc
; GCN-NEXT:    v_cndmask_b32_e32 v6, 0, v13, vcc
