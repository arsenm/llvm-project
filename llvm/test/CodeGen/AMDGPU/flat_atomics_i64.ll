...
; GFX12-NEXT:    v_dual_mov_b32 v3, s3 :: v_dual_mov_b32 v0, s0
...
; GFX12-NEXT:    s_load_b64 s[0:1], s[2:3], 0x34
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v5, s5 :: v_dual_mov_b32 v2, s0
; GFX12-NEXT:    v_dual_mov_b32 v3, s1 :: v_dual_mov_b32 v0, s6
; GFX12-NEXT:    v_dual_mov_b32 v1, s7 :: v_dual_mov_b32 v4, s4
...
; GFX12-NEXT:    s_load_b256 s[0:7], s[2:3], 0x24
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v5, s1 :: v_dual_mov_b32 v0, s4
...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_lshl_b64 s[4:5], s[4:5], 3
; GFX12-NEXT:    v_dual_mov_b32 v1, s3 :: v_dual_mov_b32 v2, s6
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[4:5]
; GFX12-NEXT:    v_dual_mov_b32 v3, s7 :: v_dual_mov_b32 v0, s2
...
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[4:5], s[2:3]
