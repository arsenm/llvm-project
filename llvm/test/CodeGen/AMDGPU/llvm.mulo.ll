...
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v4, v2, 0
; GFX9-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v0, v3, 0
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v0, v2, 0
; GFX9-NEXT:    v_add3_u32 v5, v1, v8, v6
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, v1, v8
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v4, v3, 0
; GFX9-NEXT:    v_addc_co_u32_e32 v9, vcc, 0, v9, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v3, vcc, v8, v6
...
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s4, v5, v2, 0
; GFX10-NEXT:    v_mad_u64_u32 v[5:6], s4, v5, v3, 0
...
; GFX10-NEXT:    v_add_co_u32 v4, vcc_lo, v9, v5
...
; GFX11-NEXT:    v_mad_u64_u32 v[8:9], null, v4, v2, 0
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], null, v5, v2, 0
; GFX11-NEXT:    v_mad_u64_u32 v[6:7], null, v5, v3, 0
; GFX11-NEXT:    v_mad_u64_u32 v[10:11], null, v4, v3, 0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_mov_b32_e32 v5, v1
; GFX11-NEXT:    v_add3_u32 v1, v1, v6, v8
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_add_co_u32 v2, vcc_lo, v5, v6
...
; GFX12-NEXT:    v_mad_co_u64_u32 v[0:1], null, v5, v2, 0
; GFX12-NEXT:    v_mad_co_u64_u32 v[5:6], null, v5, v3, 0
...
; GFX12-NEXT:    v_add_co_u32 v4, vcc_lo, v9, v5
...
; GFX9-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v5, v3, 0
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v5, v2, 0
; GFX9-NEXT:    v_add3_u32 v6, v1, v9, v7
; GFX9-NEXT:    v_add_co_u32_e32 v1, vcc, v1, v9
; GFX9-NEXT:    v_addc_co_u32_e32 v11, vcc, 0, v10, vcc
; GFX9-NEXT:    v_mad_i64_i32 v[9:10], s[4:5], v4, v3, 0
; GFX9-NEXT:    v_add_co_u32_e32 v1, vcc, v1, v7
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, v11, v8, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v7, vcc, 0, v10, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v1, vcc, v1, v9
; GFX9-NEXT:    v_addc_co_u32_e32 v7, vcc, 0, v7, vcc
; GFX9-NEXT:    v_sub_co_u32_e32 v2, vcc, v1, v2
; GFX9-NEXT:    v_subbrev_co_u32_e32 v8, vcc, 0, v7, vcc
; GFX9-NEXT:    v_cmp_gt_i32_e32 vcc, 0, v4
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v1, v2, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v4, v7, v8, vcc
; GFX9-NEXT:    v_sub_co_u32_e32 v5, vcc, v1, v5
; GFX9-NEXT:    v_subbrev_co_u32_e32 v2, vcc, 0, v4, vcc
; GFX9-NEXT:    v_cmp_gt_i32_e32 vcc, 0, v3
; GFX9-NEXT:    v_ashrrev_i32_e32 v3, 31, v6
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v4, v2, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v1, v5, vcc
; GFX9-NEXT:    v_mov_b32_e32 v4, v3
; GFX9-NEXT:    v_cmp_ne_u64_e32 vcc, v[1:2], v[3:4]
...
; GFX10-NEXT:    v_mov_b32_e32 v4, v1
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s4, v5, v2, 0
; GFX10-NEXT:    v_mad_u64_u32 v[6:7], s4, v5, v3, 0
; GFX10-NEXT:    v_mad_u64_u32 v[8:9], s4, v4, v2, 0
; GFX10-NEXT:    v_mad_i64_i32 v[10:11], s4, v4, v3, 0
...
; GFX10-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 0, v4
; GFX10-NEXT:    v_cndmask_b32_e32 v6, v7, v2, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e32 v4, v9, v10, vcc_lo
; GFX10-NEXT:    v_ashrrev_i32_e32 v2, 31, v1
; GFX10-NEXT:    v_sub_co_u32 v7, vcc_lo, v6, v5
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v5, vcc_lo, 0, v4, vcc_lo
; GFX10-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 0, v3
; GFX10-NEXT:    v_mov_b32_e32 v3, v2
; GFX10-NEXT:    v_cndmask_b32_e32 v5, v4, v5, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e32 v4, v6, v7, vcc_lo
...
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], null, v5, v2, 0
; GFX11-NEXT:    v_mad_u64_u32 v[6:7], null, v5, v3, 0
; GFX11-NEXT:    v_mad_i64_i32 v[10:11], null, v4, v3, 0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
...
; GFX11-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 0, v4
...
; GFX11-NEXT:    v_sub_co_u32 v7, vcc_lo, v6, v5
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_subrev_co_ci_u32_e32 v5, vcc_lo, 0, v4, vcc_lo
; GFX11-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 0, v3
; GFX11-NEXT:    v_mov_b32_e32 v3, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_dual_cndmask_b32 v5, v4, v5 :: v_dual_cndmask_b32 v4, v6, v7
...
; GFX12-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v5, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-NEXT:    v_mad_co_u64_u32 v[8:9], null, v4, v2, 0
; GFX12-NEXT:    v_mad_co_u64_u32 v[0:1], null, v5, v2, 0
; GFX12-NEXT:    v_mad_co_u64_u32 v[6:7], null, v5, v3, 0
; GFX12-NEXT:    v_mad_co_i64_i32 v[10:11], null, v4, v3, 0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
...
; GFX12-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 0, v4
; GFX12-NEXT:    v_cndmask_b32_e32 v4, v9, v10, vcc_lo
