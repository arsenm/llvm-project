...
; CHECK-NEXT:    v_lshlrev_b32_e32 v12, 4, v0
; CHECK-NEXT:    v_mul_hi_i32_i24_e32 v15, -12, v0
; CHECK-NEXT:    v_mul_i32_i24_e32 v14, -12, v0
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_lshl_add_u64 v[16:17], s[0:1], 0, v[12:13]
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v12, s[0:1]
; CHECK-NEXT:    global_load_dwordx4 v[4:7], v12, s[0:1] offset:16
; CHECK-NEXT:    global_load_dwordx4 v[8:11], v12, s[0:1] offset:32
...
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[18:21], v[0:3], v[4:7], v[0:3]
; CHECK-NEXT:    s_add_i32 s0, s8, s9
; CHECK-NEXT:    v_add_u32_e32 v22, v14, v15
; CHECK-NEXT:    v_add_u32_e32 v23, v15, v16
; CHECK-NEXT:    v_mfma_f32_16x16x32_f16 v[26:29], v[0:3], v[4:7], v[4:7]
...
; CHECK-NEXT:    v_add_u32_e32 v5, v31, v14
; CHECK-NEXT:    ; sched_barrier mask(0x00000000)
; CHECK-NEXT:    global_store_dwordx4 v13, v[18:21], s[14:15]
; CHECK-NEXT:    global_store_dwordx4 v13, v[26:29], s[14:15] offset:16
; CHECK-NEXT:    s_nop 2
; CHECK-NEXT:    global_store_dwordx4 v13, v[0:3], s[14:15] offset:32
; CHECK-NEXT:    global_store_dwordx4 v13, v[22:25], s[14:15] offset:48
; CHECK-NEXT:    v_mov_b32_e32 v6, s0
; CHECK-NEXT:    v_mov_b32_e32 v7, s1
; CHECK-NEXT:    v_mov_b32_e32 v0, s2
; CHECK-NEXT:    global_store_dwordx4 v13, v[4:7], s[14:15] offset:64
; CHECK-NEXT:    global_store_dword v13, v0, s[14:15] offset:80
; CHECK-NEXT:    s_endpgm
    ptr addrspace(1) %ptr,
