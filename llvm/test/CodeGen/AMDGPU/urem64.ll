...
; GCN-NEXT:    s_mul_i32 s2, s2, s1
; GCN-NEXT:    s_sub_i32 s2, s8, s2
...
; GCN-IR-NEXT:    s_mul_i32 s2, s2, s1
; GCN-IR-NEXT:    s_sub_i32 s2, s8, s2
; GCN-IR-NEXT:    s_sub_i32 s3, s2, s1
; GCN-IR-NEXT:    s_cmp_ge_u32 s2, s1
; GCN-IR-NEXT:    s_cselect_b32 s2, s3, s2
; GCN-IR-NEXT:    s_sub_i32 s3, s2, s1
; GCN-IR-NEXT:    s_cmp_ge_u32 s2, s1
; GCN-IR-NEXT:    s_cselect_b32 s1, s3, s2
...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
; GCN-NEXT:    v_mov_b32_e32 v1, 0xaaaaaaab
; GCN-NEXT:    v_mov_b32_e32 v0, 0xaaaaaaaa
; GCN-NEXT:    s_mov_b32 s7, 0xf000
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mul_hi_u32 v3, s3, v1
...
; GCN-NEXT:    v_addc_u32_e32 v1, vcc, 0, v2, vcc
; GCN-NEXT:    s_mul_i32 s6, s3, 0xaaaaaaaa
; GCN-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
...
; GCN-NEXT:    v_subb_u32_e32 v1, vcc, v4, v2, vcc
; GCN-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GCN-NEXT:    s_endpgm
;
...
; GCN-IR:       ; %bb.0:
; GCN-IR-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
; GCN-IR-NEXT:    s_movk_i32 s5, 0x5b7f
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_mov_b32 s2, -1
