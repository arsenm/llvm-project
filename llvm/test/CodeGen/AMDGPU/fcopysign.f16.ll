...
; VI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_and_b32 s2, s4, 0x7fff
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_and_b32 s2, s4, 0x7fff
...
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_or_b32 s2, s4, 0x8000
; GFX9-NEXT:    v_mov_b32_e32 v1, s2
; GFX9-NEXT:    global_store_short v0, v1, s[0:1]
; GFX9-NEXT:    s_endpgm
;
...
; SI-NEXT:    s_mov_b32 s7, 0xf000
; SI-NEXT:    s_mov_b32 s11, s7
; SI-NEXT:    buffer_load_dword v3, v[1:2], s[8:11], 0 addr64
; SI-NEXT:    s_mov_b64 s[2:3], s[10:11]
; SI-NEXT:    v_lshlrev_b32_e32 v1, 1, v0
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_ushort v2, v1, s[0:1]
; GFX9-NEXT:    s_brev_b32 s0, -2
...
; VI-NEXT:    v_bfi_b32 v0, s2, v3, v0
; VI-NEXT:    v_mov_b32_e32 v3, s6
; VI-NEXT:    v_mov_b32_e32 v4, s3
; VI-NEXT:    v_mov_b32_e32 v1, s5
; VI-NEXT:    v_mov_b32_e32 v2, s7
; VI-NEXT:    v_bfi_b32 v3, s2, v3, v4
; VI-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; VI-NEXT:    v_bfi_b32 v2, s2, v1, v2
; VI-NEXT:    s_add_u32 s2, s0, 4
; VI-NEXT:    v_or_b32_sdwa v3, v0, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
; GFX9-NEXT:    v_bfi_b32 v0, s2, v3, v4
; GFX9-NEXT:    v_mov_b32_e32 v3, s4
; GFX9-NEXT:    v_mov_b32_e32 v4, s6
; GFX9-NEXT:    v_bfi_b32 v3, s2, v3, v4
; GFX9-NEXT:    v_and_b32_e32 v0, 0xffff, v0
