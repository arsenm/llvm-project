...
; THUMB1-NEXT:    .pad #28
; THUMB1-NEXT:    sub sp, #28
; THUMB1-NEXT:    mov r6, r2
; THUMB1-NEXT:    movs r2, #1
; THUMB1-NEXT:    str r2, [sp] @ 4-byte Spill
; THUMB1-NEXT:    movs r2, #0
; THUMB1-NEXT:    str r2, [sp, #20] @ 4-byte Spill
; THUMB1-NEXT:    ldr r2, [sp, #60]
; THUMB1-NEXT:    add r7, sp, #48
; THUMB1-NEXT:    ldm r7, {r4, r5, r7}
; THUMB1-NEXT:    str r0, [sp, #8] @ 4-byte Spill
; THUMB1-NEXT:    str r4, [sp, #4] @ 4-byte Spill
; THUMB1-NEXT:    subs r4, r0, r4
; THUMB1-NEXT:    str r1, [sp, #12] @ 4-byte Spill
; THUMB1-NEXT:    mov r4, r1
; THUMB1-NEXT:    sbcs r4, r5
; THUMB1-NEXT:    str r6, [sp, #16] @ 4-byte Spill
; THUMB1-NEXT:    sbcs r6, r7
; THUMB1-NEXT:    str r3, [sp, #24] @ 4-byte Spill
; THUMB1-NEXT:    mov r4, r3
; THUMB1-NEXT:    ldr r3, [sp] @ 4-byte Reload
; THUMB1-NEXT:    sbcs r4, r2
; THUMB1-NEXT:    mov r1, r3
; THUMB1-NEXT:    blo .LBB4_2
; THUMB1-NEXT:  @ %bb.1:
; THUMB1-NEXT:    ldr r1, [sp, #20] @ 4-byte Reload
; THUMB1-NEXT:  .LBB4_2:
; THUMB1-NEXT:    ldr r0, [sp, #8] @ 4-byte Reload
; THUMB1-NEXT:    ldr r4, [sp, #4] @ 4-byte Reload
...
; THUMB1-NEXT:    ldr r0, [sp, #24] @ 4-byte Reload
; THUMB1-NEXT:    sbcs r2, r0
; THUMB1-NEXT:    blo .LBB4_4
; THUMB1-NEXT:  @ %bb.3:
; THUMB1-NEXT:    ldr r3, [sp, #20] @ 4-byte Reload
; THUMB1-NEXT:  .LBB4_4:
; THUMB1-NEXT:    subs r0, r3, r1
; THUMB1-NEXT:    add sp, #28
