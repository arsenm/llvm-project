...
define zeroext i1 @pr13209(ptr %x, ptr %jumpTable) nounwind {
if.end51:
...
do.end165:
  %tmp92 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.end209:
  %tmp104 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.end220:
  %tmp107 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.end231:
  %tmp110 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.end242:
  %tmp113 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.end253:
  %tmp116 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.end286:
  %tmp125 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.end297:
  %tmp128 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.end308:
  %tmp131 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.end429:
  %tmp164 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.end440:
  %tmp167 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.body482:
...
jit_return:
  br label %indirectgoto.preheader
L_JSOP_UINT24:
  %tmp864 = load ptr, ptr %x, align 8
  br label %indirectgoto
L_JSOP_THROWING:
  %tmp1201 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.body4936:
  %tmp1240 = load ptr, ptr %x, align 8
  br label %indirectgoto
do.body5184:
  %tmp1340 = load ptr, ptr %x, align 8
  br label %indirectgoto
if.end5571:
  br  label %inline_return
indirectgoto:
  ...
  indirectbr ptr null, [ label %if.end5571, label %do.end165, label %do.end209, label %do.end220, label %do.end231, label %do.end242, label %do.end253, label %do.end723, label %L_JSOP_THROWING, label %do.end440, label %do.end429, label %do.end308, label %do.end297, label %do.end286, label %L_JSOP_UINT24, label %do.body5184, label %do.body4936, label %do.body482]
}
