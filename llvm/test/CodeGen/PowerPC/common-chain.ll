...
; CHECK-NEXT:    ld r2, -160(r1) # 8-byte Folded Reload
; CHECK-NEXT:    rldicl r7, r7, 62, 2
; CHECK-NEXT:    sldi r8, r16, 3
; CHECK-NEXT:    sldi r3, r14, 3
; CHECK-NEXT:    add r9, r11, r8
; CHECK-NEXT:    add r12, r5, r9
; CHECK-NEXT:    sldi r9, r15, 3
; CHECK-NEXT:    add r0, r11, r9
; CHECK-NEXT:    add r30, r5, r0
; CHECK-NEXT:    add r0, r11, r3
; CHECK-NEXT:    add r29, r5, r0
; CHECK-NEXT:    add r28, r4, r0
; CHECK-NEXT:    add r27, r2, r0
; CHECK-NEXT:    mulli r0, r10, 24
; CHECK-NEXT:    add r26, r0, r8
; CHECK-NEXT:    add r25, r0, r9
; CHECK-NEXT:    add r0, r0, r3
; CHECK-NEXT:    add r24, r5, r0
; CHECK-NEXT:    add r23, r4, r0
; CHECK-NEXT:    add r22, r2, r0
; CHECK-NEXT:    sldi r0, r10, 4
; CHECK-NEXT:    add r26, r5, r26
; CHECK-NEXT:    add r25, r5, r25
; CHECK-NEXT:    add r21, r0, r8
; CHECK-NEXT:    add r20, r0, r9
; CHECK-NEXT:    add r0, r0, r3
; CHECK-NEXT:    add r19, r5, r0
; CHECK-NEXT:    add r18, r4, r0
; CHECK-NEXT:    add r17, r2, r0
; CHECK-NEXT:    add r0, r10, r16
; CHECK-NEXT:    add r21, r5, r21
; CHECK-NEXT:    add r20, r5, r20
; CHECK-NEXT:    sldi r0, r0, 3
; CHECK-NEXT:    add r16, r5, r0
; CHECK-NEXT:    add r0, r10, r15
; CHECK-NEXT:    sldi r0, r0, 3
...
; CHECK-NEXT:    sub r0, r9, r3
; CHECK-NEXT:    rldicl r9, r7, 2, 1
; CHECK-NEXT:    sub r7, r8, r3
; CHECK-NEXT:    addi r8, r9, -4
; CHECK-NEXT:    ori r3, r9, 1
; CHECK-NEXT:    rldicl r8, r8, 62, 2
; CHECK-NEXT:    mulld r9, r10, r3
...
; CHECK-NEXT:    xsmuldp f0, f0, f1
; CHECK-NEXT:    lfdx f1, r7, r9
; CHECK-NEXT:    xsadddp f0, f1, f0
; CHECK-NEXT:    stfdx f0, r7, r9
; CHECK-NEXT:    add r9, r9, r8
