...
define void @asm_simple_register_clobber() {
  ...
  ; CHECK-NEXT:   RET_ReallyLR
  call void asm sideeffect "mov x0, 7", "~{x0}"() noconvergent, !srcloc !0
  ret void
}
...
define i64 @asm_register_early_clobber() {
  ...
  call { i64, i64 } asm sideeffect "mov $0, 7; mov $1, 7", "=&r,=&r"() noconvergent, !srcloc !0
...
entry:
  %0 = tail call i32 asm "mov ${0:w}, 7", "={w0}"() noconvergent nounwind
  ret i32 %0
}
...
define i32 @test_single_register_output() nounwind ssp {
  ...
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
entry:
  %0 = tail call i32 asm "mov ${0:w}, 7", "=r"() noconvergent nounwind
  ret i32 %0
}
...
define i64 @test_single_register_output_s64() nounwind ssp {
  ...
  ; CHECK-NEXT:   RET_ReallyLR implicit $x0
entry:
  %0 = tail call i64 asm "mov $0, 7", "=r"() noconvergent nounwind
  ret i64 %0
}
...
define float @test_multiple_register_outputs_same() #0 {
  ...
  %1 = call { float, float } asm "mov $0, #0; mov $1, #0", "=r,=r"() noconvergent
...
define double @test_multiple_register_outputs_mixed() #0 {
  ...
  %1 = call { float, double } asm "mov $0, #0; mov $1, #0", "=r,=w"() noconvergent
...
define i32 @test_specific_register_output_trunc() nounwind ssp {
  ...
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
entry:
  %0 = tail call i32 asm "mov ${0:w}, 7", "={x0}"() noconvergent nounwind
  ret i32 %0
}
...
define zeroext i8 @test_register_output_trunc(ptr %src) nounwind {
  ...
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
entry:
  %0 = tail call i8 asm "mov ${0:w}, 32", "=r"() noconvergent nounwind
  ret i8 %0
}
...
define float @test_vector_output() nounwind {
  ...
  ; CHECK-NEXT:   RET_ReallyLR implicit $s0
  %1 = tail call <2 x float> asm sideeffect "fmov ${0}.2s, #1.0", "={v14}"() noconvergent nounwind
...
define void @test_input_register_imm() {
  ...
  ; CHECK-NEXT:   RET_ReallyLR
  call void asm sideeffect "mov x0, $0", "r"(i64 42) noconvergent
  ret void
}
...
define i32 @test_boolean_imm_ext() {
  ...
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
entry:
  tail call void asm sideeffect "#TEST 42 + ${0:c} - .\0A\09", "i"(i1 true) noconvergent
  ret i32 1
}
...
define void @test_input_imm() {
  ...
  ; CHECK-NEXT:   RET_ReallyLR
  call void asm sideeffect "mov x0, $0", "i"(i64 42) noconvergent
  ret void
}
...
define zeroext i8 @test_input_register(ptr %src) nounwind {
  ...
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
entry:
  %0 = tail call i8 asm "ldtrb ${0:w}, [$1]", "=r,r"(ptr %src) noconvergent nounwind
  ret i8 %0
}
...
define i32 @test_memory_constraint(ptr %a) nounwind {
  ...
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
  %1 = tail call i32 asm "ldr $0, $1", "=r,*m"(ptr elementtype(i32) %a) noconvergent
  ret i32 %1
}
...
define i16 @test_anyext_input() {
  ...
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
  %1 = call i16 asm sideeffect "", "=r,r"(i16 1) noconvergent
  ret i16 %1
}
...
define i16 @test_anyext_input_with_matching_constraint() {
  ...
  ; CHECK-NEXT:   $w0 = COPY [[ANYEXT1]](s32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
  %1 = call i16 asm sideeffect "", "=r,0"(i16 1) noconvergent
  ret i16 %1
}
...
define i64 @test_input_with_matching_constraint_to_physical_register() {
  ...
  ; CHECK-NEXT:   $x0 = COPY [[COPY]](s64)
  ; CHECK-NEXT:   RET_ReallyLR implicit $x0
  %1 = tail call i64 asm "", "={x2},0"(i64 0) noconvergent
  ret i64 %1
}
