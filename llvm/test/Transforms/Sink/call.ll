...
declare i32 @f_load_global() noconvergent nounwind willreturn readonly
declare i32 @f_load_global_throwable() noconvergent willreturn readonly
declare i32 @f_load_global_may_not_return() noconvergent nounwind readonly
declare i32 @f_load_arg(ptr) noconvergent nounwind willreturn readonly argmemonly
declare void @f_store_global(i32) noconvergent nounwind willreturn
declare void @f_store_arg(ptr) noconvergent nounwind willreturn argmemonly
declare void @f_readonly_arg(ptr readonly, ptr) noconvergent nounwind willreturn argmemonly
declare i32 @f_readnone(i32) noconvergent nounwind willreturn readnone
