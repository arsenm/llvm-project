...
; CHECK: attributes #1 = { noconvergent nounwind memory(none) }
; CHECK: attributes #2 = { ssp uwtable }
; CHECK: attributes #3 = { nocallback noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite) }
