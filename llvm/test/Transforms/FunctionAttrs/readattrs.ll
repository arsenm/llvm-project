...
; CHECK: Function Attrs: mustprogress noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
...
; CHECK: Function Attrs: mustprogress noconvergent nofree nosync nounwind willreturn memory(write)
...
; CHECK: Function Attrs: mustprogress noconvergent nofree nosync nounwind willreturn memory(read)
...
; CHECK: Function Attrs: mustprogress noconvergent nofree norecurse nounwind willreturn memory(argmem: readwrite, inaccessiblemem: readwrite)
