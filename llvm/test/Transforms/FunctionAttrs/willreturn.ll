...
; CHECK: Function Attrs: mustprogress noconvergent nofree norecurse noreturn nosync nounwind willreturn memory(none)
...
; CHECK: Function Attrs: mustprogress noconvergent nofree norecurse noreturn nosync nounwind willreturn memory(argmem: read)
...
; CHECK: Function Attrs: mustprogress noconvergent nofree norecurse noreturn nosync nounwind memory(argmem: write)
...
; CHECK: Function Attrs: mustprogress nofree nounwind willreturn memory(none)
...
; CHECK: Function Attrs: noconvergent nofree norecurse noreturn nosync nounwind memory(none)
