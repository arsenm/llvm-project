...
; CHECK: Function Attrs: mustprogress noconvergent nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: read, inaccessiblemem: none)
...
; CHECK: Function Attrs: noconvergent nofree norecurse nounwind memory(argmem: readwrite, inaccessiblemem: readwrite)
