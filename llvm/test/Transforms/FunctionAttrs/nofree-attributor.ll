...
; FNATTR: Function Attrs: mustprogress noconvergent nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
...
; FNATTR: Function Attrs: noconvergent nofree noinline nosync nounwind memory(none) uwtable
...
; FNATTR: Function Attrs: nofree noinline nounwind memory(none) uwtable
; FNATTR-LABEL: define {{[^@]+}}@call_nofree_function
; FNATTR-SAME: () #[[ATTR5:[0-9]+]] {
...
; FNATTR: Function Attrs: mustprogress noconvergent nofree noinline nosync nounwind willreturn memory(none) uwtable
