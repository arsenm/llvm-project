...
; CHECK: Function Attrs: mustprogress noconvergent nofree norecurse nosync nounwind ssp willreturn memory(none) uwtable
; CHECK-LABEL: @test1(
; CHECK-NEXT:  entry:
...
; CHECK: Function Attrs: mustprogress noconvergent nofree norecurse nounwind ssp willreturn memory(argmem: readwrite) uwtable
; CHECK-LABEL: @test2(
; CHECK-NEXT:  entry:
