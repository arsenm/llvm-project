...
; CHECK-NEXT:    call void @spmd_helper() #[[ATTR3:[0-9]+]]
...
; CHECK-DISABLE-SPMDIZATION-NEXT:    call void @spmd_helper() #[[ATTR3:[0-9]+]]
...
; CHECK-NEXT:    br i1 [[EXEC_USER_CODE]], label [[USER_CODE_ENTRY:%.*]], label [[WORKER_EXIT:%.*]]
; CHECK:       user_code.entry:
; CHECK-NEXT:    call void @generic_helper() #[[ATTR3]]
...
; CHECK-DISABLE-SPMDIZATION-NEXT:    br i1 [[EXEC_USER_CODE]], label [[USER_CODE_ENTRY:%.*]], label [[WORKER_EXIT:%.*]]
; CHECK-DISABLE-SPMDIZATION:       user_code.entry:
; CHECK-DISABLE-SPMDIZATION-NEXT:    call void @generic_helper() #[[ATTR3]]
; CHECK-DISABLE-SPMDIZATION-NEXT:    call void @__kmpc_target_deinit(ptr @[[GLOB1]], i8 1)
; CHECK-DISABLE-SPMDIZATION-NEXT:    ret void
; CHECK-DISABLE-SPMDIZATION:       worker.exit:
; CHECK-DISABLE-SPMDIZATION-NEXT:    ret void
...
; CHECK-DISABLE-SPMDIZATION-NEXT:    call void @leaf() #[[ATTR6:[0-9]+]]
...
; CHECK-NEXT:    call void @__omp_outlined__(ptr [[DOTADDR1]], ptr [[DOTZERO_ADDR]]) #[[ATTR6]]
; CHECK-NEXT:    ret void
;
...
; CHECK-DISABLE-SPMDIZATION-NEXT:    call void @__omp_outlined__(ptr [[DOTADDR1]], ptr [[DOTZERO_ADDR]]) #[[ATTR6]]
; CHECK-DISABLE-SPMDIZATION-NEXT:    ret void
;
entry:
...
; CHECK: attributes #[[ATTR6]] = { nosync nounwind }
;.
...
; CHECK-DISABLE-SPMDIZATION: attributes #[[ATTR6]] = { nosync nounwind }
;.
