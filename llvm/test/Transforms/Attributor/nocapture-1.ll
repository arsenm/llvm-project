...
; CHECK: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn memory(write)
...
; TUNIT: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn memory(write)
; TUNIT-LABEL: define {{[^@]+}}@c3
; TUNIT-SAME: (ptr nofree writeonly [[Q:%.*]]) #[[ATTR1]] {
; TUNIT-NEXT:    call void @c2(ptr nofree writeonly [[Q]]) #[[ATTR17:[0-9]+]]
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree nosync nounwind willreturn memory(write)
...
; TUNIT: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn memory(read)
...
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn memory(read)
...
; TUNIT: Function Attrs: noconvergent nounwind memory(read)
...
;
; CGSCC: Function Attrs: noconvergent nounwind memory(read)
...
; TUNIT: Function Attrs: noconvergent nofree norecurse nounwind willreturn memory(read)
; TUNIT-LABEL: define {{[^@]+}}@c7
; TUNIT-SAME: (ptr nofree readonly [[Q:%.*]], i32 [[BITNO:%.*]]) #[[ATTR5:[0-9]+]] {
...
; TUNIT-NEXT:    ret i1 [[VAL]]
;
; CGSCC: Function Attrs: noconvergent nofree nosync nounwind willreturn memory(read)
...
; TUNIT: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn
; TUNIT-LABEL: define {{[^@]+}}@nc1
; TUNIT-SAME: (ptr nofree [[Q:%.*]], ptr nocapture nofree [[P:%.*]], i1 [[B:%.*]]) #[[ATTR6:[0-9]+]] {
; TUNIT-NEXT:  e:
...
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn
...
; TUNIT-SAME: (ptr nofree [[Q:%.*]], ptr addrspace(1) nocapture nofree [[P:%.*]], i1 [[B:%.*]]) #[[ATTR6]] {
; TUNIT-NEXT:  e:
; TUNIT-NEXT:    br label [[L:%.*]]
; TUNIT:       l:
...
; TUNIT-SAME: (ptr nocapture nofree [[P:%.*]], ptr nofree [[Q:%.*]]) #[[ATTR6]] {
; TUNIT-NEXT:    [[TMP1:%.*]] = call i32 @nc1(ptr nofree [[Q]], ptr nocapture nofree [[P]], i1 noundef false) #[[ATTR17]]
; TUNIT-NEXT:    ret void
;
...
; CGSCC-NEXT:    [[TMP1:%.*]] = call i32 @nc1(ptr nofree [[Q]], ptr nocapture nofree align 4 [[P]], i1 noundef false) #[[ATTR19]]
; CGSCC-NEXT:    ret void
;
...
; TUNIT: Function Attrs: noconvergent nounwind memory(argmem: readwrite)
; TUNIT-LABEL: define {{[^@]+}}@nc4
; TUNIT-SAME: (ptr [[P:%.*]]) #[[ATTR8:[0-9]+]] {
; TUNIT-NEXT:    call void @external(ptr readonly [[P]]) #[[ATTR19:[0-9]+]]
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nounwind memory(argmem: readwrite)
; CGSCC-LABEL: define {{[^@]+}}@nc4
; CGSCC-SAME: (ptr [[P:%.*]]) #[[ATTR10:[0-9]+]] {
; CGSCC-NEXT:    call void @external(ptr readonly [[P]]) #[[ATTR21:[0-9]+]]
; CGSCC-NEXT:    ret void
;
...
; TUNIT: Function Attrs: noconvergent nofree nosync nounwind memory(write)
...
; TUNIT-NEXT:    [[TMP1:%.*]] = call ptr @test1_2(ptr noalias nocapture nofree readnone undef, ptr noalias nofree readnone "no-capture-maybe-returned" [[Y1_1]], i1 [[C]]) #[[ATTR20:[0-9]+]]
; TUNIT-NEXT:    store ptr null, ptr @g, align 8
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree nosync nounwind memory(write)
...
; CGSCC-NEXT:    [[TMP1:%.*]] = call ptr @test1_2(ptr noalias nocapture nofree readnone undef, ptr noalias nofree readnone "no-capture-maybe-returned" [[Y1_1]], i1 [[C]]) #[[ATTR22:[0-9]+]]
...
; TUNIT:       t:
; TUNIT-NEXT:    call void @test1_1(ptr noalias nocapture nofree readnone undef, ptr noalias nocapture nofree readnone [[Y1_2]], i1 noundef [[C]]) #[[ATTR20]]
; TUNIT-NEXT:    store ptr null, ptr @g, align 8
...
; CGSCC:       t:
; CGSCC-NEXT:    call void @test1_1(ptr noalias nocapture nofree readnone undef, ptr noalias nocapture nofree readnone [[Y1_2]], i1 noundef [[C]]) #[[ATTR22]]
; CGSCC-NEXT:    store ptr null, ptr @g, align 8
...
; TUNIT-NEXT:    call void @test2(ptr noalias nocapture nofree readnone undef) #[[ATTR20]]
; TUNIT-NEXT:    store ptr null, ptr @g, align 8
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree nosync nounwind memory(write)
...
; CGSCC-NEXT:    call void @test2(ptr noalias nocapture nofree readnone undef) #[[ATTR22]]
; CGSCC-NEXT:    store ptr null, ptr @g, align 8
; CGSCC-NEXT:    ret void
;
...
; TUNIT-NEXT:    call void @test3(ptr noalias nocapture nofree readnone undef, ptr noalias nocapture nofree readnone undef, ptr noalias nocapture nofree readnone undef) #[[ATTR20]]
; TUNIT-NEXT:    store ptr null, ptr @g, align 8
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree nosync nounwind memory(write)
...
; CGSCC-NEXT:    call void @test3(ptr noalias nocapture nofree readnone undef, ptr noalias nocapture nofree readnone undef, ptr noalias nocapture nofree readnone undef) #[[ATTR22]]
; CGSCC-NEXT:    store ptr null, ptr @g, align 8
; CGSCC-NEXT:    ret void
;
...
; TUNIT-NEXT:    [[TMP1:%.*]] = call ptr @test4_2(ptr noalias nocapture nofree readnone undef, ptr noalias nofree readnone "no-capture-maybe-returned" [[X4_1]], ptr noalias nocapture nofree readnone undef, i1 [[C]]) #[[ATTR20]]
; TUNIT-NEXT:    store ptr null, ptr @g, align 8
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree nosync nounwind memory(write)
...
; CGSCC-NEXT:    [[TMP1:%.*]] = call ptr @test4_2(ptr noalias nocapture nofree readnone undef, ptr noalias nofree readnone "no-capture-maybe-returned" [[X4_1]], ptr noalias nocapture nofree readnone undef, i1 [[C]]) #[[ATTR22]]
; CGSCC-NEXT:    store ptr null, ptr @g, align 8
; CGSCC-NEXT:    ret void
;
...
; TUNIT-NEXT:    br i1 [[C]], label [[T:%.*]], label [[F:%.*]]
; TUNIT:       t:
; TUNIT-NEXT:    call void @test4_1(ptr noalias nocapture nofree noundef readnone align 4294967296 null, i1 noundef [[C]]) #[[ATTR20]]
; TUNIT-NEXT:    store ptr null, ptr @g, align 8
; TUNIT-NEXT:    br label [[F]]
; TUNIT:       f:
...
; CGSCC-NEXT:    br i1 [[C]], label [[T:%.*]], label [[F:%.*]]
; CGSCC:       t:
; CGSCC-NEXT:    call void @test4_1(ptr noalias nocapture nofree noundef readnone align 4294967296 null, i1 noundef [[C]]) #[[ATTR22]]
; CGSCC-NEXT:    store ptr null, ptr @g, align 8
; CGSCC-NEXT:    br label [[F]]
; CGSCC:       f:
...
; TUNIT: Function Attrs: noconvergent nofree norecurse nounwind willreturn memory(argmem: readwrite)
...
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nounwind willreturn memory(argmem: readwrite)
...
; TUNIT-SAME: (ptr nocapture nofree noundef nonnull dereferenceable(8) [[P:%.*]], ptr nofree [[Q:%.*]]) #[[ATTR10]] {
; TUNIT-NEXT:    [[TMP1:%.*]] = cmpxchg ptr [[P]], ptr null, ptr [[Q]] acquire monotonic, align 8
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nounwind willreturn memory(argmem: readwrite)
; CGSCC-LABEL: define {{[^@]+}}@test_cmpxchg_ptr
; CGSCC-SAME: (ptr nocapture nofree noundef nonnull dereferenceable(8) [[P:%.*]], ptr nofree [[Q:%.*]]) #[[ATTR12]] {
...
; TUNIT-SAME: (ptr nocapture nofree [[P:%.*]]) #[[ATTR6]] {
; TUNIT-NEXT:  entry:
...
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn memory(write)
...
; TUNIT: Function Attrs: noconvergent nofree norecurse nosync nounwind null_pointer_is_valid willreturn memory(none)
; TUNIT-LABEL: define {{[^@]+}}@captureDereferenceableOrNullICmp
; TUNIT-SAME: (ptr nofree readnone dereferenceable_or_null(4) [[X:%.*]]) #[[ATTR11:[0-9]+]] {
; TUNIT-NEXT:    [[TMP1:%.*]] = icmp eq ptr [[X]], null
; TUNIT-NEXT:    ret i1 [[TMP1]]
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nosync nounwind null_pointer_is_valid willreturn memory(none)
; CGSCC-LABEL: define {{[^@]+}}@captureDereferenceableOrNullICmp
; CGSCC-SAME: (ptr nofree readnone dereferenceable_or_null(4) [[X:%.*]]) #[[ATTR13:[0-9]+]] {
...
; TUNIT: Function Attrs: noconvergent nounwind willreturn
; TUNIT-LABEL: define {{[^@]+}}@ptr_uses
; TUNIT-SAME: (ptr [[PTR:%.*]], ptr nocapture nofree noundef nonnull writeonly dereferenceable(1) [[WPTR:%.*]]) #[[ATTR14:[0-9]+]] {
; TUNIT-NEXT:    store i8 0, ptr [[WPTR]], align 1
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nounwind willreturn
; CGSCC-LABEL: define {{[^@]+}}@ptr_uses
; CGSCC-SAME: (ptr [[PTR:%.*]], ptr nocapture nofree noundef nonnull writeonly dereferenceable(1) [[WPTR:%.*]]) #[[ATTR16:[0-9]+]] {
...
; TUNIT: attributes #[[ATTR1]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(write) }
; TUNIT: attributes #[[ATTR2]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(read) }
; TUNIT: attributes #[[ATTR3:[0-9]+]] = { memory(read) }
; TUNIT: attributes #[[ATTR4]] = { noconvergent nounwind memory(read) }
; TUNIT: attributes #[[ATTR5]] = { noconvergent nofree norecurse nounwind willreturn memory(read) }
; TUNIT: attributes #[[ATTR6]] = { noconvergent nofree norecurse nosync nounwind willreturn }
; TUNIT: attributes #[[ATTR7:[0-9]+]] = { nounwind memory(argmem: readwrite) }
; TUNIT: attributes #[[ATTR8]] = { noconvergent nounwind memory(argmem: readwrite) }
; TUNIT: attributes #[[ATTR9]] = { noconvergent nofree nosync nounwind memory(write) }
; TUNIT: attributes #[[ATTR10]] = { noconvergent nofree norecurse nounwind willreturn memory(argmem: readwrite) }
; TUNIT: attributes #[[ATTR11]] = { noconvergent nofree norecurse nosync nounwind null_pointer_is_valid willreturn memory(none) }
; TUNIT: attributes #[[ATTR12]] = { nounwind memory(read) }
; TUNIT: attributes #[[ATTR13:[0-9]+]] = { nounwind willreturn memory(read) }
; TUNIT: attributes #[[ATTR14]] = { noconvergent nounwind willreturn }
; TUNIT: attributes #[[ATTR15:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind speculatable willreturn memory(inaccessiblemem: readwrite) }
; TUNIT: attributes #[[ATTR16:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind speculatable willreturn memory(none) }
; TUNIT: attributes #[[ATTR17]] = { noconvergent nofree nosync nounwind willreturn }
; TUNIT: attributes #[[ATTR18]] = { nofree nounwind willreturn }
; TUNIT: attributes #[[ATTR19]] = { nounwind }
; TUNIT: attributes #[[ATTR20]] = { noconvergent nofree nosync nounwind }
; TUNIT: attributes #[[ATTR21]] = { willreturn }
;.
; CGSCC: attributes #[[ATTR0]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
; CGSCC: attributes #[[ATTR1]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(write) }
; CGSCC: attributes #[[ATTR2]] = { noconvergent nofree nosync nounwind willreturn memory(write) }
; CGSCC: attributes #[[ATTR3]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(read) }
; CGSCC: attributes #[[ATTR4:[0-9]+]] = { memory(read) }
; CGSCC: attributes #[[ATTR5]] = { noconvergent nounwind memory(read) }
; CGSCC: attributes #[[ATTR6]] = { noconvergent nofree nosync nounwind willreturn memory(read) }
; CGSCC: attributes #[[ATTR7]] = { noconvergent nofree norecurse nosync nounwind willreturn }
; CGSCC: attributes #[[ATTR8]] = { noconvergent nofree nosync nounwind willreturn }
; CGSCC: attributes #[[ATTR9:[0-9]+]] = { nounwind memory(argmem: readwrite) }
; CGSCC: attributes #[[ATTR10]] = { noconvergent nounwind memory(argmem: readwrite) }
; CGSCC: attributes #[[ATTR11]] = { noconvergent nofree nosync nounwind memory(write) }
; CGSCC: attributes #[[ATTR12]] = { noconvergent nofree norecurse nounwind willreturn memory(argmem: readwrite) }
; CGSCC: attributes #[[ATTR13]] = { noconvergent nofree norecurse nosync nounwind null_pointer_is_valid willreturn memory(none) }
; CGSCC: attributes #[[ATTR14]] = { nounwind memory(read) }
; CGSCC: attributes #[[ATTR15:[0-9]+]] = { nounwind willreturn memory(read) }
; CGSCC: attributes #[[ATTR16]] = { noconvergent nounwind willreturn }
; CGSCC: attributes #[[ATTR17:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind speculatable willreturn memory(inaccessiblemem: readwrite) }
; CGSCC: attributes #[[ATTR18:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind speculatable willreturn memory(none) }
; CGSCC: attributes #[[ATTR19]] = { nounwind willreturn }
; CGSCC: attributes #[[ATTR20]] = { willreturn }
; CGSCC: attributes #[[ATTR21]] = { nounwind }
; CGSCC: attributes #[[ATTR22]] = { noconvergent nofree nosync nounwind }
;.
