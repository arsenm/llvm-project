...
; TUNIT-NEXT:    ret i1 [[R]]
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nosync nounwind memory(none)
...
; CGSCC: attributes #[[ATTR4]] = { noconvergent nofree norecurse nosync nounwind memory(none) }
