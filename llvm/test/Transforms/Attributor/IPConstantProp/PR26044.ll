...
;
; TUNIT: Function Attrs: noconvergent nofree norecurse nosync nounwind null_pointer_is_valid
...
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree nosync nounwind null_pointer_is_valid
...
;.
; TUNIT: attributes #[[ATTR0]] = { noconvergent nofree norecurse nosync nounwind memory(argmem: readwrite) }
; TUNIT: attributes #[[ATTR1]] = { noconvergent nofree norecurse nosync nounwind null_pointer_is_valid }
;.
...
; CGSCC: attributes #[[ATTR2]] = { noconvergent nofree nosync nounwind null_pointer_is_valid }
;.
