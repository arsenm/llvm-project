...
; CHECK: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn memory(read)
...
!0 = !{!1}
;.
; CHECK: attributes #[[ATTR0]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(read) }
;.
; CHECK: [[META0:![0-9]+]] = !{!1}
