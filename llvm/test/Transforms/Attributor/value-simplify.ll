...
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree nosync nounwind willreturn memory(argmem: write)
...
; TUNIT: Function Attrs: norecurse memory(none)
...
;
; CGSCC: Function Attrs: norecurse memory(none)
...
;.
; TUNIT: attributes #[[ATTR0:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind willreturn }
; TUNIT: attributes #[[ATTR1]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
; TUNIT: attributes #[[ATTR2]] = { noconvergent nofree norecurse nosync nounwind willreturn }
; TUNIT: attributes #[[ATTR3]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: write) }
; TUNIT: attributes #[[ATTR4]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(write) }
; TUNIT: attributes #[[ATTR5:[0-9]+]] = { speculatable memory(none) }
; TUNIT: attributes #[[ATTR6]] = { norecurse memory(none) }
; TUNIT: attributes #[[ATTR7]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: read) }
; TUNIT: attributes #[[ATTR8:[0-9]+]] = { nocallback noconvergent nofree nounwind willreturn memory(argmem: readwrite) }
; TUNIT: attributes #[[ATTR9]] = { noconvergent nofree nosync nounwind willreturn }
; TUNIT: attributes #[[ATTR10]] = { willreturn }
; TUNIT: attributes #[[ATTR11]] = { willreturn memory(readwrite) }
; TUNIT: attributes #[[ATTR12]] = { nounwind }
;.
; CGSCC: attributes #[[ATTR0:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind willreturn }
...
; CGSCC: attributes #[[ATTR4]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: write) }
; CGSCC: attributes #[[ATTR5]] = { noconvergent nofree nosync nounwind willreturn memory(argmem: write) }
; CGSCC: attributes #[[ATTR6]] = { noconvergent nofree nosync nounwind willreturn memory(write) }
...
; CGSCC: attributes #[[ATTR9]] = { norecurse memory(none) }
; CGSCC: attributes #[[ATTR10]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: read) }
; CGSCC: attributes #[[ATTR11]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(write) }
; CGSCC: attributes #[[ATTR12:[0-9]+]] = { nocallback noconvergent nofree nounwind willreturn memory(argmem: readwrite) }
