...
; CHECK: Function Attrs: noconvergent nofree norecurse nounwind willreturn memory(argmem: readwrite)
...
;.
; CHECK: attributes #[[ATTR0]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: read) }
; CHECK: attributes #[[ATTR1]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) }
; CHECK: attributes #[[ATTR2]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
; CHECK: attributes #[[ATTR3]] = { noconvergent nofree norecurse nounwind willreturn memory(argmem: readwrite) }
; CHECK: attributes #[[ATTR4]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: write) }
;.
