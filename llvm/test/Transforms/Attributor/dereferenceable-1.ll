...
; CHECK: Function Attrs: noconvergent nounwind willreturn
...
; TUNIT: attributes #[[ATTR2]] = { noconvergent nounwind willreturn }
; TUNIT: attributes #[[ATTR3]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: write) }
; TUNIT: attributes #[[ATTR4]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) }
; TUNIT: attributes #[[ATTR5]] = { noconvergent nofree nosync nounwind memory(argmem: write) }
; TUNIT: attributes #[[ATTR6:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind willreturn memory(inaccessiblemem: readwrite) }
; TUNIT: attributes #[[ATTR7]] = { noconvergent nofree nosync nounwind willreturn }
; TUNIT: attributes #[[ATTR8]] = { noconvergent nofree nosync nounwind }
...
; CGSCC: attributes #[[ATTR2]] = { noconvergent nounwind willreturn }
; CGSCC: attributes #[[ATTR3]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: write) }
; CGSCC: attributes #[[ATTR4]] = { noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite) }
; CGSCC: attributes #[[ATTR5]] = { noconvergent nofree nosync nounwind memory(argmem: write) }
; CGSCC: attributes #[[ATTR6:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind willreturn memory(inaccessiblemem: readwrite) }
; CGSCC: attributes #[[ATTR7]] = { noconvergent nofree nosync nounwind }
