...
; CHECK: attributes #[[ATTR6:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite) }
...
; CHECK: attributes #[[ATTR9:[0-9]+]] = { nocallback noconvergent nofree nounwind willreturn memory(argmem: write) }
