...
; CHECK: Function Attrs: noconvergent nounwind memory(read)
; CHECK-LABEL: define {{[^@]+}}@chain_alive
; CHECK-SAME: (i32 [[ARG:%.*]]) #[[ATTR2:[0-9]+]] {
; CHECK-NEXT:    [[INIT:%.*]] = call i32 @source() #[[ATTR3:[0-9]+]]
...
; CHECK: attributes #[[ATTR2]] = { noconvergent nounwind memory(read) }
