...
; TUNIT: Function Attrs: noconvergent nofree noinline norecurse nosync nounwind willreturn memory(argmem: read) uwtable
...
;
; CGSCC: Function Attrs: noconvergent nofree noinline nosync nounwind willreturn memory(argmem: read) uwtable
...
; TUNIT-NEXT:    ret i32 [[ADD]]
;
; CGSCC: Function Attrs: noconvergent nofree noinline norecurse nosync nounwind willreturn memory(argmem: read) uwtable
...
; TUNIT: Function Attrs: noconvergent nofree noinline norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
...
; TUNIT-NEXT:    ret i32 [[ADD]]
;
; CGSCC: Function Attrs: noconvergent nofree noinline nosync nounwind willreturn memory(argmem: readwrite) uwtable
...
;
; CGSCC: Function Attrs: noconvergent nofree noinline norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
...
;.
; TUNIT: attributes #[[ATTR0]] = { noconvergent nofree noinline norecurse nosync nounwind willreturn memory(argmem: read) uwtable }
; TUNIT: attributes #[[ATTR1]] = { noconvergent nofree noinline norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable }
; TUNIT: attributes #[[ATTR2]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
; TUNIT: attributes #[[ATTR3]] = { noconvergent nofree noinline norecurse nosync nounwind willreturn memory(argmem: write) uwtable }
; TUNIT: attributes #[[ATTR4]] = { nofree nosync nounwind }
; TUNIT: attributes #[[ATTR5]] = { nofree nosync nounwind willreturn }
;.
; CGSCC: attributes #[[ATTR0]] = { noconvergent nofree noinline nosync nounwind willreturn memory(argmem: read) uwtable }
; CGSCC: attributes #[[ATTR1]] = { noconvergent nofree noinline norecurse nosync nounwind willreturn memory(argmem: read) uwtable }
; CGSCC: attributes #[[ATTR2]] = { noconvergent nofree noinline nosync nounwind willreturn memory(argmem: readwrite) uwtable }
; CGSCC: attributes #[[ATTR3]] = { noconvergent nofree nosync nounwind willreturn memory(none) }
; CGSCC: attributes #[[ATTR4]] = { noconvergent nofree noinline norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable }
