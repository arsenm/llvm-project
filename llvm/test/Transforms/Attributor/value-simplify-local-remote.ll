...
; TUNIT: attributes #[[ATTR2]] = { noconvergent nofree norecurse noreturn nosync nounwind memory(none) }
...
;.
; CGSCC: attributes #[[ATTR0]] = { noconvergent nofree nosync nounwind willreturn memory(argmem: write) }
; CGSCC: attributes #[[ATTR1]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
; CGSCC: attributes #[[ATTR2]] = { noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite) }
; CGSCC: attributes #[[ATTR3]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: write) }
; CGSCC: attributes #[[ATTR4]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) }
; CGSCC: attributes #[[ATTR5]] = { noconvergent nofree norecurse noreturn nosync nounwind memory(none) }
