...
; CHECK: Function Attrs: noconvergent nofree nosync nounwind memory(argmem: read)
...
; GRAPH-EMPTY:
; GRAPH-NEXT: [AANoConvergent] for CtxI '  %2 = load i32, ptr %0, align 4' at position {fn:checkAndAdvance [checkAndAdvance@-1]} with state noconvergent
; GRAPH-NEXT:   updates [AANoConvergent] for CtxI '  %6 = call ptr @checkAndAdvance(ptr %5)' at position {cs: [@-1]} with state noconvergent
; GRAPH-EMPTY:
; GRAPH-NEXT: [AANoConvergent] for CtxI '  %6 = call ptr @checkAndAdvance(ptr %5)' at position {cs: [@-1]} with state noconvergent
; GRAPH-NEXT:   updates [AANoConvergent] for CtxI '  %2 = load i32, ptr %0, align 4' at position {fn:checkAndAdvance [checkAndAdvance@-1]} with state noconvergent
; GRAPH-EMPTY:
...
;.
; CHECK: attributes #[[ATTR0]] = { noconvergent nofree nosync nounwind memory(argmem: read) }
; CHECK: attributes #[[ATTR1]] = { noconvergent nofree nosync nounwind }
;.
