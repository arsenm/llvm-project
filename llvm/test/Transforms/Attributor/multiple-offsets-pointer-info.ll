...
; CHECK: attributes #[[ATTR1]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
; CHECK: attributes #[[ATTR2]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(write) }
; CHECK: attributes #[[ATTR3]] = { noconvergent nofree norecurse nosync nounwind willreturn }
;.
