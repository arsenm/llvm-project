...
; TUNIT: attributes #[[ATTR9:[0-9]+]] = { nocallback noconvergent nofree nounwind willreturn memory(argmem: write) }
...
; CGSCC: attributes #[[ATTR4]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(write) }
...
; CGSCC: attributes #[[ATTR9:[0-9]+]] = { nocallback noconvergent nofree nounwind willreturn memory(argmem: write) }
