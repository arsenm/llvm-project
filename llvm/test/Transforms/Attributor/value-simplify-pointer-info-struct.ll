...
; CHECK: Function Attrs: noconvergent nofree norecurse nounwind willreturn memory(none)
...
; CHECK: attributes #[[ATTR1]] = { noconvergent nofree norecurse nounwind willreturn memory(none) }
