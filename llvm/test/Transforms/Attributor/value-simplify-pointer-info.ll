...
; TUNIT: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
...
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite)
...
;
; TUNIT: Function Attrs: noconvergent nofree norecurse nosync nounwind memory(write)
...
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nosync nounwind memory(write)
...
; TUNIT: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn uwtable
...
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn uwtable
...
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
...
!31 = distinct !{!31, !17}
;.
; TUNIT: attributes #[[ATTR0]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: write) }
; TUNIT: attributes #[[ATTR1]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) }
; TUNIT: attributes #[[ATTR2:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite) }
; TUNIT: attributes #[[ATTR3]] = { noconvergent nofree norecurse nosync nounwind willreturn }
; TUNIT: attributes #[[ATTR4]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
; TUNIT: attributes #[[ATTR5]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(write) }
; TUNIT: attributes #[[ATTR6]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(read) }
; TUNIT: attributes #[[ATTR7]] = { noconvergent nofree norecurse nosync nounwind memory(write) }
...
; TUNIT: attributes #[[ATTR11]] = { noconvergent nofree norecurse nosync nounwind willreturn uwtable }
; TUNIT: attributes #[[ATTR12]] = { noconvergent nofree nosync nounwind memory(argmem: readwrite) }
; TUNIT: attributes #[[ATTR13]] = { noconvergent nofree norecurse nosync nounwind memory(none) }
; TUNIT: attributes #[[ATTR14]] = { noconvergent nofree nosync nounwind }
; TUNIT: attributes #[[ATTR15:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind willreturn memory(inaccessiblemem: readwrite) }
; TUNIT: attributes #[[ATTR16:[0-9]+]] = { nocallback noconvergent nofree nounwind willreturn memory(argmem: write) }
; TUNIT: attributes #[[ATTR17]] = { willreturn }
; TUNIT: attributes #[[ATTR18]] = { noconvergent nofree nosync nounwind willreturn }
; TUNIT: attributes #[[ATTR19]] = { nocallback }
; TUNIT: attributes #[[ATTR20]] = { norecurse }
; TUNIT: attributes #[[ATTR21]] = { nounwind }
;.
; CGSCC: attributes #[[ATTR0]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: write) }
; CGSCC: attributes #[[ATTR1]] = { noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite) }
; CGSCC: attributes #[[ATTR2:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite) }
; CGSCC: attributes #[[ATTR3]] = { noconvergent nofree nosync nounwind willreturn }
; CGSCC: attributes #[[ATTR4]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
; CGSCC: attributes #[[ATTR5]] = { noconvergent nofree norecurse nosync nounwind willreturn }
; CGSCC: attributes #[[ATTR6]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(write) }
; CGSCC: attributes #[[ATTR7]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(read) }
; CGSCC: attributes #[[ATTR8]] = { noconvergent nofree norecurse nosync nounwind memory(write) }
...
; CGSCC: attributes #[[ATTR12]] = { noconvergent nofree norecurse nosync nounwind willreturn uwtable }
; CGSCC: attributes #[[ATTR13]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) }
; CGSCC: attributes #[[ATTR14]] = { noconvergent nofree nosync nounwind memory(argmem: readwrite) }
; CGSCC: attributes #[[ATTR15]] = { noconvergent nofree nosync nounwind memory(none) }
; CGSCC: attributes #[[ATTR16]] = { noconvergent nofree nosync nounwind willreturn memory(none) }
; CGSCC: attributes #[[ATTR17]] = { noconvergent nofree nosync nounwind }
; CGSCC: attributes #[[ATTR18:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind willreturn memory(inaccessiblemem: readwrite) }
; CGSCC: attributes #[[ATTR19:[0-9]+]] = { nocallback noconvergent nofree nounwind willreturn memory(argmem: write) }
