...
;
; CGSCC: Function Attrs: noconvergent nofree nosync nounwind willreturn memory(argmem: read)
...
;.
; TUNIT: attributes #[[ATTR0]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: read) }
; TUNIT: attributes #[[ATTR1]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
; TUNIT: attributes #[[ATTR2]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: write) }
; TUNIT: attributes #[[ATTR3]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) }
; TUNIT: attributes #[[ATTR4]] = { noconvergent nofree nosync nounwind willreturn }
;.
; CGSCC: attributes #[[ATTR0]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: read) }
; CGSCC: attributes #[[ATTR1]] = { noconvergent nofree nosync nounwind willreturn memory(argmem: read) }
; CGSCC: attributes #[[ATTR2]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
