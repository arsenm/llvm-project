...
; TUNIT: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
...
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite) uwtable
...
;.
; TUNIT: attributes #[[ATTR0]] = { inlinehint noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable "target-features"="+avx2" }
; TUNIT: attributes #[[ATTR1]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable }
; TUNIT: attributes #[[ATTR2:[0-9]+]] = { nocallback noconvergent nofree nounwind willreturn memory(argmem: write) }
; TUNIT: attributes #[[ATTR3]] = { willreturn }
; TUNIT: attributes #[[ATTR4]] = { nofree nosync nounwind willreturn }
;.
; CGSCC: attributes #[[ATTR0]] = { inlinehint noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable "target-features"="+avx2" }
; CGSCC: attributes #[[ATTR1]] = { noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite) uwtable }
; CGSCC: attributes #[[ATTR2:[0-9]+]] = { nocallback noconvergent nofree nounwind willreturn memory(argmem: write) }
