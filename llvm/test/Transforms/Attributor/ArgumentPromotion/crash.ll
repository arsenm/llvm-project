...
; TUNIT-NEXT:    unreachable
;
; CGSCC: Function Attrs: noconvergent nofree noreturn nosync nounwind willreturn memory(none)
...
declare i32 @wibble(...)
;.
; TUNIT: attributes #[[ATTR0]] = { noconvergent nofree norecurse noreturn nosync nounwind willreturn memory(none) }
...
;.
; CGSCC: attributes #[[ATTR0]] = { noconvergent nofree noreturn nosync nounwind willreturn memory(none) }
; CGSCC: attributes #[[ATTR1]] = { noconvergent nofree norecurse noreturn nosync nounwind willreturn memory(none) }
