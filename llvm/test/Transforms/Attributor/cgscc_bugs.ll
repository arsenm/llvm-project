...
; TUNIT-LABEL: define {{[^@]+}}@f5
; TUNIT-SAME: (i64 [[TMP0:%.*]], i64 [[TMP1:%.*]]) #[[ATTR0:[0-9]+]] {
; TUNIT-NEXT:    br label [[TMP3:%.*]]
; TUNIT:       3:
; TUNIT-NEXT:    call void @f6(i64 [[TMP0]]) #[[ATTR0]]
; TUNIT-NEXT:    [[TMP4:%.*]] = icmp sgt i64 [[TMP1]], [[TMP0]]
; TUNIT-NEXT:    br i1 [[TMP4]], label [[TMP5:%.*]], label [[TMP6:%.*]]
; TUNIT:       5:
; TUNIT-NEXT:    ret void
; TUNIT:       6:
; TUNIT-NEXT:    call void @f5(i64 [[TMP0]], i64 [[TMP1]]) #[[ATTR0]]
; TUNIT-NEXT:    br label [[TMP3]]
;
; CGSCC: Function Attrs: noconvergent nounwind
; CGSCC-LABEL: define {{[^@]+}}@f5
; CGSCC-SAME: (i64 [[TMP0:%.*]], i64 [[TMP1:%.*]]) #[[ATTR0:[0-9]+]] {
; CGSCC-NEXT:    br label [[TMP3:%.*]]
; CGSCC:       3:
; CGSCC-NEXT:    call void @f6(i64 [[TMP0]]) #[[ATTR2]]
; CGSCC-NEXT:    [[TMP4:%.*]] = icmp sgt i64 [[TMP1]], [[TMP0]]
; CGSCC-NEXT:    br i1 [[TMP4]], label [[TMP5:%.*]], label [[TMP6:%.*]]
; CGSCC:       5:
; CGSCC-NEXT:    ret void
; CGSCC:       6:
; CGSCC-NEXT:    call void @f5(i64 [[TMP0]], i64 [[TMP1]]) #[[ATTR0]]
; CGSCC-NEXT:    br label [[TMP3]]
;
  br label %3
...
;.
; CHECK: attributes #[[ATTR0]] = { noconvergent nounwind }
; CHECK: attributes #[[ATTR1:[0-9]+]] = { cold noconvergent noreturn nounwind }
