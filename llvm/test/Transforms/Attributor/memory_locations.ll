...
; TUNIT: Function Attrs: noconvergent nofree nosync nounwind memory(argmem: write)
...
; TUNIT-NEXT:    ret i8 0
;
; CGSCC: Function Attrs: noconvergent nofree nosync nounwind memory(argmem: write)
...
; TUNIT: attributes #[[ATTR4:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite) }
; TUNIT: attributes #[[ATTR5]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
; TUNIT: attributes #[[ATTR6]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(write) }
; TUNIT: attributes #[[ATTR7]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: write) }
; TUNIT: attributes #[[ATTR8]] = { noconvergent nofree nosync nounwind memory(argmem: write) }
; TUNIT: attributes #[[ATTR9]] = { noconvergent nofree norecurse nosync nounwind memory(none) }
; TUNIT: attributes #[[ATTR10]] = { noconvergent nofree nosync nounwind willreturn }
; TUNIT: attributes #[[ATTR11]] = { noconvergent nofree nosync nounwind }
;.
...
; CGSCC: attributes #[[ATTR4:[0-9]+]] = { nocallback noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite) }
; CGSCC: attributes #[[ATTR5]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
...
; CGSCC: attributes #[[ATTR8]] = { noconvergent nofree nosync nounwind willreturn memory(write) }
; CGSCC: attributes #[[ATTR9]] = { noconvergent nofree nosync nounwind memory(argmem: write) }
; CGSCC: attributes #[[ATTR10]] = { noconvergent nofree nosync nounwind memory(none) }
; CGSCC: attributes #[[ATTR11]] = { nounwind willreturn }
; CGSCC: attributes #[[ATTR12]] = { noconvergent nofree nosync nounwind }
