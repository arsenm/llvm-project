...
;.
; TUNIT: attributes #[[ATTR0]] = { noconvergent nofree noinline norecurse nosync nounwind sspstrong willreturn memory(none) uwtable }
; TUNIT: attributes #[[ATTR1:[0-9]+]] = { nofree nosync nounwind willreturn }
;.
; CGSCC: attributes #[[ATTR0]] = { noconvergent nofree noinline norecurse nosync nounwind sspstrong willreturn memory(none) uwtable }
; CGSCC: attributes #[[ATTR1]] = { noconvergent nofree noinline nosync nounwind sspstrong willreturn memory(none) uwtable }
