...
; CHECK: Function Attrs: noconvergent nofree norecurse nosync nounwind null_pointer_is_valid willreturn memory(none)
...
; TUNIT: Function Attrs: noconvergent nofree norecurse nounwind willreturn memory(none)
...
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nounwind willreturn memory(none)
...
; TUNIT: Function Attrs: noconvergent nofree norecurse nosync nounwind null_pointer_is_valid willreturn memory(write)
; TUNIT-LABEL: define {{[^@]+}}@store_null_pointer_is_defined
; TUNIT-SAME: () #[[ATTR3:[0-9]+]] {
; TUNIT-NEXT:    store i32 5, ptr null, align 4294967296
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nosync nounwind null_pointer_is_valid willreturn memory(write)
...
; TUNIT: Function Attrs: noconvergent nofree norecurse nounwind null_pointer_is_valid willreturn
...
; TUNIT-NEXT:    ret void
;
; CGSCC: Function Attrs: noconvergent nofree norecurse nounwind null_pointer_is_valid willreturn
...
; TUNIT-NEXT:    unreachable
;
; CGSCC: Function Attrs: noconvergent nofree nounwind willreturn
...
; TUNIT: Function Attrs: noconvergent nofree norecurse noreturn nosync nounwind willreturn memory(none)
...
; TUNIT-NEXT:    unreachable
;
; CGSCC: Function Attrs: noconvergent nofree norecurse noreturn nosync nounwind willreturn memory(none)
...
; TUNIT: attributes #[[ATTR1]] = { noconvergent nofree norecurse nosync nounwind null_pointer_is_valid willreturn memory(none) }
; TUNIT: attributes #[[ATTR2]] = { noconvergent nofree norecurse nounwind willreturn memory(none) }
; TUNIT: attributes #[[ATTR3]] = { noconvergent nofree norecurse nosync nounwind null_pointer_is_valid willreturn memory(write) }
; TUNIT: attributes #[[ATTR4]] = { noconvergent nofree norecurse nounwind null_pointer_is_valid willreturn }
; TUNIT: attributes #[[ATTR5]] = { noconvergent nofree norecurse noreturn nosync nounwind willreturn memory(none) }
; TUNIT: attributes #[[ATTR6]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: write) }
; TUNIT: attributes #[[ATTR7]] = { noconvergent nofree nosync nounwind willreturn }
;.
; CGSCC: attributes #[[ATTR0]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
; CGSCC: attributes #[[ATTR1]] = { noconvergent nofree norecurse nosync nounwind null_pointer_is_valid willreturn memory(none) }
; CGSCC: attributes #[[ATTR2]] = { noconvergent nofree nosync nounwind willreturn memory(none) }
; CGSCC: attributes #[[ATTR3]] = { noconvergent nofree norecurse nounwind willreturn memory(none) }
; CGSCC: attributes #[[ATTR4]] = { noconvergent nofree norecurse nosync nounwind null_pointer_is_valid willreturn memory(write) }
; CGSCC: attributes #[[ATTR5]] = { noconvergent nofree nosync nounwind willreturn memory(write) }
; CGSCC: attributes #[[ATTR6]] = { noconvergent nofree norecurse nounwind null_pointer_is_valid willreturn }
; CGSCC: attributes #[[ATTR7]] = { noconvergent nofree nounwind willreturn }
; CGSCC: attributes #[[ATTR8]] = { noconvergent nofree norecurse noreturn nosync nounwind willreturn memory(none) }
; CGSCC: attributes #[[ATTR9]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(argmem: write) }
; CGSCC: attributes #[[ATTR10]] = { willreturn }
; CGSCC: attributes #[[ATTR11]] = { nounwind willreturn }
;.


; TODO: Add test for noconvergent calling convergent
