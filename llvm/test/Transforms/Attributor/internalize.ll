...
;
; CHECK_ENABLED: Function Attrs: noconvergent nofree norecurse nosync nounwind willreturn memory(none)
...
;.
; CHECK_ENABLED: attributes #[[ATTR0]] = { noconvergent nofree norecurse nosync nounwind willreturn memory(none) }
