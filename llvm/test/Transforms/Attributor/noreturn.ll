...
; CHECK: Function Attrs: noconvergent nofree noinline noreturn nosync nounwind willreturn memory(none) uwtable
...
; TUNIT: Function Attrs: noconvergent nofree noinline norecurse noreturn nosync nounwind willreturn memory(none) uwtable
...
; TUNIT-NEXT:    unreachable
;
; CGSCC: Function Attrs: noconvergent nofree noinline noreturn nosync nounwind willreturn memory(none) uwtable
...
;.
; TUNIT: attributes #[[ATTR0]] = { noconvergent nofree noinline nosync nounwind willreturn memory(none) uwtable }
; TUNIT: attributes #[[ATTR1]] = { noconvergent nofree noinline noreturn nosync nounwind willreturn memory(none) uwtable }
; TUNIT: attributes #[[ATTR2]] = { noconvergent nofree noinline norecurse noreturn nosync nounwind memory(none) uwtable }
; TUNIT: attributes #[[ATTR3]] = { noconvergent nofree noinline norecurse noreturn nosync nounwind willreturn memory(none) uwtable }
; TUNIT: attributes #[[ATTR4]] = { noconvergent nofree norecurse noreturn nosync nounwind willreturn memory(none) }
;.
; CGSCC: attributes #[[ATTR0]] = { noconvergent nofree noinline nosync nounwind willreturn memory(none) uwtable }
; CGSCC: attributes #[[ATTR1]] = { noconvergent nofree noinline noreturn nosync nounwind willreturn memory(none) uwtable }
; CGSCC: attributes #[[ATTR2]] = { noconvergent nofree noinline norecurse noreturn nosync nounwind memory(none) uwtable }
; CGSCC: attributes #[[ATTR3]] = { noconvergent nofree norecurse noreturn nosync nounwind willreturn memory(none) }
;.
