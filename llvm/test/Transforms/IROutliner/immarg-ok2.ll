...
define i32 @immarg_user_same_values2(i32 %arg0) {
bb:
  %i = tail call i32 @llvm.uses.immarg2(i64 0, i32 2)
  %i1 = or i32 %arg0, %i
  %i2 = tail call i32 @llvm.uses.immarg2(i64 1, i32 2)
  %i3 = or i32 %arg0, %i2
  ret i32 %i3
}

declare i32 @llvm.uses.immarg2(i64, i32 immarg)
