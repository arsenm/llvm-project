...
; CHECK: declare void @llvm.donothing() #31
...
; CHECK: attributes #31 = { nocallback noconvergent nofree nosync nounwind willreturn memory(none) }
; CHECK: attributes #32 = { nocallback noconvergent nofree nosync nounwind willreturn }
; CHECK: attributes #33 = { noconvergent nounwind }
; CHECK: attributes #34 = { noconvergent nounwind memory(argmem: read) }
; CHECK: attributes #35 = { noconvergent nounwind memory(argmem: readwrite) }
; CHECK: attributes #36 = { nocallback noconvergent nofree nosync nounwind willreturn memory(read) }
; CHECK: attributes #37 = { nocallback noconvergent nounwind }
; CHECK: attributes #38 = { nocallback noconvergent nofree nosync nounwind willreturn memory(argmem: readwrite, inaccessiblemem: readwrite) }
